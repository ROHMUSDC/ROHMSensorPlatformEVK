...
CFILE 0000H 000007B2H "main\\main.c"
...
;;{ 	
CLINEA 0000H 0001H 01A4H 0001H 0003H
CBLOCK 228 2 420

;;	Initialization(); //Ports, UART, Timers, Oscillator, Comparators, etc.
CLINEA 0000H 0001H 01A5H 0002H 0047H
	bl	_Initialization

;;	PRINTF(WelcomeString);
CLINEA 0000H 0001H 01A7H 0002H 0017H
	mov	r0,	#0feh
	mov	r1,	#00h
	push	er0
...
;;MainLoop:
CLINEA 0000H 0001H 01AEH 0001H 0009H
...
CLINEA 0000H 0001H 01B6H 0003H 0019H
	bl	_SensorInitialization

;;		SensorIntializationFlag = 0;
CLINEA 0000H 0001H 01B7H 0003H 001EH
	mov	r0,	#00h
	st	r0,	NEAR _SensorIntializationFlag
CBLOCKEND 228 3 440

;;	}
CLINEA 0000H 0000H 01B8H 0002H 0002H
_$L32 :

;;	switch(SensorPlatformSelection){
CLINEA 0000H 0001H 01BAH 0002H 0021H
...
CLINEA 0000H 0001H 01EBH 0002H 0034H
	sb	0f009h.0
...
CLINEA 0000H 0001H 01BCH 0004H 0057H
...
CLINEA 0000H 0001H 01BFH 0004H 0058H
...
;;		case 5: 
CLINEA 0000H 0001H 01C1H 0003H 000AH
_$S41 :
...
CLINEA 0000H 0001H 01D1H 0004H 004FH
...
CLINEA 0000H 0001H 01D4H 0004H 0048H
	bl	_MainOp_KX022
...
CLINEA 0000H 0001H 01DAH 0004H 0058H
...
CLINEA 0000H 0001H 01DDH 0004H 0057H
...
CLINEA 0000H 0001H 01E0H 0004H 0058H
...
CLINEA 0000H 0001H 01E3H 0004H 0057H
	bl	_MainOp_Temperature_Sensor_23

;;			break; 
CLINEA 0000H 0001H 01E4H 0004H 000AH
	bal	_$L37
...
CLINEA 0000H 0001H 01E6H 0004H 0038H
	mov	er0,	#25
	push	er0
...
;;			LEDOUT(0xFF);
CLINEA 0000H 0001H 01E7H 0004H 0010H
	mov	r0,	#0ffh
	st	r0,	0f260h

;;			break;
CLINEA 0000H 0001H 01E8H 0004H 0009H
	bal	_$L37
CBLOCKEND 228 4 489
CBLOCKEND 228 1 493
CFUNCTIONEND 228
...
CLINEA 0000H 0001H 01F9H 0001H 0021H
	push	lr
CBLOCK 180 2 505
CRET 0000H
...
CLINEA 0000H 0001H 01FEH 0002H 0042H
	rb	0f02ah.2

;;	DUA1  = 1; // 0=> Enables Uart1 (initial value). 
CLINEA 0000H 0001H 01FFH 0002H 0032H
	sb	0f02ah.3
...
CLINEA 0000H 0001H 020BH 0002H 003EH
	bl	_PortD_Low

;;    SetOSC();
CLINEA 0000H 0001H 020EH 0005H 000DH
	bl	_SetOSC

;;	PA0DIR = 1;
CLINEA 0000H 0001H 0211H 0002H 000CH
	sb	0f251h.0
...
CLINEA 0000H 0001H 0214H 0002H 0039H
	sb	0f2f2h.1

;;	SALP = 0;		//Single Read or Continuous Read... Single = 0, Consecutive = 1
CLINEA 0000H 0001H 0215H 0002H 004BH
	rb	0f2f0h.0

;;	irq_di();	// Disable Interrupts
CLINEA 0000H 0001H 0219H 0002H 0020H
	bl	_irq_di

;;	irq_init();	// Initialize Interrupts (All Off and NO Requests)
CLINEA 0000H 0001H 021AH 0002H 003FH
	bl	_irq_init

;;	IE0 = IE1 = IE2 = IE3 = IE4 = IE5 = IE6 = IE7 = 0;
CLINEA 0000H 0001H 021DH 0002H 0033H
	mov	r0,	#00h
	st	r0,	0f017h
	st	r0,	0f016h
	st	r0,	0f015h
...
CLINEA 0000H 0001H 021FH 0002H 003BH
	st	r0,	0f01fh
	st	r0,	0f01eh
	st	r0,	0f01dh
	st	r0,	0f01ch
...
CLINEA 0000H 0001H 0221H 0002H 0045H
	rb	0f017h.3

;;	irq_setHdr((unsigned char)IRQ_NO_UA0INT, _intUart);
CLINEA 0000H 0001H 0223H 0002H 0034H
...
CLINEA 0000H 0001H 0224H 0002H 004AH
	sb	0f014h.0
...
;;	QI2CM = 0;
CLINEA 0000H 0001H 0228H 0002H 000BH
	rb	0f01ah.7

;;	irq_setHdr((unsigned char)IRQ_NO_SADINT, _intADC);
CLINEA 0000H 0001H 022BH 0002H 0033H
...
;;	QSAD = 0;
CLINEA 0000H 0001H 022DH 0002H 000AH
	rb	0f01ah.2

;;	irq_ei(); // Enable Interrupts
CLINEA 0000H 0001H 0239H 0002H 001FH
	bl	_irq_ei

;;	WDTMOD = 0x01; 	
CLINEA 0000H 0001H 0245H 0002H 0011H
	mov	r0,	#01h
	st	r0,	0f00fh

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0246H 0002H 001DH
	bl	_main_clrWDT

;;	i2c_init(I2C_MOD_FST, (unsigned short)HSCLK_KHZ, I2C_SYN_OFF);
CLINEA 0000H 0001H 024CH 0002H 003FH
	mov	r0,	#00h
	push	r0
	mov	r2,	#040h
	mov	r3,	#01fh
...
;;			   &_uartSetParam );				/* Param... 	 */
CLINEA 0000H 0001H 0251H 0007H 002BH
...
;;	uart_PortSet();
CLINEA 0000H 0001H 0252H 0002H 0010H
	bl	_uart_PortSet
CBLOCKEND 180 2 598
...
;;	uart_stop();
CLINEA 0000H 0001H 0266H 0002H 000DH
	bl	_uart_stop

;;	uart_startSend(buffer, len, _funcUartFin); 
CLINEA 0000H 0001H 0267H 0002H 002CH
...
;;	while(_flgUartFin != 1)
CLINEA 0000H 0000H 0268H 0002H 0018H
_$L58 :
CBLOCK 186 3 617
...
;;	return len;
CLINEA 0000H 0001H 026CH 0002H 000CH
	l	er0,	4[fp]
CBLOCKEND 186 2 621
...
;;	_flgADCFin = 0;
CLINEA 0000H 0001H 0279H 0002H 0010H
	mov	r0,	#00h
	st	r0,	NEAR __flgADCFin

;;	SADMOD0 = (unsigned char)(1<<idx);
CLINEA 0000H 0001H 027AH 0002H 0023H
	mov	er0,	#1 
	mov	r2,	r8
_$M6 :
	cmp	r2,	#07h
...
;;	SARUN = 1;
CLINEA 0000H 0001H 027BH 0002H 000BH
	sb	0f2f1h.0
...
;;	while(_flgADCFin == 0)
CLINEA 0000H 0000H 027CH 0002H 0017H
_$L64 :
CBLOCK 187 3 637

;;		main_clrWDT();
CLINEA 0000H 0001H 027EH 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 187 3 639
...
;;	switch(idx)
CLINEA 0000H 0001H 0280H 0002H 000CH
	mov	r0,	r8
	mov	r1,	#00h
CBLOCK 187 4 641
	cmp	r8,	#07h
...
;;		default:	return 0;
CLINEA 0000H 0001H 028AH 0003H 0014H
_$L70 :
	mov	er0,	#0 
	b	_$L61
CBLOCKEND 187 4 651
...
;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 029FH 0002H 0017H
_$L83 :
CBLOCK 188 3 672

;;		main_clrWDT();
CLINEA 0000H 0001H 02A1H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 188 3 674
...
;;{
CLINEA 0000H 0001H 02B2H 0001H 0001H
	push	lr
	push	fp
	mov	fp,	sp
	push	xr8
...
;;	_flgI2CFin = 0;
CLINEA 0000H 0001H 02B3H 0002H 0010H
	mov	r0,	#00h
	st	r0,	NEAR __flgI2CFin
...
CLINEA 0000H 0001H 02B5H 0002H 0060H
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	l	r0,	8[fp]
...
;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02B6H 0001H 0001H
	bal	_$L91

;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02B6H 0002H 0017H
_$L89 :
CBLOCK 189 3 695

;;		main_clrWDT();
CLINEA 0000H 0001H 02B8H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 189 3 697
...
;;{  
CLINEA 0000H 0001H 02C6H 0001H 0003H
CBLOCK 198 2 710
...
CLINEA 0000H 0001H 02D5H 0003H 001EH
	mov	r0,	#01h
	st	r0,	NEAR _SensorIntializationFlag

;;		SensorPlatformSelection = PDD;
CLINEA 0000H 0001H 02D6H 0003H 0020H
	l	r0,	0f268h
	st	r0,	NEAR _SensorPlatformSelection
CBLOCKEND 198 3 727

;;	}
CLINEA 0000H 0000H 02D7H 0002H 0002H
_$L93 :
CBLOCKEND 198 2 728

;;}
CLINEA 0000H 0001H 02D8H 0001H 0001H
	rt
CBLOCKEND 198 1 728
CFUNCTIONEND 198
...
;;{  
CLINEA 0000H 0001H 02E2H 0001H 0003H
	push	lr
CBLOCK 199 2 738
CRET 0000H
...
CLINEA 0000H 0001H 02E5H 0004H 0055H
...
CLINEA 0000H 0001H 02E8H 0004H 0056H
...
;;		case 5: 
CLINEA 0000H 0001H 02EAH 0003H 000AH
_$S103 :
...
CLINEA 0000H 0001H 02FAH 0004H 004DH
...
CLINEA 0000H 0001H 02FDH 0004H 0046H
	bl	_Init_KX022
...
CLINEA 0000H 0001H 0303H 0004H 0056H
...
CLINEA 0000H 0001H 0306H 0004H 0055H
...
;;			break; 
CLINEA 0000H 0001H 030DH 0004H 000AH
	bal	_$L99
...
CLINEA 0000H 0001H 031FH 0002H 0039H
	tb	0f258h.2
	beq	_$L116
	tb	0f258h.3
	beq	_$L116
...
CLINEA 0000H 0001H 0321H 0003H 0023H
	mov	r0,	#00h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – No Mag Fields Detected." ESC_SOL);
CLINEA 0000H 0001H 0322H 0003H 004FH
	mov	er0,	#49
	push	er0
...
CLINEA 0000H 0001H 0324H 0002H 003EH
	bal	_$L142
_$L116 :
	tb	0f258h.2
	beq	_$L125
...
CLINEA 0000H 0001H 0326H 0003H 001FH
	mov	r0,	#02h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – North Mag Field Detected." ESC_SOL);
CLINEA 0000H 0001H 0327H 0003H 0051H
	mov	er0,	#51
	push	er0
...
CLINEA 0000H 0001H 032BH 0003H 001FH
	mov	r0,	#080h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – South Mag Field Detected." ESC_SOL);
CLINEA 0000H 0001H 032CH 0003H 0051H
	mov	er0,	#51
	push	er0
...
;;	else
CLINEA 0000H 0001H 032EH 0002H 0005H
	bal	_$L142
_$L134 :
CBLOCK 201 6 815

;;		LEDOUT(0x82);	// Turn on LED7 and LED1
CLINEA 0000H 0001H 0330H 0003H 0028H
	mov	r0,	#082h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – Both Mag Fields Detected." ESC_SOL);
CLINEA 0000H 0001H 0331H 0003H 0051H
	mov	er0,	#51
	push	er0
...
;;}
CLINEA 0000H 0001H 0333H 0001H 0001H
	pop	pc
CBLOCKEND 201 1 819
CFUNCTIONEND 201
...
;;		LEDOUT(0x80);	// Turn on LED7
CLINEA 0000H 0001H 0343H 0003H 001FH
	mov	r0,	#080h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52011HFV> Hall – Mag Field Detected." ESC_SOL);
CLINEA 0000H 0001H 0344H 0003H 004BH
	mov	er0,	#45
	push	er0
...
;;	else
CLINEA 0000H 0001H 0346H 0002H 0005H
	bal	_$L148
_$L145 :
CBLOCK 200 4 839

;;		LEDOUT(0x0);	// Turn off all LEDs
CLINEA 0000H 0001H 0348H 0003H 0023H
	mov	r0,	#00h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52011HFV> Hall – No Mag Fields Detected." ESC_SOL);
CLINEA 0000H 0001H 0349H 0003H 004FH
	mov	er0,	#49
	push	er0
...
;;	}
CLINEA 0000H 0000H 034AH 0002H 0002H
_$L148 :
	add	sp,	#2 
CBLOCKEND 200 2 843
...
;;{	
CLINEA 0000H 0001H 0358H 0001H 0002H
	push	lr
CBLOCK 202 2 856
CRET 0000H

;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 0359H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 035BH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 0360H 0002H 0037H
	l	r0,	0f258h
	srl	r0,	#03h
	and	r0,	#01h
	mov	r1,	#00h
...
;;	switch(SENINTF_HDR1_GPIO1(D)<<1|SENINTF_HDR1_GPIO0(D))
CLINEA 0000H 0000H 0360H 0002H 0037H
	cmp	r2,	#01h
	beq	_$L156
...
;;		case 0:	// Shutdown
CLINEA 0000H 0001H 036BH 0003H 0015H
_$L159 :

;;			flSensorOut[0] = 0;
CLINEA 0000H 0001H 036DH 0004H 0016H
	mov	er0,	#0 
	st	er0,	NEAR _flSensorOut
...
;;	}
CLINEA 0000H 0000H 036FH 0002H 0002H
_$L154 :

;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>2)));
CLINEA 0000H 0000H 0371H 0002H 0040H
...
CLINEA 0000H 0001H 0372H 0002H 0063H
...
;;		case 1: // H-Gain mode
CLINEA 0000H 0001H 0362H 0003H 0018H
_$L156 :

;;			flSensorOut[0] = flSensorOut[0]/(0.57e-6f*5.6e3f);
CLINEA 0000H 0001H 0363H 0004H 0035H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#0e0h
...
;;			break;
CLINEA 0000H 0001H 0364H 0004H 0009H
	bal	_$L154
...
CLINEA 0000H 0001H 0366H 0004H 0036H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#04dh
...
CLINEA 0000H 0001H 0369H 0004H 0037H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#0d7h
...
CLINEA 0000H 0001H 0386H 0002H 0043H
	mov	r0,	#02h
	push	r0
...
CLINEA 0000H 0001H 038AH 0002H 0056H
...
;;}
CLINEA 0000H 0001H 038EH 0001H 0001H
	pop	pc
CBLOCKEND 203 1 910
CFUNCTIONEND 203
...
CLINEA 0000H 0001H 03A1H 0002H 0043H
	mov	r0,	#04h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 03A8H 0002H 0051H
...
CLINEA 0000H 0001H 03A9H 0002H 0019H
	push	xr0
	mov	r0,	#0b8h
	mov	r1,	#01eh
	mov	r2,	#085h
...
CLINEA 0000H 0001H 03AAH 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03ACH 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03ADH 0002H 001EH
	b	_$L175
_$L167 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 03AEH 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03AFH 0002H 001EH
	b	_$L175
_$L170 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
;;	else
CLINEA 0000H 0001H 03B1H 0002H 0005H
	bal	_$L175
_$L173 :

;;		flSensorOut[0] = 0;
CLINEA 0000H 0001H 03B2H 0003H 0015H
	mov	er0,	#0 
	st	er0,	NEAR _flSensorOut
	st	er0,	NEAR _flSensorOut+02h
_$L175 :
...
;;}
CLINEA 0000H 0001H 03B6H 0001H 0001H
	pop	xr4
	pop	pc
CBLOCKEND 204 1 950
CFUNCTIONEND 204
...
;;{	
CLINEA 0000H 0001H 03C3H 0001H 0002H
	push	lr
CBLOCK 205 2 963
CRET 0000H

;;	I2C_Read(BH17xxFVC_ADDR_1, NULL, 0, uniRawSensorOut._ucharArr, 2);
CLINEA 0000H 0001H 03C8H 0002H 0043H
	mov	r0,	#02h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
;;	flSensorOut[0] = (uniRawSensorOut._ucharArr[0]<<8|uniRawSensorOut._ucharArr[1])/1.2f;
CLINEA 0000H 0001H 03CCH 0002H 0056H
	l	r0,	NEAR _uniRawSensorOut
	mov	r1,	#00h
	mov	r3,	r0
	l	r0,	NEAR _uniRawSensorOut+01h
...
;;}
CLINEA 0000H 0001H 03D0H 0001H 0001H
	pop	pc
CBLOCKEND 205 1 976
CFUNCTIONEND 205
...
;;{
CLINEA 0000H 0001H 03DDH 0001H 0001H
	push	lr
CBLOCK 206 2 989
CRET 0000H
...
CLINEA 0000H 0001H 03E7H 0002H 0028H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03EAH 0002H 0063H
	...
	bl	_printf_n
	add	sp,	#6 
CBLOCKEND 206 2 1003

;;}
CLINEA 0000H 0001H 03EBH 0001H 0001H
	pop	pc
CBLOCKEND 206 1 1003
CFUNCTIONEND 206
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 03F9H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 03FBH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 03FDH 0002H 0036H
	push	xr0
	mov	r0,	#0cdh
	mov	r1,	#0cch
	mov	r2,	#0ch
...
;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>2)));
CLINEA 0000H 0000H 03FFH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#02h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 0400H 0002H 007AH
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
	...
	bl	_printf_n
	add	sp,	#18
CBLOCKEND 207 2 1025

;;}
CLINEA 0000H 0001H 0401H 0001H 0001H
	pop	pc
CBLOCKEND 207 1 1025
CFUNCTIONEND 207
...
;;{
CLINEA 0000H 0001H 040EH 0001H 0001H
	push	lr
CBLOCK 208 2 1038
CRET 0000H

;;	I2C_Read(KX022_I2C_ADDR, &KX022_XOUTL, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 0413H 0002H 0049H
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0418H 0002H 0042H
...
CLINEA 0000H 0001H 041BH 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 041EH 0002H 0048H
	mov	r0,	#02h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0420H 0002H 0025H
	l	r0,	NEAR _uniRawSensorOut
CBLOCK 208 3 1057
	cmp	r0,	#01h
	beq	_$L190
...
;;	switch(uniRawSensorOut._ucharArr[0])
CLINEA 0000H 0000H 0420H 0002H 0025H
	cmp	r0,	#02h
	beq	_$L191
...
CLINEA 0000H 0000H 0428H 0003H 0028H
	mov	r0,	#00h
CBLOCKEND 208 3 1065

;;	}
CLINEA 0000H 0000H 0429H 0002H 0002H
_$L188 :
	st	r0,	0f260h
CBLOCKEND 208 2 1066
...
CLINEA 0000H 0001H 0426H 0003H 004BH
_$L194 :
	mov	r0,	#080h
	bal	_$L188

;;		case 0x20u:	LEDOUT(0x1u<<0); break;	// LE: Left State (X-). Turn on LED0
CLINEA 0000H 0001H 0427H 0003H 004AH
_$L195 :
	mov	r0,	#01h
	bal	_$L188
CBLOCKEND 208 1 1066
CFUNCTIONEND 208
...
;;{ 
CLINEA 0000H 0001H 0437H 0001H 0002H
	push	lr
CBLOCK 209 2 1079
CRET 0000H

;;	I2C_Read(KMX61_I2C_ADDR, &KMX61_ACCEL_XOUT_L, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 0439H 0002H 0050H
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 043CH 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+04h
	srlc	r0,	#02h
	sra	r1,	#02h
...
CLINEA 0000H 0001H 0440H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut+04h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;		uniRawSensorOut._intArr[0], flSensorOut[0], uniRawSensorOut._intArr[1], flSensorOut[1], uniRawSensorOut._intArr[2], flSensorOut[2]);
CLINEA 0000H 0001H 0442H 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 0444H 0002H 0047H
	mov	er0,	#0 
	mov	r2,	#00h
	mov	r3,	#0bfh
	push	xr0
...
CLINEA 0000H 0001H 0446H 0002H 004CH
	b	_$L245
_$L198 :
	mov	er0,	#0 
	mov	r2,	#00h
...
CLINEA 0000H 0001H 0447H 0003H 0047H
	mov	r0,	#01h
	st	r0,	0f260h

;;	else if(-0.5f<flSensorOut[0] && flSensorOut[0]<0.5f && flSensorOut[1]<-0.5f)
CLINEA 0000H 0001H 0448H 0002H 004DH
	b	_$L245
_$L209 :
	mov	er0,	#0 
	mov	r2,	#00h
...
CLINEA 0000H 0001H 0449H 0003H 0048H
	mov	r0,	#04h
	st	r0,	0f260h

;;	else if(flSensorOut[0]<-0.5f && -0.5f<flSensorOut[1] && flSensorOut[1]<0.5f)
CLINEA 0000H 0001H 044AH 0002H 004DH
	b	_$L245
_$L220 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 044BH 0003H 0048H
	mov	r0,	#080h
	st	r0,	0f260h

;;	else if(flSensorOut[2]>0.5f)
CLINEA 0000H 0001H 044CH 0002H 001DH
	bal	_$L245
_$L231 :
...
CLINEA 0000H 0001H 044DH 0003H 0032H
	mov	r0,	#010h
	st	r0,	0f260h

;;	else if(flSensorOut[2]<-0.5f)
CLINEA 0000H 0001H 044EH 0002H 001EH
	bal	_$L245
_$L242 :
	l	er0,	NEAR _flSensorOut+08h
	l	er2,	NEAR _flSensorOut+0ah
...
CLINEA 0000H 0001H 044FH 0003H 0033H
	mov	r0,	#08h
	st	r0,	0f260h
_$L245 :

;;	I2C_Read(KMX61_I2C_ADDR, &KMX61_MAG_XOUT_L, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 0452H 0002H 004EH
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0459H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut+04h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;		uniRawSensorOut._intArr[0], flSensorOut[0], uniRawSensorOut._intArr[1], flSensorOut[1], uniRawSensorOut._intArr[2], flSensorOut[2]);
CLINEA 0000H 0001H 045BH 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
	...
	bl	_printf_n
	add	sp,	#32
CBLOCKEND 209 2 1116

;;}
CLINEA 0000H 0001H 045CH 0001H 0001H
	pop	pc
CBLOCKEND 209 1 1116
CFUNCTIONEND 209
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 046AH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 046CH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 046EH 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
CLINEA 0000H 0001H 0471H 0002H 0079H
	...
	bl	_printf_n
	add	sp,	#18
CBLOCKEND 210 2 1138

;;}
CLINEA 0000H 0001H 0472H 0001H 0001H
	pop	pc
CBLOCKEND 210 1 1138
CFUNCTIONEND 210
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 0480H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0482H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
;;	flSensorOut[1] = Voltage2Temperature(flSensorOut[0], 1.3f, 30.0f, -0.0082f);
CLINEA 0000H 0001H 0484H 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
CLINEA 0000H 0000H 0486H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#03h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 0487H 0002H 0072H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
...
CLINEA 0000H 0001H 0488H 0002H 001DH
	tb	0f258h.2
	beq	_$L252

;;		PRINTF(ESC_NEWLINE "BDJ0601HFV> Temperature Threshold Reached." ESC_PREVLINE);
CLINEA 0000H 0001H 0489H 0003H 0050H
	mov	er0,	#48
	push	er0
...
_$L255 :
	add	sp,	#2 
CBLOCKEND 211 2 1164

;;}
CLINEA 0000H 0001H 048CH 0001H 0001H
	pop	pc
CBLOCKEND 211 1 1164
CFUNCTIONEND 211
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 049AH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 049CH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 049EH 0002H 0050H
	push	xr0
	mov	r0,	#04eh
	mov	r1,	#062h
	mov	r2,	#0e0h
...
;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>3)));
CLINEA 0000H 0000H 04A0H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#03h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 04A1H 0002H 0070H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
...
;;	if(SENINTF_HDR1_GPIO0(D)==0)
CLINEA 0000H 0001H 04A2H 0002H 001DH
	tb	0f258h.2
	bne	_$L259

;;		PRINTF(ESC_NEWLINE "BDE0600G> Temperature Threshold Reached." ESC_PREVLINE);
CLINEA 0000H 0001H 04A3H 0003H 004EH
	mov	er0,	#46
	push	er0
...
_$L262 :
	add	sp,	#2 
CBLOCKEND 212 2 1190

;;}
CLINEA 0000H 0001H 04A6H 0001H 0001H
	pop	pc
CBLOCKEND 212 1 1190
CFUNCTIONEND 212
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 04B4H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 04B6H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
;;	flSensorOut[1] = Voltage2Temperature(flSensorOut[0], 1.3f, 30.0f, -0.0082f);
CLINEA 0000H 0001H 04B8H 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>3)));
CLINEA 0000H 0000H 04BAH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#03h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 04BBH 0002H 0072H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
...
CLINEA 0000H 0001H 04BDH 0003H 0050H
	mov	er0,	#48
	push	er0
...
_$L269 :
	add	sp,	#2 
CBLOCKEND 213 2 1216

;;}
CLINEA 0000H 0001H 04C0H 0001H 0001H
	pop	pc
CBLOCKEND 213 1 1216
CFUNCTIONEND 213
...
CLINEA 0000H 0001H 04DAH 0002H 001DH
	rb	0f25dh.3
CBLOCKEND 215 2 1243

;;}
CLINEA 0000H 0001H 04DBH 0001H 0001H
	rt
CBLOCKEND 215 1 1243
CFUNCTIONEND 215
...
;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 04EAH 0002H 001DH
	sb	0f259h.2
...
;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 04EDH 0002H 001CH
	sb	0f25bh.2
...
CLINEA 0000H 0001H 04F0H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 214 2 1265

;;}
CLINEA 0000H 0001H 04F1H 0001H 0001H
	rt
CBLOCKEND 214 1 1265
CFUNCTIONEND 214
...
CLINEA 0000H 0001H 050BH 0002H 001DH
	rb	0f25dh.3
CBLOCKEND 216 2 1292

;;}
CLINEA 0000H 0001H 050CH 0001H 0001H
	rt
CBLOCKEND 216 1 1292
CFUNCTIONEND 216
...
CLINEA 0000H 0001H 051DH 0002H 0044H
	mov	r0,	#01h
	push	r0
...
;;	NOPms(24);
CLINEA 0000H 0001H 0522H 0002H 000BH
	mov	er0,	#24
	bl	_NOPms
CBLOCKEND 217 2 1315

;;}
CLINEA 0000H 0001H 0523H 0001H 0001H
	pop	pc
CBLOCKEND 217 1 1315
CFUNCTIONEND 217
...
CLINEA 0000H 0001H 0531H 0002H 001AH
	mov	r0,	#00h
	st	r0,	-1[fp]

;;	I2C_Write(BH17xxFVC_ADDR_2, &BH1730FVC_REG_INTERRUPT, 1, &cTmp, 1);
CLINEA 0000H 0001H 0534H 0002H 0044H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
CLINEA 0000H 0001H 0536H 0002H 003FH
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
CLINEA 0000H 0001H 0539H 0002H 0041H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
;;	cTmp = 0x3;
CLINEA 0000H 0001H 053BH 0002H 000CH
	mov	r0,	#03h
	st	r0,	-1[fp]

;;	I2C_Write(BH17xxFVC_ADDR_2, &BH1730FVC_REG_CONTROL, 1, &cTmp, 1);
CLINEA 0000H 0001H 053CH 0002H 0042H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
;;{	
CLINEA 0000H 0001H 054CH 0001H 0002H
	push	lr
CBLOCK 219 2 1356
CRET 0000H

;;	I2C_Write(BH17xxFVC_ADDR_1, NULL, 0, &BH17xxFVC_PWR_ON, 1);
CLINEA 0000H 0001H 054EH 0002H 003CH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _BH17xxFVC_PWR_ON
	mov	r1,	#BYTE2 OFFSET _BH17xxFVC_PWR_ON
...
CLINEA 0000H 0001H 0550H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
;;	NOPms(180);	
CLINEA 0000H 0001H 0554H 0002H 000DH
	mov	r0,	#0b4h
	mov	r1,	#00h
	bl	_NOPms
CBLOCKEND 219 2 1365

;;}
CLINEA 0000H 0001H 0555H 0001H 0001H
	pop	pc
CBLOCKEND 219 1 1365
CFUNCTIONEND 219
...
CLINEA 0000H 0001H 0567H 0002H 0041H
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 220 2 1384

;;}
CLINEA 0000H 0001H 0568H 0001H 0001H
	pop	pc
CBLOCKEND 220 1 1384
CFUNCTIONEND 220
...
CBLOCK 221 2 1397
CBLOCKEND 221 2 1400

;;}
CLINEA 0000H 0001H 0578H 0001H 0001H
	rt
CBLOCKEND 221 1 1400
CFUNCTIONEND 221
...
CLINEA 0000H 0001H 0586H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0587H 0002H 0046H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0588H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0589H 0002H 004EH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 058BH 0002H 0043H
	mov	r0,	#0c1h
	st	r0,	NEAR _uniRawSensorOut

;;	I2C_Write(KX022_I2C_ADDR, &KX022_CNTL1, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 058CH 0002H 0048H
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 222 2 1421

;;}
CLINEA 0000H 0001H 058DH 0001H 0001H
	pop	pc
CBLOCKEND 222 1 1421
CFUNCTIONEND 222
...
;;{ 
CLINEA 0000H 0001H 059AH 0001H 0002H
	push	lr
CBLOCK 223 2 1434
CRET 0000H

;;	uniRawSensorOut._uchar = 0x03u;
CLINEA 0000H 0001H 059CH 0002H 0020H
	mov	r0,	#03h
	st	r0,	NEAR _uniRawSensorOut

;;	I2C_Write(KMX61_I2C_ADDR, &KMX61_STBY_REG, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 059DH 0002H 004BH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 059FH 0002H 004CH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A1H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A2H 0002H 0046H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A3H 0002H 0052H
	mov	r0,	#01h
	push	r0
...
;;	I2C_Write(KMX61_I2C_ADDR, &KMX61_STBY_REG, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 05A8H 0002H 004BH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 223 2 1449

;;}
CLINEA 0000H 0001H 05A9H 0001H 0001H
	pop	pc
CBLOCKEND 223 1 1449
CFUNCTIONEND 223
...
;;{
CLINEA 0000H 0001H 05B6H 0001H 0001H
CBLOCK 224 2 1462
CBLOCKEND 224 2 1465

;;}
CLINEA 0000H 0001H 05B9H 0001H 0001H
	rt
CBLOCKEND 224 1 1465
CFUNCTIONEND 224
...
;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 05C8H 0002H 001DH
	sb	0f259h.2
...
;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 05CBH 0002H 001CH
	sb	0f25bh.2
...
;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05CEH 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 225 2 1487

;;}
CLINEA 0000H 0001H 05CFH 0001H 0001H
	rt
CBLOCKEND 225 1 1487
CFUNCTIONEND 225
...
;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 05DEH 0002H 001DH
	sb	0f259h.2
...
;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 05E1H 0002H 001CH
	sb	0f25bh.2
...
CLINEA 0000H 0001H 05E4H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 226 2 1509

;;}
CLINEA 0000H 0001H 05E5H 0001H 0001H
	rt
CBLOCKEND 226 1 1509
CFUNCTIONEND 226
...
;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 05F4H 0002H 001DH
	sb	0f259h.2
...
;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 05F7H 0002H 001CH
	sb	0f25bh.2
...
;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05FAH 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 227 2 1531

;;}
CLINEA 0000H 0001H 05FBH 0001H 0001H
	rt
CBLOCKEND 227 1 1531
CFUNCTIONEND 227
...
;;	do {
CLINEA 0000H 0001H 0609H 0002H 0005H
_$L288 :
CBLOCK 179 3 1545

;;		WDTCON = 0x5Au;
CLINEA 0000H 0001H 060AH 0003H 0011H
	mov	r0,	#05ah
	st	r0,	0f00eh
CBLOCKEND 179 3 1547

;;	} while (WDP != 1);
CLINEA 0000H 0000H 060BH 0002H 0014H
	tb	0f00eh.0
	beq	_$L288

;;	WDTCON = 0xA5u;
CLINEA 0000H 0001H 060CH 0002H 0010H
	mov	r0,	#0a5h
	st	r0,	0f00eh
CBLOCKEND 179 2 1549

;;}
CLINEA 0000H 0001H 060DH 0001H 0001H
	rt
CBLOCKEND 179 1 1549
CFUNCTIONEND 179
...
;;{
CLINEA 0000H 0001H 0618H 0001H 0001H
	push	lr
CBLOCK 190 2 1560
CRET 0000H
...
CLINEA 0000H 0001H 0619H 0002H 0054H
	bl	_uart_continue

;;	_flgUartFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 061AH 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __flgUartFin

;;	main_reqNotHalt();				// uncommented 5/2/2013
CLINEA 0000H 0001H 061BH 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 190 2 1564

;;}
CLINEA 0000H 0001H 061CH 0001H 0001H
	pop	pc
CBLOCKEND 190 1 1564
CFUNCTIONEND 190
...
;;{
CLINEA 0000H 0001H 0627H 0001H 0001H
	push	lr
CBLOCK 191 2 1575
CRET 0000H
CARGUMENT 46H 0002H 0000H "size" 02H 00H 01H
...
CLINEA 0000H 0001H 0628H 0002H 0053H
	bl	_i2c_continue

;;	_flgI2CFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0629H 0002H 0025H
	mov	r0,	#01h
	st	r0,	NEAR __flgI2CFin

;;	main_reqNotHalt();				// uncommented 5/2/2013
CLINEA 0000H 0001H 062AH 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 191 2 1579

;;}
CLINEA 0000H 0001H 062BH 0001H 0001H
	pop	pc
CBLOCKEND 191 1 1579
CFUNCTIONEND 191
...
;;	main_reqNotHalt();
CLINEA 0000H 0001H 0637H 0002H 0013H
	bl	_main_reqNotHalt
CBLOCKEND 194 2 1592

;;}
CLINEA 0000H 0001H 0638H 0001H 0001H
	pop	pc
CBLOCKEND 194 1 1592
CFUNCTIONEND 194
...
;;{
CLINEA 0000H 0001H 0642H 0001H 0001H
CBLOCK 195 2 1602

;;	_flgADCFin = 1;
CLINEA 0000H 0001H 0643H 0002H 0010H
	mov	r0,	#01h
	st	r0,	NEAR __flgADCFin
CBLOCKEND 195 2 1604

;;}
CLINEA 0000H 0001H 0644H 0001H 0001H
	rt
CBLOCKEND 195 1 1604
CFUNCTIONEND 195
...
;;{
CLINEA 0000H 0001H 064EH 0001H 0001H
CBLOCK 192 2 1614

;;	_reqNotHalt = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 064FH 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __reqNotHalt
CBLOCKEND 192 2 1616

;;}
CLINEA 0000H 0001H 0650H 0001H 0001H
	rt
CBLOCKEND 192 1 1616
CFUNCTIONEND 192
...
;;{
CLINEA 0000H 0001H 065AH 0001H 0001H
CBLOCK 193 2 1626

;;	uart_continue(); 	//in UART.c: process to continue send and receive...
CLINEA 0000H 0001H 065BH 0002H 0047H
	b	_uart_continue
CBLOCKEND 193 2 1628
CLINEA 0000H 0001H 065CH 0001H 0001H
CBLOCKEND 193 1 1628
CFUNCTIONEND 193
...
CLINEA 0000H 0001H 0661H 0001H 0019H
CBLOCK 181 2 1633

;;	SYSC0 = 0;			// Used to select the frequency of the HSCLK => 00=8.192MHz.
CLINEA 0000H 0001H 0664H 0002H 004AH
	rb	0f002h.0

;;	SYSC1 = 0;
CLINEA 0000H 0001H 0665H 0002H 000BH
	rb	0f002h.1

;;	OSCM1 = 1;			// 10 => Built-in PLL oscillation mode
CLINEA 0000H 0001H 0667H 0002H 0034H
	sb	0f002h.3
...
CLINEA 0000H 0001H 066AH 0002H 0031H
	sb	0f003h.1

;;	SYSCLK = 1;			//1=HSCLK; 0=LSCLK 
CLINEA 0000H 0001H 066BH 0002H 0022H
	sb	0f003h.0

;;	LPLL = 1;			//1=Enables the use of PLL oscillation - ADDED 4/30/2013
CLINEA 0000H 0001H 066DH 0002H 0045H
	sb	0f003h.7

;;	__EI();			//INT enable
CLINEA 0000H 0001H 066FH 0002H 0017H
	ei
CBLOCKEND 181 2 1648

;;}
CLINEA 0000H 0001H 0670H 0001H 0001H
	rt
CBLOCKEND 181 1 1648
CFUNCTIONEND 181
...
;;void PortA_Low(void){
CLINEA 0000H 0001H 0676H 0001H 0015H
CBLOCK 182 2 1654
...
CLINEA 0000H 0001H 0682H 0002H 0031H
	rb	0f251h.2
...
;;	PA0C0  = 1;		
CLINEA 0000H 0001H 0686H 0002H 000EH
	sb	0f252h.0
...
;;	PA1C0  = 1;	
CLINEA 0000H 0001H 0688H 0002H 000DH
	sb	0f252h.1

;;	PA2C1  = 1;		// PortA Bit2 set to CMOS Output...
CLINEA 0000H 0001H 0689H 0002H 0031H
	sb	0f253h.2

;;	PA2C0  = 1;	
CLINEA 0000H 0001H 068AH 0002H 000DH
	sb	0f252h.2

;;	PA0MD1  = 0;	// PortA Bit0 set to General Purpose Output...
CLINEA 0000H 0001H 068DH 0002H 003CH
	rb	0f255h.0

;;	PA0MD0  = 0;	
CLINEA 0000H 0001H 068EH 0002H 000EH
	rb	0f254h.0

;;	PA1MD1  = 0;	// PortA Bit1 set to General Purpose Output...
CLINEA 0000H 0001H 068FH 0002H 003CH
	rb	0f255h.1

;;	PA1MD0  = 0;	
CLINEA 0000H 0001H 0690H 0002H 000EH
	rb	0f254h.1

;;	PA2MD1  = 0;	// PortA Bit2 set to General Purpose Output...
CLINEA 0000H 0001H 0691H 0002H 003CH
	rb	0f255h.2

;;	PA2MD0  = 0;	
CLINEA 0000H 0001H 0692H 0002H 000EH
	rb	0f254h.2
...
CLINEA 0000H 0001H 0697H 0002H 0021H
	rb	0f250h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0699H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 182 2 1690
CLINEA 0000H 0001H 069AH 0001H 0001H
CBLOCKEND 182 1 1690
CFUNCTIONEND 182
...
;;void PortB_Low(void){
CLINEA 0000H 0001H 06A0H 0001H 0015H
CBLOCK 183 2 1696
...
;;	PB0C0  = 1;		
CLINEA 0000H 0001H 06B5H 0002H 000EH
	sb	0f25ah.0
...
;;	PB1C0  = 1;	
CLINEA 0000H 0001H 06B7H 0002H 000DH
	sb	0f25ah.1

;;	PB2C1  = 1;		// PortB Bit2 set to CMOS Output...
CLINEA 0000H 0001H 06B8H 0002H 0031H
	sb	0f25bh.2
...
CLINEA 0000H 0001H 06BAH 0002H 0031H
	sb	0f25bh.3

;;	PB3C0  = 1;		
CLINEA 0000H 0001H 06BBH 0002H 000EH
	sb	0f25ah.3
...
;;	PB4C0  = 1;	
CLINEA 0000H 0001H 06BDH 0002H 000DH
	sb	0f25ah.4
...
;;	PB5C0  = 1;	
CLINEA 0000H 0001H 06BFH 0002H 000DH
	sb	0f25ah.5
...
;;	PB6C0  = 1;	
CLINEA 0000H 0001H 06C1H 0002H 000DH
	sb	0f25ah.6

;;	PB7C1  = 1;		// PortB Bit7 set to CMOS Output...
CLINEA 0000H 0001H 06C2H 0002H 0031H
	sb	0f25bh.7

;;	PB7C0  = 1;	
CLINEA 0000H 0001H 06C3H 0002H 000DH
	sb	0f25ah.7

;;	PB0MD1  = 0;	// PortB Bit0 set to General Purpose Output...
CLINEA 0000H 0001H 06C6H 0002H 003CH
	rb	0f25dh.0

;;	PB0MD0  = 0;	
CLINEA 0000H 0001H 06C7H 0002H 000EH
	rb	0f25ch.0

;;	PB1MD1  = 0;	// PortB Bit1 set to General Purpose Output...
CLINEA 0000H 0001H 06C8H 0002H 003CH
	rb	0f25dh.1

;;	PB1MD0  = 0;	
CLINEA 0000H 0001H 06C9H 0002H 000EH
	rb	0f25ch.1

;;	PB2MD1  = 0;	// PortB Bit2 set to General Purpose Output...
CLINEA 0000H 0001H 06CAH 0002H 003CH
	rb	0f25dh.2

;;	PB2MD0  = 0;	
CLINEA 0000H 0001H 06CBH 0002H 000EH
	rb	0f25ch.2

;;	PB3MD1  = 0;	// PortB Bit3 set to General Purpose Output...
CLINEA 0000H 0001H 06CCH 0002H 003CH
	rb	0f25dh.3

;;	PB3MD0  = 0;	
CLINEA 0000H 0001H 06CDH 0002H 000EH
	rb	0f25ch.3

;;	PB4MD1  = 0;	// PortB Bit4 set to General Purpose Output...
CLINEA 0000H 0001H 06CEH 0002H 003CH
	rb	0f25dh.4

;;	PB4MD0  = 0;	
CLINEA 0000H 0001H 06CFH 0002H 000EH
	rb	0f25ch.4

;;	PB5MD1  = 0;	// PortB Bit5 set to General Purpose Output...
CLINEA 0000H 0001H 06D0H 0002H 003CH
	rb	0f25dh.5

;;	PB5MD0  = 0;
CLINEA 0000H 0001H 06D1H 0002H 000DH
	rb	0f25ch.5

;;	PB6MD1  = 0;	// PortB Bit6 set to General Purpose Output...
CLINEA 0000H 0001H 06D2H 0002H 003CH
	rb	0f25dh.6

;;	PB6MD0  = 0;	
CLINEA 0000H 0001H 06D3H 0002H 000EH
	rb	0f25ch.6

;;	PB7MD1  = 0;	// PortB Bit7 set to General Purpose Output...
CLINEA 0000H 0001H 06D4H 0002H 003CH
	rb	0f25dh.7

;;	PB7MD0  = 0;
CLINEA 0000H 0001H 06D5H 0002H 000DH
	rb	0f25ch.7
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 06E1H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 183 2 1762
CLINEA 0000H 0001H 06E2H 0001H 0001H
CBLOCKEND 183 1 1762
CFUNCTIONEND 183
...
;;void PortC_Low(void){
CLINEA 0000H 0001H 06E8H 0001H 0015H
CBLOCK 184 2 1768
...
CLINEA 0000H 0001H 06FCH 0002H 003BH
	sb	0f263h.0

;;	PC0C0  = 1;		
CLINEA 0000H 0001H 06FDH 0002H 000EH
	sb	0f262h.0

;;	PC1C1  = 1;		// PortC Bit1 set to High-Impedance Output...
CLINEA 0000H 0001H 06FEH 0002H 003BH
	sb	0f263h.1
...
CLINEA 0000H 0001H 0700H 0002H 003BH
	sb	0f263h.2

;;	PC2C0  = 1;	
CLINEA 0000H 0001H 0701H 0002H 000DH
	sb	0f262h.2

;;	PC3C1  = 1;		// PortC Bit3 set to High-Impedance Output...
CLINEA 0000H 0001H 0702H 0002H 003BH
	sb	0f263h.3

;;	PC3C0  = 1;		
CLINEA 0000H 0001H 0703H 0002H 000EH
	sb	0f262h.3

;;	PC4C1  = 1;		// PortC Bit4 set to High-Impedance Output...
CLINEA 0000H 0001H 0704H 0002H 003BH
	sb	0f263h.4
...
CLINEA 0000H 0001H 0706H 0002H 003BH
	sb	0f263h.5
...
CLINEA 0000H 0001H 0708H 0002H 003BH
	sb	0f263h.6
...
CLINEA 0000H 0001H 070AH 0002H 003BH
	sb	0f263h.7
...
;;	PC4MD0  = 0;	
CLINEA 0000H 0001H 0717H 0002H 000EH
	rb	0f264h.4
...
;;	PC5MD0  = 0;
CLINEA 0000H 0001H 0719H 0002H 000DH
	rb	0f264h.5
...
;;	PC6MD0  = 0;	
CLINEA 0000H 0001H 071BH 0002H 000EH
	rb	0f264h.6

;;	PC7MD1  = 0;	// PortC Bit7 set to General Purpose Output...
CLINEA 0000H 0001H 071CH 0002H 003CH
	rb	0f265h.7

;;	PC7MD0  = 0;
CLINEA 0000H 0001H 071DH 0002H 000DH
	rb	0f264h.7
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0729H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 184 2 1835
CLINEA 0000H 0001H 072BH 0001H 0001H
CBLOCKEND 184 1 1835
CFUNCTIONEND 184
...
;;void PortD_Low(void){
CLINEA 0000H 0001H 0731H 0001H 0015H
CBLOCK 185 2 1841
...
CLINEA 0000H 0001H 0742H 0002H 0038H
	sb	0f26bh.0

;;	PD0C0= 1;		
CLINEA 0000H 0001H 0743H 0002H 000CH
	sb	0f26ah.0

;;	PD1C1= 1;		// PortD Bit1 set to High-impedance input...
CLINEA 0000H 0001H 0744H 0002H 0038H
	sb	0f26bh.1

;;	PD1C0= 1;	
CLINEA 0000H 0001H 0745H 0002H 000BH
	sb	0f26ah.1

;;	PD2C1= 1;		// PortD Bit2 set to High-impedance input...
CLINEA 0000H 0001H 0746H 0002H 0038H
	sb	0f26bh.2

;;	PD2C0= 1;	
CLINEA 0000H 0001H 0747H 0002H 000BH
	sb	0f26ah.2

;;	PD3C1= 1;		// PortD Bit3 set to High-impedance input...
CLINEA 0000H 0001H 0748H 0002H 0038H
	sb	0f26bh.3

;;	PD3C0= 1;		
CLINEA 0000H 0001H 0749H 0002H 000CH
	sb	0f26ah.3

;;	PD4C1= 1;		// PortD Bit4 set to High-impedance input...
CLINEA 0000H 0001H 074AH 0002H 0038H
	sb	0f26bh.4

;;	PD4C0= 1;	
CLINEA 0000H 0001H 074BH 0002H 000BH
	sb	0f26ah.4

;;	PD5C1= 1;		// PortD Bit5 set to High-impedance input...
CLINEA 0000H 0001H 074CH 0002H 0038H
	sb	0f26bh.5

;;	PD5C0= 1;	
CLINEA 0000H 0001H 074DH 0002H 000BH
	sb	0f26ah.5
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0757H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 185 2 1880
CLINEA 0000H 0001H 0758H 0001H 0001H
CBLOCKEND 185 1 1880
CFUNCTIONEND 185
...
;;	TimeFlag = 0;
CLINEA 0000H 0001H 076EH 0002H 000EH
	mov	r6,	#00h

;;	tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 0770H 0002H 0016H
	mov	r0,	#01h
	bl	_tm_init
...
;;	if(ms < 128){
CLINEA 0000H 0001H 0774H 0002H 000EH
	mov	er0,	er8
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bge	_$L302
...
;;		timerThres = 0x1FF * ms;
CLINEA 0000H 0001H 0775H 0003H 001AH
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
...
;;		TimeFlag = 0;
CLINEA 0000H 0001H 0776H 0003H 000FH
CBLOCKEND 196 3 1911

;;	}
CLINEA 0000H 0000H 0777H 0002H 0002H
_$L302 :

;;	if(ms == 128){
CLINEA 0000H 0001H 0778H 0002H 000FH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bne	_$L304
CBLOCK 196 4 1912
...
;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0779H 0003H 0016H
	mov	bp,	#-1

;;		TimeFlag = 0;
CLINEA 0000H 0001H 077AH 0003H 000FH
	mov	r6,	#00h
CBLOCKEND 196 4 1915

;;	}
CLINEA 0000H 0000H 077BH 0002H 0002H
_$L304 :

;;	if(ms > 128){
CLINEA 0000H 0001H 077CH 0002H 000EH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	ble	_$L314
CBLOCK 196 5 1916
...
;;		while(TempSec > 128){
CLINEA 0000H 0000H 077DH 0001H 0001H
	bal	_$L324

;;		while(TempSec > 128){
CLINEA 0000H 0000H 077DH 0003H 0017H
_$L310 :
CBLOCK 196 6 1917

;;			TempSec -= 128;
CLINEA 0000H 0001H 077EH 0004H 0012H
	add	r0,	#080h
	addc	r1,	#0ffh
	mov	er4,	er0

;;			TimeFlag++;
CLINEA 0000H 0000H 077FH 0004H 000EH
	add	r6,	#01h
CBLOCKEND 196 6 1920
...
;;		if(TempSec != 0){
CLINEA 0000H 0001H 0781H 0003H 0013H
	mov	er4,	er4
	beq	_$L312
CBLOCK 196 7 1921

;;			timerThres = 0x1FF * TempSec;
CLINEA 0000H 0001H 0782H 0004H 0020H
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
	...
	subc	r1,	r5
	mov	bp,	er0
CBLOCKEND 196 7 1923

;;		else{
CLINEA 0000H 0001H 0784H 0003H 0007H
	bal	_$L314
_$L312 :
CBLOCK 196 8 1924

;;			timerThres = 0xFFFF;
CLINEA 0000H 0001H 0785H 0004H 0017H
	mov	bp,	#-1

;;			TimeFlag--;
CLINEA 0000H 0000H 0786H 0004H 000EH
	add	r6,	#0ffh
CBLOCKEND 196 8 1927

;;		}
CLINEA 0000H 0000H 0787H 0003H 0003H
_$L314 :
CBLOCKEND 196 5 1928

;;	main_clrWDT();	
CLINEA 0000H 0001H 078BH 0002H 0010H
	bl	_main_clrWDT
...
CLINEA 0000H 0001H 078FH 0002H 001BH
	bal	_$L317
_$L319 :
CBLOCK 196 9 1935
...
;;		timer = tm_getABCounter();
CLINEA 0000H 0000H 0790H 0003H 001CH
CBLOCKEND 196 9 1938

;;	}
CLINEA 0000H 0000H 0792H 0002H 0002H
_$L317 :

;;	while(timer < timerThres){
CLINEA 0000H 0000H 078FH 0000H 0000H
	cmp	er0,	bp
	blt	_$L319

;;	if(TimeFlag !=0){
CLINEA 0000H 0001H 0793H 0002H 0012H
	cmp	r6,	#00h
	beq	_$L322
...
;;		TimeFlag--;
CLINEA 0000H 0000H 0795H 0003H 000DH
	add	r6,	#0ffh

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0796H 0003H 0016H
	mov	bp,	#-1

;;		goto TimerRestart;
CLINEA 0000H 0001H 0797H 0003H 0014H
	bal	_$L314

;;	}
CLINEA 0000H 0000H 0798H 0002H 0002H
_$L322 :
CBLOCKEND 196 2 1945
...
;;{
CLINEA 0000H 0001H 07A3H 0001H 0001H
CBLOCK 197 2 1955
CARGUMENT 46H 0001H 0000H "data" 02H 00H 00H

;;");
CLINEA 0000H 0001H 07B1H 0001H 0003H
...
CBLOCKEND 197 2 1970

;;}
CLINEA 0000H 0001H 07B2H 0001H 0001H
	rt
CBLOCKEND 197 1 1970
CFUNCTIONEND 197
