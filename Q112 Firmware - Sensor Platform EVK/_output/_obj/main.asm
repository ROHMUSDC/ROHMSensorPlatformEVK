...
CFILE 0000H 000007D1H "main\\main.c"
...
CLINEA 0000H 0001H 020EH 0002H 003EH
	bl	_PortD_Low

;;    SetOSC();
CLINEA 0000H 0001H 0211H 0005H 000DH
	bl	_SetOSC

;;	PA0DIR = 1;
CLINEA 0000H 0001H 0214H 0002H 000CH
	sb	0f251h.0

;;	PA1DIR = 1;		//GPIO Input
CLINEA 0000H 0001H 0215H 0002H 001AH
	sb	0f251h.1

;;	SACH0 = 1;		//This enables the ADC Channel 0 from A0 Pin
CLINEA 0000H 0001H 0216H 0002H 0039H
	sb	0f2f2h.0

;;	SACH1 = 1;		//This enables the ADC Channel 1 from A1 Pin
CLINEA 0000H 0001H 0217H 0002H 0039H
	sb	0f2f2h.1

;;	SALP = 0;		//Single Read or Continuous Read... Single = 0, Consecutive = 1
CLINEA 0000H 0001H 0218H 0002H 004BH
	rb	0f2f0h.0

;;	irq_di();	// Disable Interrupts
CLINEA 0000H 0001H 021CH 0002H 0020H
	bl	_irq_di

;;	irq_init();	// Initialize Interrupts (All Off and NO Requests)
CLINEA 0000H 0001H 021DH 0002H 003FH
	bl	_irq_init

;;	IE0 = IE1 = IE2 = IE3 = IE4 = IE5 = IE6 = IE7 = 0;
CLINEA 0000H 0001H 0220H 0002H 0033H
	mov	r0,	#00h
	st	r0,	0f017h
	st	r0,	0f016h
	st	r0,	0f015h
...
CLINEA 0000H 0001H 0222H 0002H 003BH
	st	r0,	0f01fh
	st	r0,	0f01eh
	st	r0,	0f01dh
	st	r0,	0f01ch
...
CLINEA 0000H 0001H 0227H 0002H 004AH
	sb	0f014h.0
...
;;	EI2CM = 1;
CLINEA 0000H 0001H 022AH 0002H 000BH
	sb	0f012h.7

;;	QI2CM = 0;
CLINEA 0000H 0001H 022BH 0002H 000BH
	rb	0f01ah.7

;;	irq_setHdr((unsigned char)IRQ_NO_SADINT, _intADC);
CLINEA 0000H 0001H 022EH 0002H 0033H
...
;;	ESAD = 1;
CLINEA 0000H 0001H 022FH 0002H 000AH
	sb	0f012h.2

;;	QSAD = 0;
CLINEA 0000H 0001H 0230H 0002H 000AH
	rb	0f01ah.2

;;	irq_ei(); // Enable Interrupts
CLINEA 0000H 0001H 023CH 0002H 001FH
	bl	_irq_ei

;;	WDTMOD = 0x01; 	
CLINEA 0000H 0001H 0248H 0002H 0011H
	mov	r0,	#01h
	st	r0,	0f00fh

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0249H 0002H 001DH
	bl	_main_clrWDT

;;	i2c_init(I2C_MOD_FST, (unsigned short)HSCLK_KHZ, I2C_SYN_OFF);
CLINEA 0000H 0001H 024FH 0002H 003FH
	mov	r0,	#00h
	push	r0
	mov	r2,	#040h
	mov	r3,	#01fh
...
;;			   &_uartSetParam );				/* Param... 	 */
CLINEA 0000H 0001H 0254H 0007H 002BH
...
;;	uart_PortSet();
CLINEA 0000H 0001H 0255H 0002H 0010H
	bl	_uart_PortSet
CBLOCKEND 180 2 601

;;}//End Initialization
CLINEA 0000H 0001H 0259H 0001H 0015H
	pop	pc
CBLOCKEND 180 1 601
CFUNCTIONEND 180
...
;;{
CLINEA 0000H 0001H 0267H 0001H 0001H
	push	lr
	push	fp
	mov	fp,	sp
	push	er10
...
CLINEA 0000H 0001H 026AH 0002H 002CH
...
;;	while(_flgUartFin != 1)
CLINEA 0000H 0000H 026BH 0001H 0001H
	bal	_$L60

;;	while(_flgUartFin != 1)
CLINEA 0000H 0000H 026BH 0002H 0018H
_$L58 :
CBLOCK 186 3 620

;;		main_clrWDT();
CLINEA 0000H 0001H 026DH 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 186 3 622
...
;;	return len;
CLINEA 0000H 0001H 026FH 0002H 000CH
	l	er0,	4[fp]
CBLOCKEND 186 2 624

;;}
CLINEA 0000H 0000H 0270H 0001H 0001H
	pop	er10
	mov	sp,	fp
	pop	fp
	pop	pc
...
;;	_flgADCFin = 0;
CLINEA 0000H 0001H 027CH 0002H 0010H
	mov	r0,	#00h
	st	r0,	NEAR __flgADCFin

;;	SADMOD0 = (unsigned char)(1<<idx);
CLINEA 0000H 0001H 027DH 0002H 0023H
	mov	er0,	#1 
	mov	r2,	r8
_$M6 :
	cmp	r2,	#07h
...
;;	SARUN = 1;
CLINEA 0000H 0001H 027EH 0002H 000BH
	sb	0f2f1h.0
...
;;	while(_flgADCFin == 0)
CLINEA 0000H 0000H 027FH 0002H 0017H
_$L64 :
CBLOCK 187 3 640

;;		main_clrWDT();
CLINEA 0000H 0001H 0281H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 187 3 642
...
;;	switch(idx)
CLINEA 0000H 0001H 0283H 0002H 000CH
	mov	r0,	r8
	mov	r1,	#00h
CBLOCK 187 4 644
	cmp	r8,	#07h
...
;;		default:	return 0;
CLINEA 0000H 0001H 028DH 0003H 0014H
_$L70 :
	mov	er0,	#0 
	b	_$L61
CBLOCKEND 187 4 654
...
;;{
CLINEA 0000H 0001H 029EH 0001H 0001H
	push	lr
	push	fp
	mov	fp,	sp
	push	xr8
...
;;	_flgI2CFin = 0;
CLINEA 0000H 0001H 029FH 0002H 0010H
	mov	r0,	#00h
...
CLINEA 0000H 0001H 02A1H 0002H 0063H
...
;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02A2H 0002H 0017H
_$L83 :
CBLOCK 188 3 675

;;		main_clrWDT();
CLINEA 0000H 0001H 02A4H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 188 3 677
...
;;	_flgI2CFin = 0;
CLINEA 0000H 0001H 02B6H 0002H 0010H
	mov	r0,	#00h
	st	r0,	NEAR __flgI2CFin
...
CLINEA 0000H 0001H 02B8H 0002H 0060H
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	l	r0,	8[fp]
...
;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02B9H 0001H 0001H
	bal	_$L91

;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02B9H 0002H 0017H
_$L89 :
CBLOCK 189 3 698

;;		main_clrWDT();
CLINEA 0000H 0001H 02BBH 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 189 3 700
...
;;}
CLINEA 0000H 0001H 02BDH 0001H 0001H
	pop	xr8
	mov	sp,	fp
	pop	fp
	pop	pc
...
;;{  
CLINEA 0000H 0001H 02C9H 0001H 0003H
CBLOCK 199 2 713
...
CLINEA 0000H 0001H 02D8H 0003H 001EH
	mov	r0,	#01h
	st	r0,	NEAR _SensorIntializationFlag

;;		SensorPlatformSelection = PDD;
CLINEA 0000H 0001H 02D9H 0003H 0020H
	l	r0,	0f268h
	st	r0,	NEAR _SensorPlatformSelection
CBLOCKEND 199 3 730

;;	}
CLINEA 0000H 0000H 02DAH 0002H 0002H
_$L93 :
CBLOCKEND 199 2 731
...
;;{  
CLINEA 0000H 0001H 02E5H 0001H 0003H
	push	lr
CBLOCK 200 2 741
CRET 0000H
...
CLINEA 0000H 0001H 02E8H 0004H 0055H
...
CLINEA 0000H 0001H 02EBH 0004H 0056H
...
;;		case 5: 
CLINEA 0000H 0001H 02EDH 0003H 000AH
_$S103 :
...
CLINEA 0000H 0001H 02FDH 0004H 004DH
...
CLINEA 0000H 0001H 0300H 0004H 0046H
	bl	_Init_KX022
...
CLINEA 0000H 0001H 0306H 0004H 0056H
...
CLINEA 0000H 0001H 0309H 0004H 0055H
...
CLINEA 0000H 0001H 030CH 0004H 0056H
...
CLINEA 0000H 0001H 030FH 0004H 0055H
	bl	_Init_Temperature_Sensor_23

;;			break; 
CLINEA 0000H 0001H 0310H 0004H 000AH
	bal	_$L99
...
;;			break;
CLINEA 0000H 0001H 0312H 0004H 0009H
	bal	_$L99
CBLOCKEND 200 3 787
CBLOCKEND 200 1 788
CFUNCTIONEND 200
...
CLINEA 0000H 0001H 0322H 0002H 0039H
	tb	0f258h.2
	beq	_$L116
	tb	0f258h.3
	beq	_$L116
...
CLINEA 0000H 0001H 0324H 0003H 0023H
	mov	r0,	#00h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – No Mag Fields Detected." ESC_SOL);
CLINEA 0000H 0001H 0325H 0003H 004FH
	mov	er0,	#49
	push	er0
...
CLINEA 0000H 0001H 0327H 0002H 003EH
	bal	_$L142
_$L116 :
	tb	0f258h.2
	beq	_$L125
...
CLINEA 0000H 0001H 0329H 0003H 001FH
	mov	r0,	#02h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – North Mag Field Detected." ESC_SOL);
CLINEA 0000H 0001H 032AH 0003H 0051H
	mov	er0,	#51
	push	er0
...
CLINEA 0000H 0001H 032CH 0002H 003EH
	bal	_$L142
_$L125 :
	tb	0f258h.2
	bne	_$L134
...
CLINEA 0000H 0001H 032EH 0003H 001FH
	mov	r0,	#080h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – South Mag Field Detected." ESC_SOL);
CLINEA 0000H 0001H 032FH 0003H 0051H
	mov	er0,	#51
	push	er0
...
;;	else
CLINEA 0000H 0001H 0331H 0002H 0005H
	bal	_$L142
_$L134 :
CBLOCK 202 6 818

;;		LEDOUT(0x82);	// Turn on LED7 and LED1
CLINEA 0000H 0001H 0333H 0003H 0028H
	mov	r0,	#082h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – Both Mag Fields Detected." ESC_SOL);
CLINEA 0000H 0001H 0334H 0003H 0051H
	mov	er0,	#51
	push	er0
...
;;}
CLINEA 0000H 0001H 0336H 0001H 0001H
	pop	pc
CBLOCKEND 202 1 822
CFUNCTIONEND 202
...
CLINEA 0000H 0001H 0344H 0002H 001DH
	tb	0f258h.2
	bne	_$L145
CBLOCK 201 3 837

;;		LEDOUT(0x80);	// Turn on LED7
CLINEA 0000H 0001H 0346H 0003H 001FH
	mov	r0,	#080h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52011HFV> Hall – Mag Field Detected." ESC_SOL);
CLINEA 0000H 0001H 0347H 0003H 004BH
	mov	er0,	#45
	push	er0
...
;;	else
CLINEA 0000H 0001H 0349H 0002H 0005H
	bal	_$L148
_$L145 :
CBLOCK 201 4 842

;;		LEDOUT(0x0);	// Turn off all LEDs
CLINEA 0000H 0001H 034BH 0003H 0023H
	mov	r0,	#00h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52011HFV> Hall – No Mag Fields Detected." ESC_SOL);
CLINEA 0000H 0001H 034CH 0003H 004FH
	mov	er0,	#49
	push	er0
...
;;	}
CLINEA 0000H 0000H 034DH 0002H 0002H
_$L148 :
	add	sp,	#2 
CBLOCKEND 201 2 846
...
;;{	
CLINEA 0000H 0001H 035BH 0001H 0002H
	push	lr
CBLOCK 203 2 859
CRET 0000H

;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 035CH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 035EH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 0363H 0002H 0037H
	l	r0,	0f258h
	srl	r0,	#03h
	and	r0,	#01h
	mov	r1,	#00h
...
;;	switch(SENINTF_HDR1_GPIO1(D)<<1|SENINTF_HDR1_GPIO0(D))
CLINEA 0000H 0000H 0363H 0002H 0037H
	cmp	r2,	#01h
	beq	_$L156
...
;;		case 0:	// Shutdown
CLINEA 0000H 0001H 036EH 0003H 0015H
_$L159 :

;;			flSensorOut[0] = 0;
CLINEA 0000H 0001H 0370H 0004H 0016H
	mov	er0,	#0 
	st	er0,	NEAR _flSensorOut
...
;;	}
CLINEA 0000H 0000H 0372H 0002H 0002H
_$L154 :

;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>2)));
CLINEA 0000H 0000H 0374H 0002H 0040H
...
CLINEA 0000H 0001H 0375H 0002H 0063H
...
;;		case 1: // H-Gain mode
CLINEA 0000H 0001H 0365H 0003H 0018H
_$L156 :

;;			flSensorOut[0] = flSensorOut[0]/(0.57e-6f*5.6e3f);
CLINEA 0000H 0001H 0366H 0004H 0035H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#0e0h
...
;;			break;
CLINEA 0000H 0001H 0367H 0004H 0009H
	bal	_$L154
...
CLINEA 0000H 0001H 0369H 0004H 0036H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#04dh
...
CLINEA 0000H 0001H 036CH 0004H 0037H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#0d7h
...
CLINEA 0000H 0001H 0389H 0002H 0043H
	mov	r0,	#02h
	push	r0
...
CLINEA 0000H 0001H 038DH 0002H 0056H
...
;;}
CLINEA 0000H 0001H 0391H 0001H 0001H
	pop	pc
CBLOCKEND 204 1 913
CFUNCTIONEND 204
...
;;{
CLINEA 0000H 0001H 039EH 0001H 0001H
	push	lr
	push	xr4
CBLOCK 205 2 926
CRET 0004H
...
CLINEA 0000H 0001H 03A4H 0002H 0043H
	mov	r0,	#04h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 03ABH 0002H 0051H
...
CLINEA 0000H 0001H 03ACH 0002H 0019H
	push	xr0
	mov	r0,	#0b8h
	mov	r1,	#01eh
	mov	r2,	#085h
...
;;	else
CLINEA 0000H 0001H 03B4H 0002H 0005H
	bal	_$L175
_$L173 :

;;		flSensorOut[0] = 0;
CLINEA 0000H 0001H 03B5H 0003H 0015H
	mov	er0,	#0 
	st	er0,	NEAR _flSensorOut
	st	er0,	NEAR _flSensorOut+02h
_$L175 :
...
;;}
CLINEA 0000H 0001H 03B9H 0001H 0001H
	pop	xr4
	pop	pc
CBLOCKEND 205 1 953
CFUNCTIONEND 205
...
;;{	
CLINEA 0000H 0001H 03C6H 0001H 0002H
	push	lr
CBLOCK 206 2 966
CRET 0000H

;;	I2C_Read(BH17xxFVC_ADDR_1, NULL, 0, uniRawSensorOut._ucharArr, 2);
CLINEA 0000H 0001H 03CBH 0002H 0043H
	mov	r0,	#02h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
;;	flSensorOut[0] = (uniRawSensorOut._ucharArr[0]<<8|uniRawSensorOut._ucharArr[1])/1.2f;
CLINEA 0000H 0001H 03CFH 0002H 0056H
	l	r0,	NEAR _uniRawSensorOut
	mov	r1,	#00h
	mov	r3,	r0
	l	r0,	NEAR _uniRawSensorOut+01h
...
;;}
CLINEA 0000H 0001H 03D3H 0001H 0001H
	pop	pc
CBLOCKEND 206 1 979
CFUNCTIONEND 206
...
CLINEA 0000H 0001H 03E6H 0002H 0043H
	mov	r0,	#02h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 03EAH 0002H 0028H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03EDH 0002H 0063H
	...
	bl	_printf_n
	add	sp,	#6 
CBLOCKEND 207 2 1006

;;}
CLINEA 0000H 0001H 03EEH 0001H 0001H
	pop	pc
CBLOCKEND 207 1 1006
CFUNCTIONEND 207
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 03FCH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 03FEH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>2)));
CLINEA 0000H 0000H 0402H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#02h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 0403H 0002H 007AH
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
	...
	bl	_printf_n
	add	sp,	#18
CBLOCKEND 208 2 1028

;;}
CLINEA 0000H 0001H 0404H 0001H 0001H
	pop	pc
CBLOCKEND 208 1 1028
CFUNCTIONEND 208
...
;;{
CLINEA 0000H 0001H 0411H 0001H 0001H
	push	lr
CBLOCK 209 2 1041
CRET 0000H

;;	I2C_Read(KX022_I2C_ADDR, &KX022_XOUTL, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 0416H 0002H 0049H
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0419H 0002H 0042H
	l	er0,	NEAR _uniRawSensorOut
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 041AH 0002H 0042H
	l	er0,	NEAR _uniRawSensorOut+02h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 041EH 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 0421H 0002H 0048H
	mov	r0,	#02h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0423H 0002H 0025H
	l	r0,	NEAR _uniRawSensorOut
CBLOCK 209 3 1060
	cmp	r0,	#01h
	beq	_$L190
...
;;	switch(uniRawSensorOut._ucharArr[0])
CLINEA 0000H 0000H 0423H 0002H 0025H
	cmp	r0,	#02h
	beq	_$L191
...
CLINEA 0000H 0000H 042BH 0003H 0028H
	mov	r0,	#00h
CBLOCKEND 209 3 1068

;;	}
CLINEA 0000H 0000H 042CH 0002H 0002H
_$L188 :
	st	r0,	0f260h
CBLOCKEND 209 2 1069
...
;;{ 
CLINEA 0000H 0001H 043AH 0001H 0002H
	push	lr
CBLOCK 210 2 1082
CRET 0000H

;;	I2C_Read(KMX61_I2C_ADDR, &KMX61_ACCEL_XOUT_L, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 043CH 0002H 0050H
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 043DH 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut
...
CLINEA 0000H 0001H 043EH 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+02h
	srlc	r0,	#02h
	sra	r1,	#02h
...
CLINEA 0000H 0001H 043FH 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+04h
	srlc	r0,	#02h
	sra	r1,	#02h
...
CLINEA 0000H 0001H 0441H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 0442H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut+02h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 0443H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut+04h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;		uniRawSensorOut._intArr[0], flSensorOut[0], uniRawSensorOut._intArr[1], flSensorOut[1], uniRawSensorOut._intArr[2], flSensorOut[2]);
CLINEA 0000H 0001H 0445H 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 0447H 0002H 0047H
	mov	er0,	#0 
	mov	r2,	#00h
	mov	r3,	#0bfh
	push	xr0
...
CLINEA 0000H 0001H 0448H 0003H 0047H
	mov	r0,	#020h
	st	r0,	0f260h
...
CLINEA 0000H 0001H 044AH 0003H 0047H
	mov	r0,	#01h
	st	r0,	0f260h

;;	else if(-0.5f<flSensorOut[0] && flSensorOut[0]<0.5f && flSensorOut[1]<-0.5f)
CLINEA 0000H 0001H 044BH 0002H 004DH
	b	_$L245
_$L209 :
	mov	er0,	#0 
	mov	r2,	#00h
...
CLINEA 0000H 0001H 044CH 0003H 0048H
	mov	r0,	#04h
	st	r0,	0f260h

;;	else if(flSensorOut[0]<-0.5f && -0.5f<flSensorOut[1] && flSensorOut[1]<0.5f)
CLINEA 0000H 0001H 044DH 0002H 004DH
	b	_$L245
_$L220 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 044EH 0003H 0048H
	mov	r0,	#080h
	st	r0,	0f260h

;;	else if(flSensorOut[2]>0.5f)
CLINEA 0000H 0001H 044FH 0002H 001DH
	bal	_$L245
_$L231 :
...
CLINEA 0000H 0001H 0450H 0003H 0032H
	mov	r0,	#010h
	st	r0,	0f260h

;;	else if(flSensorOut[2]<-0.5f)
CLINEA 0000H 0001H 0451H 0002H 001EH
	bal	_$L245
_$L242 :
	l	er0,	NEAR _flSensorOut+08h
	l	er2,	NEAR _flSensorOut+0ah
...
CLINEA 0000H 0001H 0452H 0003H 0033H
	mov	r0,	#08h
	st	r0,	0f260h
_$L245 :

;;	I2C_Read(KMX61_I2C_ADDR, &KMX61_MAG_XOUT_L, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 0455H 0002H 004EH
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
;;	uniRawSensorOut._intArr[0] = uniRawSensorOut._intArr[0]>>2;
CLINEA 0000H 0001H 0456H 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut
...
;;	uniRawSensorOut._intArr[1] = uniRawSensorOut._intArr[1]>>2;
CLINEA 0000H 0001H 0457H 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+02h
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut+02h
...
;;	uniRawSensorOut._intArr[2] = uniRawSensorOut._intArr[2]>>2;
CLINEA 0000H 0001H 0458H 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+04h
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 045AH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 045BH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut+02h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 045CH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut+04h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;		uniRawSensorOut._intArr[0], flSensorOut[0], uniRawSensorOut._intArr[1], flSensorOut[1], uniRawSensorOut._intArr[2], flSensorOut[2]);
CLINEA 0000H 0001H 045EH 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
	...
	bl	_printf_n
	add	sp,	#32
CBLOCKEND 210 2 1119

;;}
CLINEA 0000H 0001H 045FH 0001H 0001H
	pop	pc
CBLOCKEND 210 1 1119
CFUNCTIONEND 210
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 046DH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 046FH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 0471H 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
CLINEA 0000H 0001H 0474H 0002H 0079H
	...
	bl	_printf_n
	add	sp,	#18
CBLOCKEND 211 2 1141

;;}
CLINEA 0000H 0001H 0475H 0001H 0001H
	pop	pc
CBLOCKEND 211 1 1141
CFUNCTIONEND 211
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 0483H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0485H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
;;	flSensorOut[1] = Voltage2Temperature(flSensorOut[0], 1.3f, 30.0f, -0.0082f);
CLINEA 0000H 0001H 0487H 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
CLINEA 0000H 0000H 0489H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#03h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 048AH 0002H 0072H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
...
CLINEA 0000H 0001H 048BH 0002H 001DH
	tb	0f258h.2
	beq	_$L252

;;		PRINTF(ESC_NEWLINE "BDJ0601HFV> Temperature Threshold Reached." ESC_PREVLINE);
CLINEA 0000H 0001H 048CH 0003H 0050H
	mov	er0,	#48
	push	er0
...
_$L255 :
	add	sp,	#2 
CBLOCKEND 212 2 1167

;;}
CLINEA 0000H 0001H 048FH 0001H 0001H
	pop	pc
CBLOCKEND 212 1 1167
CFUNCTIONEND 212
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 049DH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 049FH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 04A1H 0002H 0050H
	push	xr0
	mov	r0,	#04eh
	mov	r1,	#062h
	mov	r2,	#0e0h
...
;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>3)));
CLINEA 0000H 0000H 04A3H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#03h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 04A4H 0002H 0070H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
...
CLINEA 0000H 0001H 04A6H 0003H 004EH
	mov	er0,	#46
	push	er0
...
_$L262 :
	add	sp,	#2 
CBLOCKEND 213 2 1193

;;}
CLINEA 0000H 0001H 04A9H 0001H 0001H
	pop	pc
CBLOCKEND 213 1 1193
CFUNCTIONEND 213
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 04B7H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 04B9H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
;;	flSensorOut[1] = Voltage2Temperature(flSensorOut[0], 1.3f, 30.0f, -0.0082f);
CLINEA 0000H 0001H 04BBH 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>3)));
CLINEA 0000H 0000H 04BDH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#03h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 04BEH 0002H 0072H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
...
CLINEA 0000H 0001H 04C0H 0003H 0050H
	mov	er0,	#48
	push	er0
...
_$L269 :
	add	sp,	#2 
CBLOCKEND 214 2 1219

;;}
CLINEA 0000H 0001H 04C3H 0001H 0001H
	pop	pc
CBLOCKEND 214 1 1219
CFUNCTIONEND 214
...
CLINEA 0000H 0001H 04D2H 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO1(DIR) = 1;
CLINEA 0000H 0001H 04D3H 0002H 001DH
	sb	0f259h.3

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 04D5H 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 04D6H 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO1(C0) = 0;
CLINEA 0000H 0001H 04D7H 0002H 001CH
	rb	0f25ah.3
...
CLINEA 0000H 0001H 04DAH 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 04DBH 0002H 001DH
	rb	0f25dh.2
...
CLINEA 0000H 0001H 04DDH 0002H 001DH
	rb	0f25dh.3
CBLOCKEND 216 2 1246

;;}
CLINEA 0000H 0001H 04DEH 0001H 0001H
	rt
CBLOCKEND 216 1 1246
CFUNCTIONEND 216
...
;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 04EFH 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 04F0H 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 04F2H 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 04F3H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 215 2 1268

;;}
CLINEA 0000H 0001H 04F4H 0001H 0001H
	rt
CBLOCKEND 215 1 1268
CFUNCTIONEND 215
...
;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 0503H 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO1(DIR) = 1;
CLINEA 0000H 0001H 0504H 0002H 001DH
	sb	0f259h.3

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 0506H 0002H 001CH
	rb	0f25ah.2
...
;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 050BH 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 050CH 0002H 001DH
	rb	0f25dh.2

;;	SENINTF_HDR1_GPIO1(MD0) = 0;
CLINEA 0000H 0001H 050DH 0002H 001DH
	rb	0f25ch.3

;;	SENINTF_HDR1_GPIO1(MD1) = 0;
CLINEA 0000H 0001H 050EH 0002H 001DH
	rb	0f25dh.3
CBLOCKEND 217 2 1295

;;}
CLINEA 0000H 0001H 050FH 0001H 0001H
	rt
CBLOCKEND 217 1 1295
CFUNCTIONEND 217
...
CLINEA 0000H 0001H 0520H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0525H 0002H 000BH
	mov	er0,	#24
	bl	_NOPms
CBLOCKEND 218 2 1318

;;}
CLINEA 0000H 0001H 0526H 0001H 0001H
	pop	pc
CBLOCKEND 218 1 1318
CFUNCTIONEND 218
...
CLINEA 0000H 0001H 0537H 0002H 0044H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
CLINEA 0000H 0001H 0539H 0002H 003FH
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
CLINEA 0000H 0001H 053CH 0002H 0041H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
;;	cTmp = 0x3;
CLINEA 0000H 0001H 053EH 0002H 000CH
	mov	r0,	#03h
	st	r0,	-1[fp]
...
CLINEA 0000H 0001H 0541H 0002H 0042H
	mov	r0,	#00h
	push	r0
	mov	er0,	#0 
	push	er0
...
;;{	
CLINEA 0000H 0001H 054FH 0001H 0002H
	push	lr
CBLOCK 220 2 1359
CRET 0000H

;;	I2C_Write(BH17xxFVC_ADDR_1, NULL, 0, &BH17xxFVC_PWR_ON, 1);
CLINEA 0000H 0001H 0551H 0002H 003CH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _BH17xxFVC_PWR_ON
	mov	r1,	#BYTE2 OFFSET _BH17xxFVC_PWR_ON
...
CLINEA 0000H 0001H 0553H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
;;	NOPms(180);	
CLINEA 0000H 0001H 0557H 0002H 000DH
	mov	r0,	#0b4h
	mov	r1,	#00h
	bl	_NOPms
CBLOCKEND 220 2 1368

;;}
CLINEA 0000H 0001H 0558H 0001H 0001H
	pop	pc
CBLOCKEND 220 1 1368
CFUNCTIONEND 220
...
CLINEA 0000H 0001H 056AH 0002H 0041H
	mov	r0,	#00h
	push	r0
	mov	er0,	#0 
	push	er0
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 221 2 1387

;;}
CLINEA 0000H 0001H 056BH 0001H 0001H
	pop	pc
CBLOCKEND 221 1 1387
CFUNCTIONEND 221
...
CBLOCK 222 2 1400
CBLOCKEND 222 2 1403

;;}
CLINEA 0000H 0001H 057BH 0001H 0001H
	rt
CBLOCKEND 222 1 1403
CFUNCTIONEND 222
...
CLINEA 0000H 0001H 0589H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 058AH 0002H 0046H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 058BH 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 058CH 0002H 004EH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 058EH 0002H 0043H
	mov	r0,	#0c1h
	st	r0,	NEAR _uniRawSensorOut

;;	I2C_Write(KX022_I2C_ADDR, &KX022_CNTL1, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 058FH 0002H 0048H
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 223 2 1424

;;}
CLINEA 0000H 0001H 0590H 0001H 0001H
	pop	pc
CBLOCKEND 223 1 1424
CFUNCTIONEND 223
...
;;{ 
CLINEA 0000H 0001H 059DH 0001H 0002H
	push	lr
CBLOCK 224 2 1437
CRET 0000H

;;	uniRawSensorOut._uchar = 0x03u;
CLINEA 0000H 0001H 059FH 0002H 0020H
	mov	r0,	#03h
	st	r0,	NEAR _uniRawSensorOut

;;	I2C_Write(KMX61_I2C_ADDR, &KMX61_STBY_REG, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 05A0H 0002H 004BH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 05A2H 0002H 004CH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A3H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A4H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A5H 0002H 0046H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A6H 0002H 0052H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A7H 0002H 004CH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A8H 0002H 004CH
	mov	r0,	#01h
	push	r0
...
;;	I2C_Write(KMX61_I2C_ADDR, &KMX61_STBY_REG, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 05ABH 0002H 004BH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 224 2 1452

;;}
CLINEA 0000H 0001H 05ACH 0001H 0001H
	pop	pc
CBLOCKEND 224 1 1452
CFUNCTIONEND 224
...
CBLOCK 225 2 1465
CBLOCKEND 225 2 1468

;;}
CLINEA 0000H 0001H 05BCH 0001H 0001H
	rt
CBLOCKEND 225 1 1468
CFUNCTIONEND 225
...
;;{
CLINEA 0000H 0001H 05C9H 0001H 0001H
CBLOCK 226 2 1481

;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 05CBH 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 05CDH 0002H 001CH
	rb	0f25ah.2
...
;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 05D0H 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05D1H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 226 2 1490

;;}
CLINEA 0000H 0001H 05D2H 0001H 0001H
	rt
CBLOCKEND 226 1 1490
CFUNCTIONEND 226
...
;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 05E1H 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 05E3H 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 05E4H 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 05E6H 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05E7H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 227 2 1512

;;}
CLINEA 0000H 0001H 05E8H 0001H 0001H
	rt
CBLOCKEND 227 1 1512
CFUNCTIONEND 227
...
;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 05F9H 0002H 001CH
	rb	0f25ah.2
...
;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 05FCH 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05FDH 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 228 2 1534

;;}
CLINEA 0000H 0001H 05FEH 0001H 0001H
	rt
CBLOCKEND 228 1 1534
CFUNCTIONEND 228
...
;;{
CLINEA 0000H 0001H 0609H 0001H 0001H
CBLOCK 179 2 1545

;;	do {
CLINEA 0000H 0001H 060CH 0002H 0005H
_$L288 :
CBLOCK 179 3 1548

;;		WDTCON = 0x5Au;
CLINEA 0000H 0001H 060DH 0003H 0011H
	mov	r0,	#05ah
	st	r0,	0f00eh
CBLOCKEND 179 3 1550

;;	} while (WDP != 1);
CLINEA 0000H 0000H 060EH 0002H 0014H
	tb	0f00eh.0
	beq	_$L288

;;	WDTCON = 0xA5u;
CLINEA 0000H 0001H 060FH 0002H 0010H
	mov	r0,	#0a5h
	st	r0,	0f00eh
CBLOCKEND 179 2 1552

;;}
CLINEA 0000H 0001H 0610H 0001H 0001H
	rt
CBLOCKEND 179 1 1552
CFUNCTIONEND 179
...
CLINEA 0000H 0001H 061CH 0002H 0054H
	bl	_uart_continue

;;	_flgUartFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 061DH 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __flgUartFin
...
CLINEA 0000H 0001H 061EH 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 190 2 1567

;;}
CLINEA 0000H 0001H 061FH 0001H 0001H
	pop	pc
CBLOCKEND 190 1 1567
CFUNCTIONEND 190
...
CLINEA 0000H 0001H 062BH 0002H 0053H
	bl	_i2c_continue

;;	_flgI2CFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 062CH 0002H 0025H
	mov	r0,	#01h
	st	r0,	NEAR __flgI2CFin

;;	main_reqNotHalt();				// uncommented 5/2/2013
CLINEA 0000H 0001H 062DH 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 191 2 1582

;;}
CLINEA 0000H 0001H 062EH 0001H 0001H
	pop	pc
CBLOCKEND 191 1 1582
CFUNCTIONEND 191
...
;;	i2c_continue();
CLINEA 0000H 0001H 0639H 0002H 0010H
	bl	_i2c_continue

;;	main_reqNotHalt();
CLINEA 0000H 0001H 063AH 0002H 0013H
	bl	_main_reqNotHalt
CBLOCKEND 194 2 1595

;;}
CLINEA 0000H 0001H 063BH 0001H 0001H
	pop	pc
CBLOCKEND 194 1 1595
CFUNCTIONEND 194
...
;;	_flgADCFin = 1;
CLINEA 0000H 0001H 0646H 0002H 0010H
	mov	r0,	#01h
	st	r0,	NEAR __flgADCFin
CBLOCKEND 195 2 1607

;;}
CLINEA 0000H 0001H 0647H 0001H 0001H
	rt
CBLOCKEND 195 1 1607
CFUNCTIONEND 195
...
CLINEA 0000H 0001H 0652H 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __reqNotHalt
CBLOCKEND 192 2 1619

;;}
CLINEA 0000H 0001H 0653H 0001H 0001H
	rt
CBLOCKEND 192 1 1619
CFUNCTIONEND 192
...
;;{
CLINEA 0000H 0001H 065DH 0001H 0001H
CBLOCK 193 2 1629

;;	uart_continue(); 	//in UART.c: process to continue send and receive...
CLINEA 0000H 0001H 065EH 0002H 0047H
	b	_uart_continue
CBLOCKEND 193 2 1631
CLINEA 0000H 0001H 065FH 0001H 0001H
CBLOCKEND 193 1 1631
CFUNCTIONEND 193
...
CLINEA 0000H 0001H 0664H 0001H 0019H
CBLOCK 181 2 1636

;;	SYSC0 = 0;			// Used to select the frequency of the HSCLK => 00=8.192MHz.
CLINEA 0000H 0001H 0667H 0002H 004AH
	rb	0f002h.0
...
CLINEA 0000H 0001H 066AH 0002H 0034H
	sb	0f002h.3
...
CLINEA 0000H 0001H 066DH 0002H 0031H
	sb	0f003h.1

;;	SYSCLK = 1;			//1=HSCLK; 0=LSCLK 
CLINEA 0000H 0001H 066EH 0002H 0022H
	sb	0f003h.0

;;	LPLL = 1;			//1=Enables the use of PLL oscillation - ADDED 4/30/2013
CLINEA 0000H 0001H 0670H 0002H 0045H
	sb	0f003h.7

;;	__EI();			//INT enable
CLINEA 0000H 0001H 0672H 0002H 0017H
	ei
CBLOCKEND 181 2 1651

;;}
CLINEA 0000H 0001H 0673H 0001H 0001H
	rt
CBLOCKEND 181 1 1651
CFUNCTIONEND 181
...
;;void PortA_Low(void){
CLINEA 0000H 0001H 0679H 0001H 0015H
CBLOCK 182 2 1657

;;	PA0DIR = 0;		// PortA Bit0 set to Output Mode...
CLINEA 0000H 0001H 0683H 0002H 0031H
	rb	0f251h.0
...
;;	PA1C0  = 1;	
CLINEA 0000H 0001H 068BH 0002H 000DH
	sb	0f252h.1
...
CLINEA 0000H 0001H 0698H 0002H 0021H
	rb	0f250h.0

;;	PA1D = 0;		// A.1 Output OFF....
CLINEA 0000H 0001H 0699H 0002H 0021H
	rb	0f250h.1
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 069CH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 182 2 1693
CLINEA 0000H 0001H 069DH 0001H 0001H
CBLOCKEND 182 1 1693
CFUNCTIONEND 182
...
;;void PortB_Low(void){
CLINEA 0000H 0001H 06A3H 0001H 0015H
CBLOCK 183 2 1699
...
;;	PB0C0  = 1;		
CLINEA 0000H 0001H 06B8H 0002H 000EH
	sb	0f25ah.0
...
;;	PB7MD0  = 0;
CLINEA 0000H 0001H 06D8H 0002H 000DH
	rb	0f25ch.7
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 06E4H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 183 2 1765
CLINEA 0000H 0001H 06E5H 0001H 0001H
CBLOCKEND 183 1 1765
CFUNCTIONEND 183
...
;;void PortC_Low(void){
CLINEA 0000H 0001H 06EBH 0001H 0015H
CBLOCK 184 2 1771
...
;;	PC0C0  = 1;		
CLINEA 0000H 0001H 0700H 0002H 000EH
	sb	0f262h.0
...
;;	PC6MD0  = 0;	
CLINEA 0000H 0001H 071EH 0002H 000EH
	rb	0f264h.6
...
;;	PC7MD0  = 0;
CLINEA 0000H 0001H 0720H 0002H 000DH
	rb	0f264h.7
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 072CH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 184 2 1838
CLINEA 0000H 0001H 072EH 0001H 0001H
CBLOCKEND 184 1 1838
CFUNCTIONEND 184
...
;;void PortD_Low(void){
CLINEA 0000H 0001H 0734H 0001H 0015H
CBLOCK 185 2 1844
...
;;	PD0C0= 1;		
CLINEA 0000H 0001H 0746H 0002H 000CH
	sb	0f26ah.0
...
;;	PD1C0= 1;	
CLINEA 0000H 0001H 0748H 0002H 000BH
	sb	0f26ah.1
...
;;	PD3C0= 1;		
CLINEA 0000H 0001H 074CH 0002H 000CH
	sb	0f26ah.3
...
;;	PD4C0= 1;	
CLINEA 0000H 0001H 074EH 0002H 000BH
	sb	0f26ah.4
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 075AH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 185 2 1883
CLINEA 0000H 0001H 075BH 0001H 0001H
CBLOCKEND 185 1 1883
CFUNCTIONEND 185
...
;;	TempSec = ms;
CLINEA 0000H 0001H 0770H 0002H 000EH
	mov	er4,	er0

;;	TimeFlag = 0;
CLINEA 0000H 0001H 0771H 0002H 000EH
	mov	r6,	#00h

;;	tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 0773H 0002H 0016H
	mov	r0,	#01h
	bl	_tm_init
...
;;	if(ms < 128){
CLINEA 0000H 0001H 0777H 0002H 000EH
	mov	er0,	er8
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bge	_$L302
...
;;		timerThres = 0x1FF * ms;
CLINEA 0000H 0001H 0778H 0003H 001AH
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
...
;;	if(ms == 128){
CLINEA 0000H 0001H 077BH 0002H 000FH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bne	_$L304
CBLOCK 196 4 1915
...
;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 077CH 0003H 0016H
	mov	bp,	#-1

;;		TimeFlag = 0;
CLINEA 0000H 0001H 077DH 0003H 000FH
	mov	r6,	#00h
CBLOCKEND 196 4 1918

;;	}
CLINEA 0000H 0000H 077EH 0002H 0002H
_$L304 :

;;	if(ms > 128){
CLINEA 0000H 0001H 077FH 0002H 000EH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	ble	_$L314
CBLOCK 196 5 1919
...
;;		while(TempSec > 128){
CLINEA 0000H 0000H 0780H 0003H 0017H
_$L310 :
CBLOCK 196 6 1920
...
;;			TimeFlag++;
CLINEA 0000H 0000H 0782H 0004H 000EH
	add	r6,	#01h
CBLOCKEND 196 6 1923
...
;;		if(TempSec != 0){
CLINEA 0000H 0001H 0784H 0003H 0013H
	mov	er4,	er4
	beq	_$L312
CBLOCK 196 7 1924

;;			timerThres = 0x1FF * TempSec;
CLINEA 0000H 0001H 0785H 0004H 0020H
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
	...
	subc	r1,	r5
	mov	bp,	er0
CBLOCKEND 196 7 1926

;;		else{
CLINEA 0000H 0001H 0787H 0003H 0007H
	bal	_$L314
_$L312 :
CBLOCK 196 8 1927

;;			timerThres = 0xFFFF;
CLINEA 0000H 0001H 0788H 0004H 0017H
	mov	bp,	#-1

;;			TimeFlag--;
CLINEA 0000H 0000H 0789H 0004H 000EH
	add	r6,	#0ffh
CBLOCKEND 196 8 1930

;;		}
CLINEA 0000H 0000H 078AH 0003H 0003H
_$L314 :
CBLOCKEND 196 5 1931

;;	main_clrWDT();	
CLINEA 0000H 0001H 078EH 0002H 0010H
	bl	_main_clrWDT
...
CLINEA 0000H 0001H 0792H 0002H 001BH
	bal	_$L317
_$L319 :
CBLOCK 196 9 1938
...
;;		timer = tm_getABCounter();
CLINEA 0000H 0000H 0793H 0003H 001CH
CBLOCKEND 196 9 1941

;;	}
CLINEA 0000H 0000H 0795H 0002H 0002H
_$L317 :

;;	while(timer < timerThres){
CLINEA 0000H 0000H 0792H 0000H 0000H
	cmp	er0,	bp
	blt	_$L319

;;	if(TimeFlag !=0){
CLINEA 0000H 0001H 0796H 0002H 0012H
	cmp	r6,	#00h
	beq	_$L322
...
;;		TimeFlag--;
CLINEA 0000H 0000H 0798H 0003H 000DH
	add	r6,	#0ffh

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0799H 0003H 0016H
	mov	bp,	#-1

;;		goto TimerRestart;
CLINEA 0000H 0001H 079AH 0003H 0014H
	bal	_$L314

;;	}
CLINEA 0000H 0000H 079BH 0002H 0002H
_$L322 :
CBLOCKEND 196 2 1948

;;}
CLINEA 0000H 0001H 079CH 0001H 0001H
	pop	er8
	pop	bp
	pop	xr4
	pop	pc
CBLOCKEND 196 1 1948
CFUNCTIONEND 196
...
;;");
CLINEA 0000H 0001H 07B4H 0001H 0003H
...
CBLOCKEND 197 2 1973

;;}
CLINEA 0000H 0001H 07B5H 0001H 0001H
	rt
CBLOCKEND 197 1 1973
CFUNCTIONEND 197
...
;;	if(LEDFlashFlag == 0){
CLINEA 0000H 0001H 07C0H 0002H 0017H
	l	r0,	NEAR _LEDFlashFlag
	bne	_$L327
CBLOCK 198 3 1984

;;		if(LEDChangeFlag == 0){
CLINEA 0000H 0001H 07C1H 0003H 0019H
	l	r0,	NEAR _LEDChangeFlag
	bne	_$L329
CBLOCK 198 4 1985

;;			LEDOUT(0xAA);
CLINEA 0000H 0001H 07C2H 0004H 0010H
	mov	r0,	#0aah
	st	r0,	0f260h

;;			LEDChangeFlag = 1;
CLINEA 0000H 0001H 07C3H 0004H 0015H
	mov	r0,	#01h
CBLOCKEND 198 4 1988

;;		else{
CLINEA 0000H 0001H 07C5H 0003H 0007H
	bal	_$L331
_$L329 :
CBLOCK 198 5 1989

;;			LEDOUT(0x55);
CLINEA 0000H 0001H 07C6H 0004H 0010H
	mov	r0,	#055h
	st	r0,	0f260h

;;			LEDChangeFlag = 0;
CLINEA 0000H 0001H 07C7H 0004H 0015H
	mov	r0,	#00h
CBLOCKEND 198 5 1992

;;		}
CLINEA 0000H 0000H 07C8H 0003H 0003H
_$L331 :
	st	r0,	NEAR _LEDChangeFlag
CBLOCKEND 198 3 1993

;;	else{
CLINEA 0000H 0001H 07CAH 0002H 0006H
	bal	_$L332
_$L327 :
CBLOCK 198 6 1994

;;		LEDOUT(0x00);
CLINEA 0000H 0001H 07CBH 0003H 000FH
	mov	r0,	#00h
	st	r0,	0f260h
CBLOCKEND 198 6 1996

;;	}
CLINEA 0000H 0000H 07CCH 0002H 0002H
_$L332 :

;;	LEDFlashFlag++;
CLINEA 0000H 0000H 07CDH 0002H 0010H
	lea	OFFSET _LEDFlashFlag
	inc	[ea]
	l	r0,	NEAR _LEDFlashFlag

;;	if(LEDFlashFlag >= 4){
CLINEA 0000H 0001H 07CEH 0002H 0017H
	cmp	r0,	#04h
	blt	_$L333
CBLOCK 198 7 1998

;;		LEDFlashFlag = 0;
CLINEA 0000H 0001H 07CFH 0003H 0013H
	mov	r0,	#00h
	st	r0,	NEAR _LEDFlashFlag
CBLOCKEND 198 7 2000

;;	}
CLINEA 0000H 0000H 07D0H 0002H 0002H
_$L333 :
CBLOCKEND 198 2 2001

;;}
CLINEA 0000H 0001H 07D1H 0001H 0001H
	rt
CBLOCKEND 198 1 2001
CFUNCTIONEND 198
...
_KMX61_BUF_CTRL2_CFGDAT :
	...
	rseg $$TAB$$S30$main
$$S30 :
	DB	"\x1b[2J\x1b[1;1H*********************************************\x0a\x0d** Q112 Firmware - Sensor Platform EVK\x0a\x0d** Revision    : REV00\x0a\x0d** Release date: Oct  6 2014 16:19:39\x0a\x0d** By          : ROHM Semiconductor USA, LLC\x0a\x0d********************************************"
	DB	"*\x0a\x0d", 00H
