...
CFILE 0000H 00000791H "main\\main.c"
...
;;{ 	
CLINEA 0000H 0001H 019BH 0001H 0003H
CBLOCK 227 2 411

;;	Initialization(); //Ports, UART, Timers, Oscillator, Comparators, etc.
CLINEA 0000H 0001H 019CH 0002H 0047H
	bl	_Initialization

;;	PRINTF(WelcomeString);
CLINEA 0000H 0001H 019EH 0002H 0017H
	mov	r0,	#0feh
	mov	r1,	#00h
	push	er0
...
CLINEA 0000H 0001H 01AEH 0003H 001EH
	mov	r0,	#00h
...
CLINEA 0000H 0001H 01B1H 0002H 0021H
...
CLINEA 0000H 0001H 01E2H 0002H 0034H
	sb	0f009h.0

;;	goto MainLoop;
CLINEA 0000H 0001H 01E3H 0002H 000FH
	bal	_$L31
CBLOCKEND 227 2 484

;;		case 1:
CLINEA 0000H 0001H 01B2H 0003H 0009H
_$S39 :

;;			MainOp_Hall_Effect_Sensors_1(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 01B3H 0004H 0057H
	bl	_MainOp_Hall_Effect_Sensors_1

;;			break;
CLINEA 0000H 0001H 01B4H 0004H 0009H
	bal	_$L37

;;		case 2:
CLINEA 0000H 0001H 01B5H 0003H 0009H
_$S40 :

;;			MainOp_Hall_Effect_Sensors_2(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01B6H 0004H 0058H
	bl	_MainOp_Hall_Effect_Sensors_2

;;			break;
CLINEA 0000H 0001H 01B7H 0004H 0009H
	bal	_$L37

;;		case 5: 
CLINEA 0000H 0001H 01B8H 0003H 000AH
_$S41 :

;;			MainOp_Ambient_Light_Sensor_5(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 01B9H 0004H 0058H
	bl	_MainOp_Ambient_Light_Sensor_5

;;			break;
CLINEA 0000H 0001H 01BAH 0004H 0009H
	bal	_$L37

;;		case 6:
CLINEA 0000H 0001H 01BBH 0003H 0009H
_$S42 :

;;			MainOp_Ambient_Light_Sensor_6(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01BCH 0004H 0059H
	bl	_MainOp_Ambient_Light_Sensor_6

;;			break;
CLINEA 0000H 0001H 01BDH 0004H 0009H
	bal	_$L37
...
CLINEA 0000H 0001H 01BFH 0004H 0059H
...
CLINEA 0000H 0001H 01C2H 0004H 0059H
...
;;		case 10:
CLINEA 0000H 0001H 01C7H 0003H 000AH
_$S46 :

;;			MainOp_UV_Sensor_10(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01C8H 0004H 004FH
...
;;		case 15:
CLINEA 0000H 0001H 01CAH 0003H 000AH
_$S47 :

;;			MainOp_KX022(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01CBH 0004H 0048H
	bl	_MainOp_KX022
...
;;		case 16:
CLINEA 0000H 0001H 01CDH 0003H 000AH
_$S48 :

;;			MainOp_KMX61(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01CEH 0004H 0048H
	bl	_MainOp_KMX61
...
CLINEA 0000H 0001H 01D4H 0004H 0057H
...
CLINEA 0000H 0001H 01D7H 0004H 0058H
...
CLINEA 0000H 0001H 01DAH 0004H 0057H
	bl	_MainOp_Temperature_Sensor_23

;;			break; 
CLINEA 0000H 0001H 01DBH 0004H 000AH
	bal	_$L37
...
CLINEA 0000H 0001H 01DDH 0004H 002BH
	mov	er0,	#26
	push	er0
...
;;			LEDOUT = 0x0;
CLINEA 0000H 0001H 01DEH 0004H 0010H
	mov	r0,	#00h
	st	r0,	0f260h

;;			break;
CLINEA 0000H 0001H 01DFH 0004H 0009H
	bal	_$L37
CBLOCKEND 227 4 480
CBLOCKEND 227 1 484
CFUNCTIONEND 227
...
CLINEA 0000H 0001H 0211H 0002H 003FH
	bl	_irq_init

;;	IE0 = IE1 = IE2 = IE3 = IE4 = IE5 = IE6 = IE7 = 0;
CLINEA 0000H 0001H 0214H 0002H 0033H
	mov	r0,	#00h
	st	r0,	0f017h
	st	r0,	0f016h
	st	r0,	0f015h
...
CLINEA 0000H 0001H 0216H 0002H 003BH
	st	r0,	0f01fh
	st	r0,	0f01eh
	st	r0,	0f01dh
	st	r0,	0f01ch
...
CLINEA 0000H 0001H 0218H 0002H 0045H
	rb	0f017h.3

;;	irq_setHdr((unsigned char)IRQ_NO_UA0INT, _intUart);
CLINEA 0000H 0001H 021AH 0002H 0034H
...
;;	ESAD = 1;
CLINEA 0000H 0001H 0223H 0002H 000AH
	sb	0f012h.2

;;	QSAD = 0;
CLINEA 0000H 0001H 0224H 0002H 000AH
	rb	0f01ah.2

;;	irq_ei(); // Enable Interrupts
CLINEA 0000H 0001H 0230H 0002H 001FH
	bl	_irq_ei

;;	WDTMOD = 0x01; 	
CLINEA 0000H 0001H 023CH 0002H 0011H
	mov	r0,	#01h
	st	r0,	0f00fh

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 023DH 0002H 001DH
	bl	_main_clrWDT

;;	i2c_init(I2C_MOD_FST, (unsigned short)HSCLK_KHZ, I2C_SYN_OFF);
CLINEA 0000H 0001H 0243H 0002H 003FH
	mov	r0,	#00h
	push	r0
	mov	r2,	#040h
	mov	r3,	#01fh
...
;;			   &_uartSetParam );				/* Param... 	 */
CLINEA 0000H 0001H 0248H 0007H 002BH
...
;;	uart_PortSet();
CLINEA 0000H 0001H 0249H 0002H 0010H
	bl	_uart_PortSet
CBLOCKEND 180 2 589

;;}//End Initialization
CLINEA 0000H 0001H 024DH 0001H 0015H
	pop	pc
CBLOCKEND 180 1 589
CFUNCTIONEND 180
...
;;	_flgUartFin = 0; 
CLINEA 0000H 0001H 025CH 0002H 0012H
	mov	r0,	#00h
...
CLINEA 0000H 0001H 025EH 0002H 002CH
...
;;	while(_flgUartFin != 1)
CLINEA 0000H 0000H 025FH 0001H 0001H
	bal	_$L60

;;	while(_flgUartFin != 1)
CLINEA 0000H 0000H 025FH 0002H 0018H
_$L58 :
CBLOCK 186 3 608

;;		main_clrWDT();
CLINEA 0000H 0001H 0261H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 186 3 610
...
;;	return len;
CLINEA 0000H 0001H 0263H 0002H 000CH
	l	er0,	4[fp]
CBLOCKEND 186 2 612

;;}
CLINEA 0000H 0000H 0264H 0001H 0001H
	pop	er10
	mov	sp,	fp
	pop	fp
	pop	pc
...
CLINEA 0000H 0001H 0271H 0002H 0023H
	mov	er0,	#1 
	mov	r2,	r8
_$M6 :
	cmp	r2,	#07h
...
;;	SARUN = 1;
CLINEA 0000H 0001H 0272H 0002H 000BH
	sb	0f2f1h.0
...
;;	while(_flgADCFin == 0)
CLINEA 0000H 0000H 0273H 0002H 0017H
_$L64 :
CBLOCK 187 3 628

;;		main_clrWDT();
CLINEA 0000H 0001H 0275H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 187 3 630
...
;;	switch(idx)
CLINEA 0000H 0001H 0277H 0002H 000CH
	mov	r0,	r8
	mov	r1,	#00h
CBLOCK 187 4 632
	cmp	r8,	#07h
...
CLINEA 0000H 0001H 0279H 0003H 0028H
_$S71 :
	l	r0,	0f2d1h
	mov	r1,	#00h
	sllc	r1,	#02h
...
CLINEA 0000H 0001H 027AH 0003H 0028H
_$S72 :
	l	r0,	0f2d3h
	mov	r1,	#00h
	sllc	r1,	#02h
...
CLINEA 0000H 0001H 027BH 0003H 0028H
_$S73 :
	l	r0,	0f2d5h
	mov	r1,	#00h
	sllc	r1,	#02h
...
CLINEA 0000H 0001H 027CH 0003H 0028H
_$S74 :
	l	r0,	0f2d7h
	mov	r1,	#00h
	sllc	r1,	#02h
...
CLINEA 0000H 0001H 027DH 0003H 0028H
_$S75 :
	l	r0,	0f2d9h
	mov	r1,	#00h
	sllc	r1,	#02h
...
CLINEA 0000H 0001H 027EH 0003H 0028H
_$S76 :
	l	r0,	0f2dbh
	mov	r1,	#00h
	sllc	r1,	#02h
...
CLINEA 0000H 0001H 027FH 0003H 0028H
_$S77 :
	l	r0,	0f2ddh
	mov	r1,	#00h
	sllc	r1,	#02h
...
CLINEA 0000H 0001H 0280H 0003H 0028H
_$S78 :
	l	r0,	0f2dfh
	mov	r1,	#00h
	sllc	r1,	#02h
...
;;		default:	return 0;
CLINEA 0000H 0001H 0281H 0003H 0014H
_$L70 :
	mov	er0,	#0 
	b	_$L61
CBLOCKEND 187 4 642
...
CLINEA 0000H 0001H 0295H 0002H 0063H
...
;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 0296H 0001H 0001H
	bal	_$L85

;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 0296H 0002H 0017H
_$L83 :
CBLOCK 188 3 663

;;		main_clrWDT();
CLINEA 0000H 0001H 0298H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 188 3 665
...
;;	_flgI2CFin = 0;
CLINEA 0000H 0001H 02AAH 0002H 0010H
	mov	r0,	#00h
	st	r0,	NEAR __flgI2CFin
...
CLINEA 0000H 0001H 02ACH 0002H 0060H
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	l	r0,	8[fp]
...
;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02ADH 0001H 0001H
	bal	_$L91

;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02ADH 0002H 0017H
_$L89 :
CBLOCK 189 3 686

;;		main_clrWDT();
CLINEA 0000H 0001H 02AFH 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 189 3 688
...
;;{  
CLINEA 0000H 0001H 02BDH 0001H 0003H
CBLOCK 197 2 701
...
CLINEA 0000H 0001H 02CCH 0003H 001EH
	mov	r0,	#01h
	st	r0,	NEAR _SensorIntializationFlag

;;		SensorPlatformSelection = PDD;
CLINEA 0000H 0001H 02CDH 0003H 0020H
	l	r0,	0f268h
...
;;{  
CLINEA 0000H 0001H 02D9H 0001H 0003H
	push	lr
CBLOCK 198 2 729
CRET 0000H
...
;;}
CLINEA 0000H 0001H 0308H 0001H 0001H
	pop	pc

;;		case 1:
CLINEA 0000H 0001H 02DBH 0003H 0009H
_$S101 :

;;			Init_Hall_Effect_Sensors_1(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 02DCH 0004H 0055H
	bl	_Init_Hall_Effect_Sensors_1

;;			break;
CLINEA 0000H 0001H 02DDH 0004H 0009H
	bal	_$L99

;;		case 2:
CLINEA 0000H 0001H 02DEH 0003H 0009H
_$S102 :

;;			Init_Hall_Effect_Sensors_2(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02DFH 0004H 0056H
	bl	_Init_Hall_Effect_Sensors_2

;;			break;
CLINEA 0000H 0001H 02E0H 0004H 0009H
	bal	_$L99

;;		case 5: 
CLINEA 0000H 0001H 02E1H 0003H 000AH
_$S103 :

;;			Init_Ambient_Light_Sensor_5(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 02E2H 0004H 0056H
	bl	_Init_Ambient_Light_Sensor_5

;;			break;
CLINEA 0000H 0001H 02E3H 0004H 0009H
	bal	_$L99

;;		case 6:
CLINEA 0000H 0001H 02E4H 0003H 0009H
_$S104 :

;;			Init_Ambient_Light_Sensor_6(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02E5H 0004H 0057H
	bl	_Init_Ambient_Light_Sensor_6

;;			break;
CLINEA 0000H 0001H 02E6H 0004H 0009H
	bal	_$L99

;;		case 7:
CLINEA 0000H 0001H 02E7H 0003H 0009H
_$S105 :

;;			Init_Ambient_Light_Sensor_7(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02E8H 0004H 0057H
	bl	_Init_Ambient_Light_Sensor_7

;;			break;
CLINEA 0000H 0001H 02E9H 0004H 0009H
	bal	_$L99
...
CLINEA 0000H 0001H 02EBH 0004H 0057H
...
CLINEA 0000H 0001H 02EEH 0004H 0057H
...
CLINEA 0000H 0001H 02F1H 0004H 004DH
...
;;		case 15:
CLINEA 0000H 0001H 02F3H 0003H 000AH
_$S109 :

;;			Init_KX022(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02F4H 0004H 0046H
	bl	_Init_KX022
...
;;		case 16:
CLINEA 0000H 0001H 02F6H 0003H 000AH
_$S110 :

;;			Init_KMX61(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02F7H 0004H 0046H
	bl	_Init_KMX61
...
CLINEA 0000H 0001H 0300H 0004H 0056H
...
CLINEA 0000H 0001H 0303H 0004H 0055H
	bl	_Init_Temperature_Sensor_23

;;			break; 
CLINEA 0000H 0001H 0304H 0004H 000AH
	bal	_$L99
...
CLINEA 0000H 0001H 0318H 0003H 0024H
	mov	r0,	#00h
	st	r0,	0f260h

;;		PRINTF("\033[2K\rBU52004GUL> Hall – No Mag Fields Detected.");
CLINEA 0000H 0001H 0319H 0003H 0042H
	mov	er0,	#50
	push	er0
...
CLINEA 0000H 0001H 031BH 0002H 003EH
	bal	_$L142
_$L116 :
	tb	0f258h.2
	beq	_$L125
...
CLINEA 0000H 0001H 031DH 0003H 0020H
	mov	r0,	#02h
	st	r0,	0f260h

;;		PRINTF("\033[2K\rBU52004GUL> Hall – North Mag Field Detected.");
CLINEA 0000H 0001H 031EH 0003H 0044H
	mov	er0,	#52
	push	er0
...
CLINEA 0000H 0001H 0320H 0002H 003EH
	bal	_$L142
_$L125 :
	tb	0f258h.2
	bne	_$L134
...
CLINEA 0000H 0001H 0322H 0003H 0020H
	mov	r0,	#080h
	st	r0,	0f260h

;;		PRINTF("\033[2K\rBU52004GUL> Hall – South Mag Field Detected.");
CLINEA 0000H 0001H 0323H 0003H 0044H
	mov	er0,	#52
	push	er0
...
;;	else
CLINEA 0000H 0001H 0325H 0002H 0005H
	bal	_$L142
_$L134 :
CBLOCK 200 6 806

;;		LEDOUT = 0x82;	// Turn on LED7 and LED1
CLINEA 0000H 0001H 0327H 0003H 0029H
	mov	r0,	#082h
	st	r0,	0f260h

;;		PRINTF("\033[2K\rBU52004GUL> Hall – Both Mag Fields Detected.");
CLINEA 0000H 0001H 0328H 0003H 0044H
	mov	er0,	#52
	push	er0
...
;;	}
CLINEA 0000H 0000H 0329H 0002H 0002H
_$L142 :
	add	sp,	#2 
CBLOCKEND 200 4 810
CBLOCKEND 200 3 810
...
;;}
CLINEA 0000H 0001H 032AH 0001H 0001H
	pop	pc
CBLOCKEND 200 1 810
CFUNCTIONEND 200
...
CLINEA 0000H 0001H 0338H 0002H 001DH
	tb	0f258h.2
	bne	_$L145
CBLOCK 199 3 825
...
CLINEA 0000H 0001H 033BH 0003H 003EH
	mov	er0,	#46
	push	er0
...
;;	else
CLINEA 0000H 0001H 033DH 0002H 0005H
	bal	_$L148
_$L145 :
CBLOCK 199 4 830

;;		LEDOUT = 0x0;	// Turn off all LEDs
CLINEA 0000H 0001H 033FH 0003H 0024H
	mov	r0,	#00h
	st	r0,	0f260h

;;		PRINTF("\033[2K\rBU52011HFV> Hall – No Mag Fields Detected.");
CLINEA 0000H 0001H 0340H 0003H 0042H
	mov	er0,	#50
	push	er0
...
;;	}
CLINEA 0000H 0000H 0341H 0002H 0002H
_$L148 :
	add	sp,	#2 
CBLOCKEND 199 2 834
...
;;{	
CLINEA 0000H 0001H 034FH 0001H 0002H
	push	lr
CBLOCK 201 2 847
CRET 0000H

;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 0350H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0352H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 0357H 0002H 0037H
	l	r0,	0f258h
	srl	r0,	#03h
	and	r0,	#01h
	mov	r1,	#00h
...
;;	switch(SENINTF_HDR1_GPIO1(D)<<1|SENINTF_HDR1_GPIO0(D))
CLINEA 0000H 0000H 0357H 0002H 0037H
	cmp	r2,	#01h
	beq	_$L156
...
;;		case 0:	// Shutdown
CLINEA 0000H 0001H 0362H 0003H 0015H
_$L159 :

;;			flSensorOut[0] = 0;
CLINEA 0000H 0001H 0364H 0004H 0016H
	mov	er0,	#0 
	st	er0,	NEAR _flSensorOut
...
;;}
CLINEA 0000H 0001H 036AH 0001H 0001H
	pop	pc

;;		case 1: // H-Gain mode
CLINEA 0000H 0001H 0359H 0003H 0018H
_$L156 :

;;			flSensorOut[0] = flSensorOut[0]/(0.57e-6f*5.6e3f);
CLINEA 0000H 0001H 035AH 0004H 0035H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#0e0h
...
;;			break;
CLINEA 0000H 0001H 035BH 0004H 0009H
	bal	_$L154

;;		case 2: // M-Gain mode
CLINEA 0000H 0001H 035CH 0003H 0018H
_$L157 :

;;			flSensorOut[0] = flSensorOut[0]/(0.057e-6f*5.6e3f);
CLINEA 0000H 0001H 035DH 0004H 0036H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#04dh
...
;;			break;
CLINEA 0000H 0001H 035EH 0004H 0009H
	bal	_$L154

;;		case 3: // L-Gain mode
CLINEA 0000H 0001H 035FH 0003H 0018H
_$L158 :

;;			flSensorOut[0] = flSensorOut[0]/(0.0057e-6f*5.6e3f);
CLINEA 0000H 0001H 0360H 0004H 0037H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#0d7h
...
;;			break;
CLINEA 0000H 0001H 0361H 0004H 0009H
	b	_$L154
CBLOCKEND 201 1 874
CFUNCTIONEND 201
...
;;{
CLINEA 0000H 0001H 0377H 0001H 0001H
	push	lr
CBLOCK 202 2 887
CRET 0000H

;;	I2C_Read(BH17xxFVC_ADDR_1, NULL, 0, uniRawSensorOut._ucharArr, 2);
CLINEA 0000H 0001H 037DH 0002H 0043H
	mov	r0,	#02h
	push	r0
...
CLINEA 0000H 0001H 0381H 0002H 0056H
...
CLINEA 0000H 0001H 0383H 0002H 0027H
	l	r0,	NEAR _uniRawSensorOut
	st	r0,	0f260h

;;	printf("\033[2K\rBH1710FVC> Ambient Light = %lu[lx]", (unsigned long)flSensorOut[0]);
CLINEA 0000H 0001H 0384H 0002H 0056H
	l	er0,	NEAR _flSensorOut
	push	xr0
	bl	__ftolu8sw
	pop	xr0
...
CLINEA 0000H 0001H 0398H 0002H 0043H
	mov	r0,	#04h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 039FH 0002H 0051H
...
CLINEA 0000H 0001H 03A0H 0002H 0019H
	push	xr0
	mov	r0,	#0b8h
	mov	r1,	#01eh
	mov	r2,	#085h
...
CLINEA 0000H 0001H 03A1H 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03A2H 0002H 001EH
	b	_$L175
_$L164 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 03A3H 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03A4H 0002H 001EH
	b	_$L175
_$L167 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 03A5H 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03A6H 0002H 001EH
	b	_$L175
_$L170 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 03A7H 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;	else
CLINEA 0000H 0001H 03A8H 0002H 0005H
	bal	_$L175
_$L173 :

;;		flSensorOut[0] = 0;
CLINEA 0000H 0001H 03A9H 0003H 0015H
	mov	er0,	#0 
	st	er0,	NEAR _flSensorOut
	st	er0,	NEAR _flSensorOut+02h
_$L175 :
...
CLINEA 0000H 0001H 03ABH 0002H 0027H
	l	r0,	NEAR _uniRawSensorOut+01h
	st	r0,	0f260h

;;	printf("\033[2K\rBH1730FVC> Ambient Light = %lu[lx]", (unsigned long)flSensorOut[0]);
CLINEA 0000H 0001H 03ACH 0002H 0056H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	bl	__ftolu8sw
...
;;{	
CLINEA 0000H 0001H 03BAH 0001H 0002H
	push	lr
CBLOCK 204 2 954
CRET 0000H
...
;;	flSensorOut[0] = (uniRawSensorOut._ucharArr[0]<<8|uniRawSensorOut._ucharArr[1])/1.2f;
CLINEA 0000H 0001H 03C3H 0002H 0056H
	l	r0,	NEAR _uniRawSensorOut
	mov	r1,	#00h
	mov	r3,	r0
	l	r0,	NEAR _uniRawSensorOut+01h
...
;;	LEDOUT = uniRawSensorOut._ucharArr[0];
CLINEA 0000H 0001H 03C5H 0002H 0027H
	l	r0,	NEAR _uniRawSensorOut
	st	r0,	0f260h

;;	printf("\033[2K\rBH1721FVC> Ambient Light = %lu[lx]", (unsigned long)flSensorOut[0]);
CLINEA 0000H 0001H 03C6H 0002H 0056H
	l	er0,	NEAR _flSensorOut
	push	xr0
	bl	__ftolu8sw
	pop	xr0
...
;;}
CLINEA 0000H 0001H 03C7H 0001H 0001H
	pop	pc
CBLOCKEND 204 1 967
CFUNCTIONEND 204
...
;;{
CLINEA 0000H 0001H 03D4H 0001H 0001H
	push	lr
CBLOCK 205 2 980
CRET 0000H

;;	I2C_Read(BH17xxFVC_ADDR_2, NULL, 0, uniRawSensorOut._ucharArr, 2);
CLINEA 0000H 0001H 03DAH 0002H 0043H
	mov	r0,	#02h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 03DEH 0002H 0028H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;	LEDOUT = uniRawSensorOut._ucharArr[1];
CLINEA 0000H 0001H 03E0H 0002H 0027H
	l	r0,	NEAR _uniRawSensorOut+01h
	st	r0,	0f260h

;;	printf("\033[2K\rBH1780GLI> Ambient Light = %lu[lx]", (unsigned long)flSensorOut[0]);
CLINEA 0000H 0001H 03E1H 0002H 0056H
	l	er0,	NEAR _flSensorOut
	push	xr0
	bl	__ftolu8sw
	pop	xr0
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 03F0H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 03F2H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 03F7H 0002H 006DH
	...
	bl	_printf_n
	add	sp,	#18
CBLOCKEND 206 2 1016

;;}
CLINEA 0000H 0001H 03F8H 0001H 0001H
	pop	pc
CBLOCKEND 206 1 1016
CFUNCTIONEND 206
...
;;{
CLINEA 0000H 0001H 0405H 0001H 0001H
	push	lr
CBLOCK 207 2 1029
CRET 0000H

;;	I2C_Read(KX022_I2C_ADDR, &KX022_XOUTL, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 040AH 0002H 0049H
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 040DH 0002H 0042H
	l	er0,	NEAR _uniRawSensorOut
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 040EH 0002H 0042H
	l	er0,	NEAR _uniRawSensorOut+02h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 0412H 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 0415H 0002H 0048H
	mov	r0,	#02h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0417H 0002H 0025H
	l	r0,	NEAR _uniRawSensorOut
CBLOCK 207 3 1048
	cmp	r0,	#01h
	beq	_$L190
...
;;	switch(uniRawSensorOut._ucharArr[0])
CLINEA 0000H 0000H 0417H 0002H 0025H
	cmp	r0,	#02h
	beq	_$L191
...
CLINEA 0000H 0000H 041FH 0003H 002AH
	mov	r0,	#00h
CBLOCKEND 207 3 1056

;;	}
CLINEA 0000H 0000H 0420H 0002H 0002H
_$L188 :
	st	r0,	0f260h
...
CLINEA 0000H 0001H 0430H 0002H 0050H
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0431H 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut
...
CLINEA 0000H 0001H 0432H 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+02h
	srlc	r0,	#02h
	sra	r1,	#02h
...
CLINEA 0000H 0001H 0433H 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+04h
	srlc	r0,	#02h
	sra	r1,	#02h
...
CLINEA 0000H 0001H 0435H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 0436H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut+02h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 0437H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut+04h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;		uniRawSensorOut._intArr[0], flSensorOut[0], uniRawSensorOut._intArr[1], flSensorOut[1], uniRawSensorOut._intArr[2], flSensorOut[2]);
CLINEA 0000H 0001H 0439H 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 043BH 0002H 0049H
	mov	er0,	#0 
	mov	r2,	#00h
	mov	r3,	#0bfh
	push	xr0
...
CLINEA 0000H 0001H 043CH 0003H 0048H
	mov	r0,	#020h
	st	r0,	0f260h

;;	else if(0.866f<flSensorOut[0] && -0.5f<flSensorOut[1] && flSensorOut[1]<0.5f)
CLINEA 0000H 0001H 043DH 0002H 004EH
	b	_$L245
_$L198 :
	mov	r0,	#02dh
	mov	r1,	#0b2h
...
CLINEA 0000H 0001H 043EH 0003H 0048H
	mov	r0,	#01h
	st	r0,	0f260h

;;	else if(-0.5f<flSensorOut[0] && flSensorOut[0]<0.5f && flSensorOut[1]<-0.866f)
CLINEA 0000H 0001H 043FH 0002H 004FH
	b	_$L245
_$L209 :
	mov	er0,	#0 
	mov	r2,	#00h
...
CLINEA 0000H 0001H 0440H 0003H 0049H
	mov	r0,	#04h
	st	r0,	0f260h

;;	else if(flSensorOut[0]<-0.866f && -0.5f<flSensorOut[1] && flSensorOut[1]<0.5f)
CLINEA 0000H 0001H 0441H 0002H 004FH
	b	_$L245
_$L220 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 0442H 0003H 0049H
	mov	r0,	#080h
	st	r0,	0f260h

;;	else if(flSensorOut[2]>0.866f)
CLINEA 0000H 0001H 0443H 0002H 001FH
	bal	_$L245
_$L231 :
...
CLINEA 0000H 0001H 0444H 0003H 0033H
	mov	r0,	#010h
	st	r0,	0f260h

;;	else if(flSensorOut[2]<-0.866f)
CLINEA 0000H 0001H 0445H 0002H 0020H
	bal	_$L245
_$L242 :
	l	er0,	NEAR _flSensorOut+08h
	l	er2,	NEAR _flSensorOut+0ah
...
CLINEA 0000H 0001H 0446H 0003H 0034H
	mov	r0,	#08h
	st	r0,	0f260h
_$L245 :

;;	I2C_Read(KMX61_I2C_ADDR, &KMX61_MAG_XOUT_L, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 0449H 0002H 004EH
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
;;	uniRawSensorOut._intArr[0] = uniRawSensorOut._intArr[0]>>2;
CLINEA 0000H 0001H 044AH 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut
...
;;	uniRawSensorOut._intArr[1] = uniRawSensorOut._intArr[1]>>2;
CLINEA 0000H 0001H 044BH 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+02h
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut+02h
...
;;	uniRawSensorOut._intArr[2] = uniRawSensorOut._intArr[2]>>2;
CLINEA 0000H 0001H 044CH 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+04h
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 044EH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 044FH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut+02h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 0450H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut+04h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;		uniRawSensorOut._intArr[0], flSensorOut[0], uniRawSensorOut._intArr[1], flSensorOut[1], uniRawSensorOut._intArr[2], flSensorOut[2]);
CLINEA 0000H 0001H 0452H 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
	...
	bl	_printf_n
	add	sp,	#32
CBLOCKEND 208 2 1107

;;}
CLINEA 0000H 0001H 0453H 0001H 0001H
	pop	pc
CBLOCKEND 208 1 1107
CFUNCTIONEND 208
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 0461H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0463H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 0465H 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
CLINEA 0000H 0001H 0468H 0002H 006CH
	...
	bl	_printf_n
	add	sp,	#18
CBLOCKEND 209 2 1129

;;}
CLINEA 0000H 0001H 0469H 0001H 0001H
	pop	pc
CBLOCKEND 209 1 1129
CFUNCTIONEND 209
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 0477H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0479H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
;;	flSensorOut[1] = Voltage2Temperature(flSensorOut[0], 1.3f, 30.0f, -0.0082f);
CLINEA 0000H 0001H 047BH 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
CLINEA 0000H 0001H 047FH 0002H 001DH
	tb	0f258h.2
	beq	_$L252

;;		PRINTF("\n\rBDJ0601HFV> Temperature Threshold Reached.\033[1F");
CLINEA 0000H 0001H 0480H 0003H 0042H
	mov	er0,	#49
	push	er0
...
;;	else
CLINEA 0000H 0001H 0481H 0002H 0005H
	bal	_$L255
_$L252 :

;;		PRINTF("\n\rBDJ0601HFV> Temperature Threshold Not Reached.\033[1F");
CLINEA 0000H 0001H 0482H 0003H 0046H
	mov	er0,	#53
	push	er0
...
_$L255 :
	add	sp,	#2 
CBLOCKEND 210 2 1155

;;}
CLINEA 0000H 0001H 0483H 0001H 0001H
	pop	pc
CBLOCKEND 210 1 1155
CFUNCTIONEND 210
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 0491H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0493H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 0495H 0002H 0050H
	push	xr0
	mov	r0,	#04eh
	mov	r1,	#062h
	mov	r2,	#0e0h
...
;;	if(SENINTF_HDR1_GPIO0(D)==0)
CLINEA 0000H 0001H 0499H 0002H 001DH
	tb	0f258h.2
	bne	_$L259

;;		PRINTF("\n\rBDE0600G> Temperature Threshold Reached.\033[1F");
CLINEA 0000H 0001H 049AH 0003H 0040H
	mov	er0,	#47
	push	er0
...
;;	else
CLINEA 0000H 0001H 049BH 0002H 0005H
	bal	_$L262
_$L259 :

;;		PRINTF("\n\rBDE0600G> Temperature Threshold Not Reached.\033[1F");
CLINEA 0000H 0001H 049CH 0003H 0044H
	mov	er0,	#51
	push	er0
...
_$L262 :
	add	sp,	#2 
CBLOCKEND 211 2 1181

;;}
CLINEA 0000H 0001H 049DH 0001H 0001H
	pop	pc
CBLOCKEND 211 1 1181
CFUNCTIONEND 211
...
;;{
CLINEA 0000H 0001H 04AAH 0001H 0001H
	push	lr
CBLOCK 212 2 1194
CRET 0000H

;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 04ABH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 04ADH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
;;	flSensorOut[1] = Voltage2Temperature(flSensorOut[0], 1.3f, 30.0f, -0.0082f);
CLINEA 0000H 0001H 04AFH 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
;;	if(SENINTF_HDR1_GPIO0(D)==0)
CLINEA 0000H 0001H 04B3H 0002H 001DH
	tb	0f258h.2
	bne	_$L266

;;		PRINTF("\n\rBDJ0550HFV> Temperature Threshold Reached.\033[1F");
CLINEA 0000H 0001H 04B4H 0003H 0042H
	mov	er0,	#49
	push	er0
...
;;	else
CLINEA 0000H 0001H 04B5H 0002H 0005H
	bal	_$L269
_$L266 :

;;		PRINTF("\n\rBDJ0550HFV> Temperature Threshold Not Reached.\033[1F");
CLINEA 0000H 0001H 04B6H 0003H 0046H
	mov	er0,	#53
	push	er0
...
_$L269 :
	add	sp,	#2 
CBLOCKEND 212 2 1207

;;}
CLINEA 0000H 0001H 04B7H 0001H 0001H
	pop	pc
CBLOCKEND 212 1 1207
CFUNCTIONEND 212
...
CLINEA 0000H 0001H 04C6H 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO1(DIR) = 1;
CLINEA 0000H 0001H 04C7H 0002H 001DH
	sb	0f259h.3

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 04C9H 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 04CAH 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO1(C0) = 0;
CLINEA 0000H 0001H 04CBH 0002H 001CH
	rb	0f25ah.3

;;	SENINTF_HDR1_GPIO1(C1) = 1;
CLINEA 0000H 0001H 04CCH 0002H 001CH
	sb	0f25bh.3
...
CLINEA 0000H 0001H 04D0H 0002H 001DH
	rb	0f25ch.3

;;	SENINTF_HDR1_GPIO1(MD1) = 0;
CLINEA 0000H 0001H 04D1H 0002H 001DH
	rb	0f25dh.3
CBLOCKEND 214 2 1234

;;}
CLINEA 0000H 0001H 04D2H 0001H 0001H
	rt
CBLOCKEND 214 1 1234
CFUNCTIONEND 214
...
;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 04E1H 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 04E3H 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 04E4H 0002H 001CH
	sb	0f25bh.2
...
;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 04E7H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 213 2 1256

;;}
CLINEA 0000H 0001H 04E8H 0001H 0001H
	rt
CBLOCKEND 213 1 1256
CFUNCTIONEND 213
...
;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 04F7H 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO1(DIR) = 1;
CLINEA 0000H 0001H 04F8H 0002H 001DH
	sb	0f259h.3

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 04FAH 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 04FBH 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO1(C0) = 0;
CLINEA 0000H 0001H 04FCH 0002H 001CH
	rb	0f25ah.3

;;	SENINTF_HDR1_GPIO1(C1) = 1;
CLINEA 0000H 0001H 04FDH 0002H 001CH
	sb	0f25bh.3
...
;;	SENINTF_HDR1_GPIO1(MD0) = 0;
CLINEA 0000H 0001H 0501H 0002H 001DH
	rb	0f25ch.3

;;	SENINTF_HDR1_GPIO1(MD1) = 0;
CLINEA 0000H 0001H 0502H 0002H 001DH
	rb	0f25dh.3
CBLOCKEND 215 2 1283

;;}
CLINEA 0000H 0001H 0503H 0001H 0001H
	rt
CBLOCKEND 215 1 1283
CFUNCTIONEND 215
...
CLINEA 0000H 0001H 0512H 0002H 003CH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0514H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
;;	NOPms(24);
CLINEA 0000H 0001H 0519H 0002H 000BH
	mov	er0,	#24
	bl	_NOPms
CBLOCKEND 216 2 1306

;;}
CLINEA 0000H 0001H 051AH 0001H 0001H
	pop	pc
CBLOCKEND 216 1 1306
CFUNCTIONEND 216
...
CLINEA 0000H 0001H 0528H 0002H 001AH
	mov	r0,	#00h
	st	r0,	-1[fp]

;;	I2C_Write(BH17xxFVC_ADDR_2, &BH1730FVC_REG_INTERRUPT, 1, &cTmp, 1);
CLINEA 0000H 0001H 052BH 0002H 0044H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
CLINEA 0000H 0001H 052DH 0002H 003FH
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
;;	cTmp = 0xdau;
CLINEA 0000H 0001H 052FH 0002H 000EH
	mov	r0,	#0dah
	st	r0,	-1[fp]

;;	I2C_Write(BH17xxFVC_ADDR_2, &BH1730FVC_REG_TIMING, 1, &cTmp, 1);
CLINEA 0000H 0001H 0530H 0002H 0041H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
;;	cTmp = 0x3;
CLINEA 0000H 0001H 0532H 0002H 000CH
	mov	r0,	#03h
	st	r0,	-1[fp]

;;	I2C_Write(BH17xxFVC_ADDR_2, &BH1730FVC_REG_CONTROL, 1, &cTmp, 1);
CLINEA 0000H 0001H 0533H 0002H 0042H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
CLINEA 0000H 0001H 0535H 0002H 0042H
	mov	r0,	#00h
	push	r0
	mov	er0,	#0 
	push	er0
...
;;{	
CLINEA 0000H 0001H 0543H 0001H 0002H
	push	lr
CBLOCK 218 2 1347
CRET 0000H

;;	I2C_Write(BH17xxFVC_ADDR_1, NULL, 0, &BH17xxFVC_PWR_ON, 1);
CLINEA 0000H 0001H 0545H 0002H 003CH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _BH17xxFVC_PWR_ON
	mov	r1,	#BYTE2 OFFSET _BH17xxFVC_PWR_ON
...
CLINEA 0000H 0001H 0547H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 054BH 0002H 000DH
	...
	mov	r1,	#00h
	bl	_NOPms
CBLOCKEND 218 2 1356

;;}
CLINEA 0000H 0001H 054CH 0001H 0001H
	pop	pc
CBLOCKEND 218 1 1356
CFUNCTIONEND 218
...
CLINEA 0000H 0001H 055EH 0002H 0041H
	mov	r0,	#00h
	push	r0
	mov	er0,	#0 
	push	er0
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 219 2 1375

;;}
CLINEA 0000H 0001H 055FH 0001H 0001H
	pop	pc
CBLOCKEND 219 1 1375
CFUNCTIONEND 219
...
CBLOCK 220 2 1388
CBLOCKEND 220 2 1391

;;}
CLINEA 0000H 0001H 056FH 0001H 0001H
	rt
CBLOCKEND 220 1 1391
CFUNCTIONEND 220
...
;;{
CLINEA 0000H 0001H 057CH 0001H 0001H
	push	lr
CBLOCK 221 2 1404
CRET 0000H

;;	I2C_Write(KX022_I2C_ADDR, &KX022_CNTL1, 1, &KX022_CNTL1_CFGDAT, 1);
CLINEA 0000H 0001H 057DH 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 057EH 0002H 0046H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 057FH 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0580H 0002H 004EH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0582H 0002H 0032H
	mov	r0,	#0c1h
	st	r0,	NEAR _uniRawSensorOut

;;	I2C_Write(KX022_I2C_ADDR, &KX022_CNTL1, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 0583H 0002H 0048H
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 221 2 1412

;;}
CLINEA 0000H 0001H 0584H 0001H 0001H
	pop	pc
CBLOCKEND 221 1 1412
CFUNCTIONEND 221
...
;;{ 
CLINEA 0000H 0001H 0591H 0001H 0002H
	push	lr
CBLOCK 222 2 1425
CRET 0000H
...
CLINEA 0000H 0001H 0594H 0002H 004BH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0596H 0002H 004CH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0597H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0598H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0599H 0002H 0046H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 059AH 0002H 0052H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 059BH 0002H 004CH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 059CH 0002H 004CH
	mov	r0,	#01h
	push	r0
...
;;	I2C_Write(KMX61_I2C_ADDR, &KMX61_STBY_REG, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 059FH 0002H 004BH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 222 2 1440

;;}
CLINEA 0000H 0001H 05A0H 0001H 0001H
	pop	pc
CBLOCKEND 222 1 1440
CFUNCTIONEND 222
...
CBLOCK 223 2 1453
CBLOCKEND 223 2 1456

;;}
CLINEA 0000H 0001H 05B0H 0001H 0001H
	rt
CBLOCKEND 223 1 1456
CFUNCTIONEND 223
...
;;{
CLINEA 0000H 0001H 05BDH 0001H 0001H
CBLOCK 224 2 1469

;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 05BFH 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 05C1H 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 05C2H 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 05C4H 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05C5H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 224 2 1478

;;}
CLINEA 0000H 0001H 05C6H 0001H 0001H
	rt
CBLOCKEND 224 1 1478
CFUNCTIONEND 224
...
;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 05D5H 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 05D7H 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 05D8H 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 05DAH 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05DBH 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 225 2 1500

;;}
CLINEA 0000H 0001H 05DCH 0001H 0001H
	rt
CBLOCKEND 225 1 1500
CFUNCTIONEND 225
...
;;{
CLINEA 0000H 0001H 05E9H 0001H 0001H
CBLOCK 226 2 1513

;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 05EBH 0002H 001DH
	sb	0f259h.2

;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 05EDH 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 05EEH 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 05F0H 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05F1H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 226 2 1522

;;}
CLINEA 0000H 0001H 05F2H 0001H 0001H
	rt
CBLOCKEND 226 1 1522
CFUNCTIONEND 226
...
;;{
CLINEA 0000H 0001H 05FDH 0001H 0001H
CBLOCK 179 2 1533

;;	do {
CLINEA 0000H 0001H 0600H 0002H 0005H
_$L288 :
CBLOCK 179 3 1536

;;		WDTCON = 0x5Au;
CLINEA 0000H 0001H 0601H 0003H 0011H
	mov	r0,	#05ah
	st	r0,	0f00eh
CBLOCKEND 179 3 1538

;;	} while (WDP != 1);
CLINEA 0000H 0000H 0602H 0002H 0014H
	tb	0f00eh.0
	beq	_$L288

;;	WDTCON = 0xA5u;
CLINEA 0000H 0001H 0603H 0002H 0010H
	mov	r0,	#0a5h
	st	r0,	0f00eh
CBLOCKEND 179 2 1540

;;}
CLINEA 0000H 0001H 0604H 0001H 0001H
	rt
CBLOCKEND 179 1 1540
CFUNCTIONEND 179
...
CLINEA 0000H 0001H 0610H 0002H 0054H
	bl	_uart_continue

;;	_flgUartFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0611H 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __flgUartFin

;;	main_reqNotHalt();				// uncommented 5/2/2013
CLINEA 0000H 0001H 0612H 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 190 2 1555

;;}
CLINEA 0000H 0001H 0613H 0001H 0001H
	pop	pc
CBLOCKEND 190 1 1555
CFUNCTIONEND 190
...
CLINEA 0000H 0001H 061FH 0002H 0053H
	bl	_i2c_continue

;;	_flgI2CFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0620H 0002H 0025H
	mov	r0,	#01h
	st	r0,	NEAR __flgI2CFin

;;	main_reqNotHalt();				// uncommented 5/2/2013
CLINEA 0000H 0001H 0621H 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 191 2 1570

;;}
CLINEA 0000H 0001H 0622H 0001H 0001H
	pop	pc
CBLOCKEND 191 1 1570
CFUNCTIONEND 191
...
;;	i2c_continue();
CLINEA 0000H 0001H 062DH 0002H 0010H
	bl	_i2c_continue

;;	main_reqNotHalt();
CLINEA 0000H 0001H 062EH 0002H 0013H
	bl	_main_reqNotHalt
CBLOCKEND 194 2 1583

;;}
CLINEA 0000H 0001H 062FH 0001H 0001H
	pop	pc
CBLOCKEND 194 1 1583
CFUNCTIONEND 194
...
CLINEA 0000H 0001H 063AH 0002H 0010H
	mov	r0,	#01h
	st	r0,	NEAR __flgADCFin
CBLOCKEND 195 2 1595

;;}
CLINEA 0000H 0001H 063BH 0001H 0001H
	rt
CBLOCKEND 195 1 1595
CFUNCTIONEND 195
...
CLINEA 0000H 0001H 0646H 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __reqNotHalt
CBLOCKEND 192 2 1607

;;}
CLINEA 0000H 0001H 0647H 0001H 0001H
	rt
CBLOCKEND 192 1 1607
CFUNCTIONEND 192
...
;;{
CLINEA 0000H 0001H 0651H 0001H 0001H
CBLOCK 193 2 1617

;;	uart_continue(); 	//in UART.c: process to continue send and receive...
CLINEA 0000H 0001H 0652H 0002H 0047H
	b	_uart_continue
CBLOCKEND 193 2 1619
CLINEA 0000H 0001H 0653H 0001H 0001H
CBLOCKEND 193 1 1619
CFUNCTIONEND 193
...
CLINEA 0000H 0001H 0658H 0001H 0019H
CBLOCK 181 2 1624

;;	SYSC0 = 0;			// Used to select the frequency of the HSCLK => 00=8.192MHz.
CLINEA 0000H 0001H 065BH 0002H 004AH
	rb	0f002h.0

;;	SYSC1 = 0;
CLINEA 0000H 0001H 065CH 0002H 000BH
	rb	0f002h.1

;;	OSCM1 = 1;			// 10 => Built-in PLL oscillation mode
CLINEA 0000H 0001H 065EH 0002H 0034H
	sb	0f002h.3

;;	OSCM0 = 0;
CLINEA 0000H 0001H 065FH 0002H 000BH
	rb	0f002h.2

;;	ENOSC = 1;			//1=Enable High Speed Oscillator...
CLINEA 0000H 0001H 0661H 0002H 0031H
	sb	0f003h.1

;;	SYSCLK = 1;			//1=HSCLK; 0=LSCLK 
CLINEA 0000H 0001H 0662H 0002H 0022H
	sb	0f003h.0

;;	LPLL = 1;			//1=Enables the use of PLL oscillation - ADDED 4/30/2013
CLINEA 0000H 0001H 0664H 0002H 0045H
	sb	0f003h.7

;;	__EI();			//INT enable
CLINEA 0000H 0001H 0666H 0002H 0017H
	ei
CBLOCKEND 181 2 1639

;;}
CLINEA 0000H 0001H 0667H 0001H 0001H
	rt
CBLOCKEND 181 1 1639
CFUNCTIONEND 181
...
;;void PortA_Low(void){
CLINEA 0000H 0001H 066DH 0001H 0015H
CBLOCK 182 2 1645

;;	PA0DIR = 0;		// PortA Bit0 set to Output Mode...
CLINEA 0000H 0001H 0677H 0002H 0031H
	rb	0f251h.0
...
CLINEA 0000H 0001H 067EH 0002H 0031H
	sb	0f253h.1
...
;;	PA2C0  = 1;	
CLINEA 0000H 0001H 0681H 0002H 000DH
	sb	0f252h.2
...
;;	PA1MD0  = 0;	
CLINEA 0000H 0001H 0687H 0002H 000EH
	rb	0f254h.1

;;	PA2MD1  = 0;	// PortA Bit2 set to General Purpose Output...
CLINEA 0000H 0001H 0688H 0002H 003CH
	rb	0f255h.2

;;	PA2MD0  = 0;	
CLINEA 0000H 0001H 0689H 0002H 000EH
	rb	0f254h.2

;;	PA0D = 0;		// A.0 Output OFF....
CLINEA 0000H 0001H 068CH 0002H 0021H
	rb	0f250h.0

;;	PA1D = 0;		// A.1 Output OFF....
CLINEA 0000H 0001H 068DH 0002H 0021H
	rb	0f250h.1

;;	PA2D = 0;		// A.2 Output OFF....
CLINEA 0000H 0001H 068EH 0002H 0021H
	rb	0f250h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0690H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 182 2 1681
CLINEA 0000H 0001H 0691H 0001H 0001H
CBLOCKEND 182 1 1681
CFUNCTIONEND 182
...
;;void PortB_Low(void){
CLINEA 0000H 0001H 0697H 0001H 0015H
CBLOCK 183 2 1687
...
CLINEA 0000H 0001H 06A6H 0002H 0031H
	rb	0f259h.5
...
CLINEA 0000H 0001H 06A8H 0002H 0031H
	rb	0f259h.7
...
;;	PB0C0  = 1;		
CLINEA 0000H 0001H 06ACH 0002H 000EH
	sb	0f25ah.0
...
;;	PB1C0  = 1;	
CLINEA 0000H 0001H 06AEH 0002H 000DH
	sb	0f25ah.1
...
;;	PB3C0  = 1;		
CLINEA 0000H 0001H 06B2H 0002H 000EH
	sb	0f25ah.3
...
;;	PB7C0  = 1;	
CLINEA 0000H 0001H 06BAH 0002H 000DH
	sb	0f25ah.7
...
;;	PB3MD0  = 0;	
CLINEA 0000H 0001H 06C4H 0002H 000EH
	rb	0f25ch.3
...
CLINEA 0000H 0001H 06D3H 0002H 0021H
	rb	0f258h.4

;;	PB5D = 0;		// B.5 Output OFF....
CLINEA 0000H 0001H 06D4H 0002H 0021H
	rb	0f258h.5

;;	PB6D = 0;		// B.6 Output OFF....
CLINEA 0000H 0001H 06D5H 0002H 0021H
	rb	0f258h.6

;;	PB7D = 0;		// B.7 Output OFF....
CLINEA 0000H 0001H 06D6H 0002H 0021H
	rb	0f258h.7

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 06D8H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 183 2 1753
CLINEA 0000H 0001H 06D9H 0001H 0001H
CBLOCKEND 183 1 1753
CFUNCTIONEND 183
...
;;void PortC_Low(void){
CLINEA 0000H 0001H 06DFH 0001H 0015H
CBLOCK 184 2 1759
...
CLINEA 0000H 0001H 06EDH 0002H 0031H
	rb	0f261h.4

;;	PC5DIR = 0;		// PortC Bit5 set to Output Mode...
CLINEA 0000H 0001H 06EEH 0002H 0031H
	rb	0f261h.5

;;	PC6DIR = 0;		// PortC Bit6 set to Output Mode...
CLINEA 0000H 0001H 06EFH 0002H 0031H
	rb	0f261h.6
...
;;	PC0C0  = 1;		
CLINEA 0000H 0001H 06F4H 0002H 000EH
	sb	0f262h.0
...
;;	PC1C0  = 1;	
CLINEA 0000H 0001H 06F6H 0002H 000DH
	sb	0f262h.1
...
;;	PC3C0  = 1;		
CLINEA 0000H 0001H 06FAH 0002H 000EH
	sb	0f262h.3
...
;;	PC7C0  = 1;	
CLINEA 0000H 0001H 0702H 0002H 000DH
	sb	0f262h.7
...
;;	PC3MD0  = 0;	
CLINEA 0000H 0001H 070CH 0002H 000EH
	rb	0f264h.3
...
;;	PC7MD0  = 0;
CLINEA 0000H 0001H 0714H 0002H 000DH
	rb	0f264h.7
...
CLINEA 0000H 0001H 071BH 0002H 0021H
	rb	0f260h.4

;;	PC5D = 0;		// C.5 Output OFF....
CLINEA 0000H 0001H 071CH 0002H 0021H
	rb	0f260h.5

;;	PC6D = 0;		// C.6 Output OFF....
CLINEA 0000H 0001H 071DH 0002H 0021H
	rb	0f260h.6
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0720H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 184 2 1826
CLINEA 0000H 0001H 0722H 0001H 0001H
CBLOCKEND 184 1 1826
CFUNCTIONEND 184
...
;;void PortD_Low(void){
CLINEA 0000H 0001H 0728H 0001H 0015H
CBLOCK 185 2 1832
...
CLINEA 0000H 0001H 0733H 0002H 0030H
	sb	0f269h.2

;;	PD3DIR = 1;		// PortD Bit3 set to Input Mode...
CLINEA 0000H 0001H 0734H 0002H 0030H
	sb	0f269h.3

;;	PD4DIR = 1;		// PortD Bit4 set to Input Mode...
CLINEA 0000H 0001H 0735H 0002H 0030H
	sb	0f269h.4

;;	PD5DIR = 1;		// PortD Bit5 set to Input Mode...
CLINEA 0000H 0001H 0736H 0002H 0030H
	sb	0f269h.5
...
;;	PD0C0= 1;		
CLINEA 0000H 0001H 073AH 0002H 000CH
	sb	0f26ah.0
...
;;	PD1C0= 1;	
CLINEA 0000H 0001H 073CH 0002H 000BH
	sb	0f26ah.1
...
;;	PD3C0= 1;		
CLINEA 0000H 0001H 0740H 0002H 000CH
	sb	0f26ah.3
...
;;	PD4C0= 1;	
CLINEA 0000H 0001H 0742H 0002H 000BH
	sb	0f26ah.4
...
CLINEA 0000H 0001H 0749H 0002H 0020H
	rb	0f268h.2

;;	PD3D = 0;		// D.3 Input OFF....
CLINEA 0000H 0001H 074AH 0002H 0020H
	rb	0f268h.3

;;	PD4D = 0;		// D.4 Input OFF....
CLINEA 0000H 0001H 074BH 0002H 0020H
	rb	0f268h.4

;;	PD5D = 0;		// D.5 Input OFF....
CLINEA 0000H 0001H 074CH 0002H 0020H
	rb	0f268h.5

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 074EH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 185 2 1871
CLINEA 0000H 0001H 074FH 0001H 0001H
CBLOCKEND 185 1 1871
CFUNCTIONEND 185
...
;;	TempSec = ms;
CLINEA 0000H 0001H 0764H 0002H 000EH
	mov	er4,	er0

;;	TimeFlag = 0;
CLINEA 0000H 0001H 0765H 0002H 000EH
	mov	r6,	#00h

;;	tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 0767H 0002H 0016H
	mov	r0,	#01h
	bl	_tm_init

;;	tm_setABSource(TM_CS_HTBCLK);
CLINEA 0000H 0001H 0768H 0002H 001EH
	sb	0f8eah.0
	rb	0f8eah.1

;;	tm_setABData(0xffff);
CLINEA 0000H 0001H 0769H 0002H 0016H
	mov	r0,	#0ffh
	st	r0,	0f8e8h
	st	r0,	0f8ech

;;	if(ms < 128){
CLINEA 0000H 0001H 076BH 0002H 000EH
	mov	er0,	er8
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bge	_$L302
...
;;		timerThres = 0x1FF * ms;
CLINEA 0000H 0001H 076CH 0003H 001AH
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
...
;;	if(ms == 128){
CLINEA 0000H 0001H 076FH 0002H 000FH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bne	_$L304
CBLOCK 196 4 1903
...
;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0770H 0003H 0016H
	mov	bp,	#-1

;;		TimeFlag = 0;
CLINEA 0000H 0001H 0771H 0003H 000FH
	mov	r6,	#00h
CBLOCKEND 196 4 1906

;;	}
CLINEA 0000H 0000H 0772H 0002H 0002H
_$L304 :
...
;;		while(TempSec > 128){
CLINEA 0000H 0000H 0774H 0003H 0017H
_$L310 :
CBLOCK 196 6 1908

;;			TempSec -= 128;
CLINEA 0000H 0001H 0775H 0004H 0012H
	add	r0,	#080h
	addc	r1,	#0ffh
	mov	er4,	er0

;;			TimeFlag++;
CLINEA 0000H 0000H 0776H 0004H 000EH
	add	r6,	#01h
CBLOCKEND 196 6 1911
...
;;		if(TempSec != 0){
CLINEA 0000H 0001H 0778H 0003H 0013H
	mov	er4,	er4
	beq	_$L312
CBLOCK 196 7 1912

;;			timerThres = 0x1FF * TempSec;
CLINEA 0000H 0001H 0779H 0004H 0020H
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
	...
	subc	r1,	r5
	mov	bp,	er0
CBLOCKEND 196 7 1914

;;		else{
CLINEA 0000H 0001H 077BH 0003H 0007H
	bal	_$L314
_$L312 :
CBLOCK 196 8 1915

;;			timerThres = 0xFFFF;
CLINEA 0000H 0001H 077CH 0004H 0017H
	mov	bp,	#-1

;;			TimeFlag--;
CLINEA 0000H 0000H 077DH 0004H 000EH
	add	r6,	#0ffh
CBLOCKEND 196 8 1918

;;		}
CLINEA 0000H 0000H 077EH 0003H 0003H
_$L314 :
CBLOCKEND 196 5 1919

;;	main_clrWDT();	
CLINEA 0000H 0001H 0782H 0002H 0010H
	bl	_main_clrWDT

;;	tm_startAB();
CLINEA 0000H 0001H 0784H 0002H 000EH
	mov	r0,	#00h
	st	r0,	0f8e9h
	sb	0f8ebh.0

;;	while(timer < timerThres){
CLINEA 0000H 0001H 0786H 0002H 001BH
_$L318 :
CBLOCK 196 9 1926

;;		timer = tm_getABCounter();
CLINEA 0000H 0000H 0787H 0003H 001CH
CBLOCKEND 196 9 1929

;;	}
CLINEA 0000H 0000H 0789H 0002H 0002H
_$L316 :
	l	r0,	0f8e9h
	mov	r1,	#00h
	mov	er2,	er0
...
;;	while(timer < timerThres){
CLINEA 0000H 0000H 0786H 0000H 0000H
	cmp	er2,	bp
	blt	_$L318

;;	if(TimeFlag !=0){
CLINEA 0000H 0001H 078AH 0002H 0012H
	cmp	r6,	#00h
	beq	_$L320
...
;;		TimeFlag--;
CLINEA 0000H 0000H 078CH 0003H 000DH
	add	r6,	#0ffh

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 078DH 0003H 0016H
	mov	bp,	#-1

;;		goto TimerRestart;
CLINEA 0000H 0001H 078EH 0003H 0014H
	bal	_$L314

;;	}
CLINEA 0000H 0000H 078FH 0002H 0002H
_$L320 :
CBLOCKEND 196 2 1936
...
_KMX61_BUF_CTRL2_CFGDAT :
	...
	rseg $$TAB$$S30$main
$$S30 :
	DB	"\x1b[2J\x1b[1;1H*********************************************\x0a\x0d** Q112 Firmware - Sensor Platform EVK\x0a\x0d** Revision    : REV00\x0a\x0d** Release date: Sep 16 2014 16:23:27\x0a\x0d** By          : ROHM Semiconductor USA, LLC\x0a\x0d********************************************"
	DB	"*\x0a\x0d", 00H
...
$$S249 :
	...
	rseg $$TAB$$S251$main
$$S251 :
	DB	"\x1b[0J\x0dBDJ0601HFV> Temperature = %.02f[\xc2\xb0C]. Vsenout = %.02f[V]", 00H

	rseg $$TAB$$S254$main
$$S254 :
	DB	"\x0a\x0dBDJ0601HFV> Temperature Threshold Reached.\x1b[1F", 00H

	rseg $$TAB$$S256$main
$$S256 :
	DB	"\x0a\x0dBDJ0601HFV> Temperature Threshold Not Reached.\x1b[1F", 00H

	rseg $$TAB$$S258$main
$$S258 :
	DB	"\x1b[0J\x0dBDE0600G> Temperature = %.02f[\xc2\xb0C]. Vsenout = %.02f[V]", 00H

	rseg $$TAB$$S261$main
$$S261 :
	DB	"\x0a\x0dBDE0600G> Temperature Threshold Reached.\x1b[1F", 00H

	rseg $$TAB$$S263$main
$$S263 :
	DB	"\x0a\x0dBDE0600G> Temperature Threshold Not Reached.\x1b[1F", 00H

	rseg $$TAB$$S265$main
$$S265 :
	DB	"\x1b[0J\x0dBDJ0550HFV> Temperature = %.02f[\xc2\xb0C]. Vsenout = %.02f[V]", 00H

	rseg $$TAB$$S268$main
$$S268 :
	DB	"\x0a\x0dBDJ0550HFV> Temperature Threshold Reached.\x1b[1F", 00H

	rseg $$TAB$$S270$main
$$S270 :
	DB	"\x0a\x0dBDJ0550HFV> Temperature Threshold Not Reached.\x1b[1F", 00H
