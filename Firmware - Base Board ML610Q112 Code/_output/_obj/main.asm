...
CGLOBAL 01H 03H 0000H "main" 08H 02H 0E5H 00H 80H 02H 00H 00H 01H
...
CFILE 0000H 000007D3H "main\\main.c"
...
;;{ 	
CLINEA 0000H 0001H 01A7H 0001H 0003H
CBLOCK 229 2 423

;;	Initialization(); //Ports, UART, Timers, Oscillator, Comparators, etc.
CLINEA 0000H 0001H 01A8H 0002H 0047H
	bl	_Initialization

;;	PRINTF(WelcomeString);
CLINEA 0000H 0001H 01AAH 0002H 0017H
	mov	r0,	#0feh
	mov	r1,	#00h
	push	er0
...
CLINEA 0000H 0001H 01B9H 0003H 0019H
	bl	_SensorInitialization

;;		SensorIntializationFlag = 0;
CLINEA 0000H 0001H 01BAH 0003H 001EH
	mov	r0,	#00h
...
CLINEA 0000H 0001H 01BDH 0002H 0021H
...
CLINEA 0000H 0001H 01EEH 0002H 0034H
	sb	0f009h.0

;;	__asm("nop\n"); 
CLINEA 0000H 0001H 01EFH 0002H 0011H
nop


;;	__asm("nop\n");
CLINEA 0000H 0001H 01F0H 0002H 0010H
nop


;;	goto MainLoop;
CLINEA 0000H 0001H 01F2H 0002H 000FH
	bal	_$L31
CBLOCKEND 229 2 499

;;		case 1:
CLINEA 0000H 0001H 01BEH 0003H 0009H
_$S39 :

;;			MainOp_Hall_Effect_Sensors_1(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 01BFH 0004H 0057H
	bl	_MainOp_Hall_Effect_Sensors_1

;;			break;
CLINEA 0000H 0001H 01C0H 0004H 0009H
	bal	_$L37

;;		case 2:
CLINEA 0000H 0001H 01C1H 0003H 0009H
_$S40 :

;;			MainOp_Hall_Effect_Sensors_2(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01C2H 0004H 0058H
	bl	_MainOp_Hall_Effect_Sensors_2

;;			break;
CLINEA 0000H 0001H 01C3H 0004H 0009H
	bal	_$L37

;;		case 5: 
CLINEA 0000H 0001H 01C4H 0003H 000AH
_$S41 :

;;			MainOp_Ambient_Light_Sensor_5(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 01C5H 0004H 0058H
	bl	_MainOp_Ambient_Light_Sensor_5

;;			break;
CLINEA 0000H 0001H 01C6H 0004H 0009H
	bal	_$L37

;;		case 6:
CLINEA 0000H 0001H 01C7H 0003H 0009H
_$S42 :

;;			MainOp_Ambient_Light_Sensor_6(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01C8H 0004H 0059H
	bl	_MainOp_Ambient_Light_Sensor_6

;;			break;
CLINEA 0000H 0001H 01C9H 0004H 0009H
	bal	_$L37

;;		case 7:
CLINEA 0000H 0001H 01CAH 0003H 0009H
_$S43 :

;;			MainOp_Ambient_Light_Sensor_7(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01CBH 0004H 0059H
	bl	_MainOp_Ambient_Light_Sensor_7

;;			break;
CLINEA 0000H 0001H 01CCH 0004H 0009H
	bal	_$L37

;;		case 8:
CLINEA 0000H 0001H 01CDH 0003H 0009H
_$S44 :

;;			MainOp_Ambient_Light_Sensor_8(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01CEH 0004H 0059H
	bl	_MainOp_Ambient_Light_Sensor_8

;;			break;
CLINEA 0000H 0001H 01CFH 0004H 0009H
	bal	_$L37

;;		case 9:
CLINEA 0000H 0001H 01D0H 0003H 0009H
_$S45 :
...
;;			break;
CLINEA 0000H 0001H 01D2H 0004H 0009H
	bal	_$L37

;;		case 10:
CLINEA 0000H 0001H 01D3H 0003H 000AH
_$S46 :

;;			MainOp_UV_Sensor_10(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01D4H 0004H 004FH
	bl	_MainOp_UV_Sensor_10

;;			break;
CLINEA 0000H 0001H 01D5H 0004H 0009H
	bal	_$L37

;;		case 15:
CLINEA 0000H 0001H 01D6H 0003H 000AH
_$S47 :

;;			MainOp_KX022(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01D7H 0004H 0048H
	bl	_MainOp_KX022

;;			break;
CLINEA 0000H 0001H 01D8H 0004H 0009H
	bal	_$L37

;;		case 16:
CLINEA 0000H 0001H 01D9H 0003H 000AH
_$S48 :

;;			MainOp_KMX61(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01DAH 0004H 0048H
	bl	_MainOp_KMX61

;;			break;
CLINEA 0000H 0001H 01DBH 0004H 0009H
	bal	_$L37

;;		case 20:
CLINEA 0000H 0001H 01DCH 0003H 000AH
_$S49 :

;;			MainOp_Temperature_Sensor_20(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01DDH 0004H 0058H
	bl	_MainOp_Temperature_Sensor_20

;;			break;
CLINEA 0000H 0001H 01DEH 0004H 0009H
	bal	_$L37

;;		case 21:
CLINEA 0000H 0001H 01DFH 0003H 000AH
_$S50 :

;;			MainOp_Temperature_Sensor_21(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 01E0H 0004H 0057H
	bl	_MainOp_Temperature_Sensor_21

;;			break;
CLINEA 0000H 0001H 01E1H 0004H 0009H
	bal	_$L37

;;		case 22:
CLINEA 0000H 0001H 01E2H 0003H 000AH
_$S51 :

;;			MainOp_Temperature_Sensor_22(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 01E3H 0004H 0058H
	bl	_MainOp_Temperature_Sensor_22

;;			break;
CLINEA 0000H 0001H 01E4H 0004H 0009H
	bal	_$L37

;;		case 23:
CLINEA 0000H 0001H 01E5H 0003H 000AH
_$S52 :

;;			MainOp_Temperature_Sensor_23(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 01E6H 0004H 0057H
	bl	_MainOp_Temperature_Sensor_23

;;			break; 
CLINEA 0000H 0001H 01E7H 0004H 000AH
	bal	_$L37

;;		default:
CLINEA 0000H 0001H 01E8H 0003H 000AH
_$L38 :

;;			PRINTF(ESC_ERASE2END "No device connected." ESC_SOL);
CLINEA 0000H 0001H 01E9H 0004H 0038H
	mov	er0,	#25
	push	er0
...
;;			FlashLEDs();
CLINEA 0000H 0001H 01EAH 0004H 000FH
	bl	_FlashLEDs

;;			break;
CLINEA 0000H 0001H 01EBH 0004H 0009H
	bal	_$L37
CBLOCKEND 229 4 492
CBLOCKEND 229 1 499
CFUNCTIONEND 229
...
CLINEA 0000H 0001H 01FFH 0001H 0021H
	push	lr
CBLOCK 180 2 511
CRET 0000H
...
CLINEA 0000H 0001H 0210H 0002H 003CH
	bl	_PortC_Low

;;	PortD_Low();	//Initialize all 6 Ports of Port D to input GPIO
CLINEA 0000H 0001H 0211H 0002H 003EH
	bl	_PortD_Low

;;    SetOSC();
CLINEA 0000H 0001H 0214H 0005H 000DH
	bl	_SetOSC

;;	PA0DIR = 1;
CLINEA 0000H 0001H 0217H 0002H 000CH
	sb	0f251h.0

;;	PA1DIR = 1;		//GPIO Input
CLINEA 0000H 0001H 0218H 0002H 001AH
	sb	0f251h.1
...
CLINEA 0000H 0001H 021AH 0002H 0039H
	sb	0f2f2h.1

;;	SALP = 0;		//Single Read or Continuous Read... Single = 0, Consecutive = 1
CLINEA 0000H 0001H 021BH 0002H 004BH
	rb	0f2f0h.0

;;	irq_di();	// Disable Interrupts
CLINEA 0000H 0001H 021FH 0002H 0020H
	bl	_irq_di

;;	irq_init();	// Initialize Interrupts (All Off and NO Requests)
CLINEA 0000H 0001H 0220H 0002H 003FH
	bl	_irq_init

;;	IE0 = IE1 = IE2 = IE3 = IE4 = IE5 = IE6 = IE7 = 0;
CLINEA 0000H 0001H 0223H 0002H 0033H
	mov	r0,	#00h
	st	r0,	0f017h
	st	r0,	0f016h
	st	r0,	0f015h
...
CLINEA 0000H 0001H 0225H 0002H 003BH
	st	r0,	0f01fh
	st	r0,	0f01eh
	st	r0,	0f01dh
	st	r0,	0f01ch
...
CLINEA 0000H 0001H 0227H 0002H 0045H
	rb	0f017h.3

;;	irq_setHdr((unsigned char)IRQ_NO_UA0INT, _intUart);
CLINEA 0000H 0001H 0229H 0002H 0034H
...
CLINEA 0000H 0001H 022AH 0002H 004AH
	sb	0f014h.0

;;	irq_setHdr((unsigned char)IRQ_NO_I2CMINT, _intI2c);
CLINEA 0000H 0001H 022CH 0002H 0034H
...
;;	QI2CM = 0;
CLINEA 0000H 0001H 022EH 0002H 000BH
	rb	0f01ah.7

;;	irq_setHdr((unsigned char)IRQ_NO_SADINT, _intADC);
CLINEA 0000H 0001H 0231H 0002H 0033H
...
;;	QSAD = 0;
CLINEA 0000H 0001H 0233H 0002H 000AH
	rb	0f01ah.2

;;	irq_ei(); // Enable Interrupts
CLINEA 0000H 0001H 023FH 0002H 001FH
	bl	_irq_ei

;;	WDTMOD = 0x01; 	
CLINEA 0000H 0001H 024BH 0002H 0011H
	mov	r0,	#01h
	st	r0,	0f00fh

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 024CH 0002H 001DH
	bl	_main_clrWDT

;;	i2c_init(I2C_MOD_FST, (unsigned short)HSCLK_KHZ, I2C_SYN_OFF);
CLINEA 0000H 0001H 0252H 0002H 003FH
	mov	r0,	#00h
	push	r0
	mov	r2,	#040h
	mov	r3,	#01fh
...
;;			   &_uartSetParam );				/* Param... 	 */
CLINEA 0000H 0001H 0257H 0007H 002BH
...
;;	uart_PortSet();
CLINEA 0000H 0001H 0258H 0002H 0010H
	bl	_uart_PortSet
CBLOCKEND 180 2 604

;;}//End Initialization
CLINEA 0000H 0001H 025CH 0001H 0015H
	pop	pc
CBLOCKEND 180 1 604
CFUNCTIONEND 180
...
;;	_flgUartFin = 0; 
CLINEA 0000H 0001H 026BH 0002H 0012H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 026CH 0002H 000DH
	bl	_uart_stop

;;	uart_startSend(buffer, len, _funcUartFin); 
CLINEA 0000H 0001H 026DH 0002H 002CH
...
;;	while(_flgUartFin != 1)
CLINEA 0000H 0000H 026EH 0001H 0001H
	bal	_$L60

;;	while(_flgUartFin != 1)
CLINEA 0000H 0000H 026EH 0002H 0018H
_$L58 :
CBLOCK 186 3 623

;;		main_clrWDT();
CLINEA 0000H 0001H 0270H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 186 3 625
...
;;	return len;
CLINEA 0000H 0001H 0272H 0002H 000CH
	l	er0,	4[fp]
CBLOCKEND 186 2 627

;;}
CLINEA 0000H 0000H 0273H 0001H 0001H
	pop	er10
	mov	sp,	fp
	pop	fp
	pop	pc
...
;;{
CLINEA 0000H 0001H 027EH 0001H 0001H
	push	lr
	push	er8
	mov	r8,	r0
CBLOCK 187 2 638
...
;;	_flgADCFin = 0;
CLINEA 0000H 0001H 027FH 0002H 0010H
	mov	r0,	#00h
	st	r0,	NEAR __flgADCFin

;;	SADMOD0 = (unsigned char)(1<<idx);
CLINEA 0000H 0001H 0280H 0002H 0023H
	mov	er0,	#1 
	mov	r2,	r8
_$M6 :
	cmp	r2,	#07h
...
;;	SARUN = 1;
CLINEA 0000H 0001H 0281H 0002H 000BH
	sb	0f2f1h.0

;;	while(_flgADCFin == 0)
CLINEA 0000H 0000H 0282H 0001H 0001H
	bal	_$L79

;;	while(_flgADCFin == 0)
CLINEA 0000H 0000H 0282H 0002H 0017H
_$L64 :
CBLOCK 187 3 643

;;		main_clrWDT();
CLINEA 0000H 0001H 0284H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 187 3 645
...
;;	switch(idx)
CLINEA 0000H 0001H 0286H 0002H 000CH
	mov	r0,	r8
	mov	r1,	#00h
CBLOCK 187 4 647
	cmp	r8,	#07h
...
CLINEA 0000H 0001H 028FH 0003H 0028H
_$S78 :
	l	r0,	0f2dfh
	mov	r1,	#00h
	sllc	r1,	#02h
...
;;		default:	return 0;
CLINEA 0000H 0001H 0290H 0003H 0014H
_$L70 :
	mov	er0,	#0 
	b	_$L61
CBLOCKEND 187 4 657
...
;;{
CLINEA 0000H 0001H 02A1H 0001H 0001H
	push	lr
	push	fp
	mov	fp,	sp
	push	xr8
...
;;	_flgI2CFin = 0;
CLINEA 0000H 0001H 02A2H 0002H 0010H
	mov	r0,	#00h
...
CLINEA 0000H 0001H 02A4H 0002H 0063H
...
;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02A5H 0002H 0017H
_$L83 :
CBLOCK 188 3 678

;;		main_clrWDT();
CLINEA 0000H 0001H 02A7H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 188 3 680
...
;;}
CLINEA 0000H 0001H 02A9H 0001H 0001H
	pop	xr8
	mov	sp,	fp
	pop	fp
	pop	pc
...
CLINEA 0000H 0001H 02BBH 0002H 0060H
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	l	r0,	8[fp]
...
;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02BCH 0001H 0001H
	bal	_$L91

;;	while(_flgI2CFin != 1)
CLINEA 0000H 0000H 02BCH 0002H 0017H
_$L89 :
CBLOCK 189 3 701

;;		main_clrWDT();
CLINEA 0000H 0001H 02BEH 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 189 3 703
...
;;}
CLINEA 0000H 0001H 02C0H 0001H 0001H
	pop	xr8
	mov	sp,	fp
	pop	fp
	pop	pc
...
;;{  
CLINEA 0000H 0001H 02CCH 0001H 0003H
CBLOCK 199 2 716
...
CLINEA 0000H 0001H 02DBH 0003H 001EH
	mov	r0,	#01h
	st	r0,	NEAR _SensorIntializationFlag

;;		SensorPlatformSelection = PDD;
CLINEA 0000H 0001H 02DCH 0003H 0020H
	l	r0,	0f268h
	st	r0,	NEAR _SensorPlatformSelection
CBLOCKEND 199 3 733

;;	}
CLINEA 0000H 0000H 02DDH 0002H 0002H
_$L93 :
CBLOCKEND 199 2 734
...
;;{  
CLINEA 0000H 0001H 02E8H 0001H 0003H
	push	lr
CBLOCK 200 2 744
CRET 0000H
...
;;		case 1:
CLINEA 0000H 0001H 02EAH 0003H 0009H
_$S101 :

;;			Init_Hall_Effect_Sensors_1(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 02EBH 0004H 0055H
	bl	_Init_Hall_Effect_Sensors_1

;;			break;
CLINEA 0000H 0001H 02ECH 0004H 0009H
	bal	_$L99

;;		case 2:
CLINEA 0000H 0001H 02EDH 0003H 0009H
_$S102 :

;;			Init_Hall_Effect_Sensors_2(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02EEH 0004H 0056H
	bl	_Init_Hall_Effect_Sensors_2

;;			break;
CLINEA 0000H 0001H 02EFH 0004H 0009H
	bal	_$L99

;;		case 5: 
CLINEA 0000H 0001H 02F0H 0003H 000AH
_$S103 :

;;			Init_Ambient_Light_Sensor_5(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 02F1H 0004H 0056H
	bl	_Init_Ambient_Light_Sensor_5

;;			break;
CLINEA 0000H 0001H 02F2H 0004H 0009H
	bal	_$L99

;;		case 6:
CLINEA 0000H 0001H 02F3H 0003H 0009H
_$S104 :

;;			Init_Ambient_Light_Sensor_6(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02F4H 0004H 0057H
	bl	_Init_Ambient_Light_Sensor_6

;;			break;
CLINEA 0000H 0001H 02F5H 0004H 0009H
	bal	_$L99

;;		case 7:
CLINEA 0000H 0001H 02F6H 0003H 0009H
_$S105 :

;;			Init_Ambient_Light_Sensor_7(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02F7H 0004H 0057H
	bl	_Init_Ambient_Light_Sensor_7

;;			break;
CLINEA 0000H 0001H 02F8H 0004H 0009H
	bal	_$L99

;;		case 8:
CLINEA 0000H 0001H 02F9H 0003H 0009H
_$S106 :

;;			Init_Ambient_Light_Sensor_8(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02FAH 0004H 0057H
	bl	_Init_Ambient_Light_Sensor_8

;;			break;
CLINEA 0000H 0001H 02FBH 0004H 0009H
	bal	_$L99

;;		case 9:
CLINEA 0000H 0001H 02FCH 0003H 0009H
_$S107 :

;;			Init_Ambient_Light_Sensor_9(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 02FDH 0004H 0057H
	bl	_Init_Ambient_Light_Sensor_9

;;			break;
CLINEA 0000H 0001H 02FEH 0004H 0009H
	bal	_$L99

;;		case 10:
CLINEA 0000H 0001H 02FFH 0003H 000AH
_$S108 :

;;			Init_UV_Sensor_10(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 0300H 0004H 004DH
	bl	_Init_UV_Sensor_10

;;			break;
CLINEA 0000H 0001H 0301H 0004H 0009H
	bal	_$L99

;;		case 15:
CLINEA 0000H 0001H 0302H 0003H 000AH
_$S109 :

;;			Init_KX022(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 0303H 0004H 0046H
	bl	_Init_KX022

;;			break;
CLINEA 0000H 0001H 0304H 0004H 0009H
	bal	_$L99

;;		case 16:
CLINEA 0000H 0001H 0305H 0003H 000AH
_$S110 :

;;			Init_KMX61(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 0306H 0004H 0046H
	bl	_Init_KMX61

;;			break;
CLINEA 0000H 0001H 0307H 0004H 0009H
	bal	_$L99

;;		case 20:
CLINEA 0000H 0001H 0308H 0003H 000AH
_$S111 :

;;			Init_Temperature_Sensor_20(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 0309H 0004H 0056H
	bl	_Init_Temperature_Sensor_20

;;			break;
CLINEA 0000H 0001H 030AH 0004H 0009H
	bal	_$L99

;;		case 21:
CLINEA 0000H 0001H 030BH 0003H 000AH
_$S112 :

;;			Init_Temperature_Sensor_21(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 030CH 0004H 0055H
	bl	_Init_Temperature_Sensor_21

;;			break;
CLINEA 0000H 0001H 030DH 0004H 0009H
	bal	_$L99

;;		case 22:
CLINEA 0000H 0001H 030EH 0003H 000AH
_$S113 :

;;			Init_Temperature_Sensor_22(); // Refer to function description for list of sensors 
CLINEA 0000H 0001H 030FH 0004H 0056H
	bl	_Init_Temperature_Sensor_22

;;			break;
CLINEA 0000H 0001H 0310H 0004H 0009H
	bal	_$L99

;;		case 23:
CLINEA 0000H 0001H 0311H 0003H 000AH
_$S114 :

;;			Init_Temperature_Sensor_23(); // Refer to function description for list of sensors
CLINEA 0000H 0001H 0312H 0004H 0055H
	bl	_Init_Temperature_Sensor_23

;;			break; 
CLINEA 0000H 0001H 0313H 0004H 000AH
	bal	_$L99

;;		default:
CLINEA 0000H 0001H 0314H 0003H 000AH
_$L100 :

;;			break;
CLINEA 0000H 0001H 0315H 0004H 0009H
	bal	_$L99
CBLOCKEND 200 3 790
CBLOCKEND 200 1 791
CFUNCTIONEND 200
...
CLINEA 0000H 0001H 0325H 0002H 0039H
	tb	0f258h.2
	beq	_$L116
	tb	0f258h.3
	beq	_$L116
...
CLINEA 0000H 0001H 0327H 0003H 0023H
	mov	r0,	#00h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – No Mag Fields Detected." ESC_SOL);
CLINEA 0000H 0001H 0328H 0003H 004FH
	mov	er0,	#49
	push	er0
...
CLINEA 0000H 0001H 032AH 0002H 003EH
	bal	_$L142
_$L116 :
	tb	0f258h.2
	beq	_$L125
...
CLINEA 0000H 0001H 032CH 0003H 001FH
	mov	r0,	#02h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – North Mag Field Detected." ESC_SOL);
CLINEA 0000H 0001H 032DH 0003H 0051H
	mov	er0,	#51
	push	er0
...
CLINEA 0000H 0001H 032FH 0002H 003EH
	bal	_$L142
_$L125 :
	tb	0f258h.2
	bne	_$L134
...
CLINEA 0000H 0001H 0331H 0003H 001FH
	mov	r0,	#080h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – South Mag Field Detected." ESC_SOL);
CLINEA 0000H 0001H 0332H 0003H 0051H
	mov	er0,	#51
	push	er0
...
;;	else
CLINEA 0000H 0001H 0334H 0002H 0005H
	bal	_$L142
_$L134 :
CBLOCK 202 6 821

;;		LEDOUT(0x82);	// Turn on LED7 and LED1
CLINEA 0000H 0001H 0336H 0003H 0028H
	mov	r0,	#082h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52004GUL> Hall – Both Mag Fields Detected." ESC_SOL);
CLINEA 0000H 0001H 0337H 0003H 0051H
	mov	er0,	#51
	push	er0
...
;;	}
CLINEA 0000H 0000H 0338H 0002H 0002H
_$L142 :
	add	sp,	#2 
CBLOCKEND 202 4 825
CBLOCKEND 202 3 825
...
;;		LEDOUT(0x80);	// Turn on LED7
CLINEA 0000H 0001H 0349H 0003H 001FH
	mov	r0,	#080h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52011HFV> Hall – Mag Field Detected." ESC_SOL);
CLINEA 0000H 0001H 034AH 0003H 004BH
	mov	er0,	#45
	push	er0
...
;;	else
CLINEA 0000H 0001H 034CH 0002H 0005H
	bal	_$L148
_$L145 :
CBLOCK 201 4 845

;;		LEDOUT(0x0);	// Turn off all LEDs
CLINEA 0000H 0001H 034EH 0003H 0023H
	mov	r0,	#00h
	st	r0,	0f260h

;;		PRINTF(ESC_ERASE2END "BU52011HFV> Hall – No Mag Fields Detected." ESC_SOL);
CLINEA 0000H 0001H 034FH 0003H 004FH
	mov	er0,	#49
	push	er0
...
;;	}
CLINEA 0000H 0000H 0350H 0002H 0002H
_$L148 :
	add	sp,	#2 
CBLOCKEND 201 2 849
...
;;{	
CLINEA 0000H 0001H 035EH 0001H 0002H
	push	lr
CBLOCK 203 2 862
CRET 0000H

;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 035FH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0361H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 0366H 0002H 0037H
	l	r0,	0f258h
	srl	r0,	#03h
	and	r0,	#01h
	mov	r1,	#00h
...
;;	switch(SENINTF_HDR1_GPIO1(D)<<1|SENINTF_HDR1_GPIO0(D))
CLINEA 0000H 0000H 0366H 0002H 0037H
	cmp	r2,	#01h
	beq	_$L156
...
;;		case 0:	// Shutdown
CLINEA 0000H 0001H 0371H 0003H 0015H
_$L159 :

;;			flSensorOut[0] = 0;
CLINEA 0000H 0001H 0373H 0004H 0016H
	mov	er0,	#0 
	st	er0,	NEAR _flSensorOut
...
;;	}
CLINEA 0000H 0000H 0375H 0002H 0002H
_$L154 :

;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>2)));
CLINEA 0000H 0000H 0377H 0002H 0040H
...
CLINEA 0000H 0001H 0378H 0002H 0063H
...
;;		case 1: // H-Gain mode
CLINEA 0000H 0001H 0368H 0003H 0018H
_$L156 :

;;			flSensorOut[0] = flSensorOut[0]/(0.57e-6f*5.6e3f);
CLINEA 0000H 0001H 0369H 0004H 0035H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#0e0h
...
;;			break;
CLINEA 0000H 0001H 036AH 0004H 0009H
	bal	_$L154

;;		case 2: // M-Gain mode
CLINEA 0000H 0001H 036BH 0003H 0018H
_$L157 :

;;			flSensorOut[0] = flSensorOut[0]/(0.057e-6f*5.6e3f);
CLINEA 0000H 0001H 036CH 0004H 0036H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#04dh
...
;;			break;
CLINEA 0000H 0001H 036DH 0004H 0009H
	bal	_$L154

;;		case 3: // L-Gain mode
CLINEA 0000H 0001H 036EH 0003H 0018H
_$L158 :

;;			flSensorOut[0] = flSensorOut[0]/(0.0057e-6f*5.6e3f);
CLINEA 0000H 0001H 036FH 0004H 0037H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	mov	r0,	#0d7h
...
;;			break;
CLINEA 0000H 0001H 0370H 0004H 0009H
	b	_$L154
CBLOCKEND 203 1 889
CFUNCTIONEND 203
...
CLINEA 0000H 0001H 038CH 0002H 0043H
	mov	r0,	#02h
	push	r0
...
CLINEA 0000H 0001H 0390H 0002H 0056H
...
;;}
CLINEA 0000H 0001H 0394H 0001H 0001H
	pop	pc
CBLOCKEND 204 1 916
CFUNCTIONEND 204
...
;;{
CLINEA 0000H 0001H 03A1H 0001H 0001H
	push	lr
	push	xr4
CBLOCK 205 2 929
CRET 0004H
...
CLINEA 0000H 0001H 03A7H 0002H 0043H
	mov	r0,	#04h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 03AEH 0002H 0051H
...
CLINEA 0000H 0001H 03AFH 0002H 0019H
	push	xr0
	mov	r0,	#0b8h
	mov	r1,	#01eh
	mov	r2,	#085h
...
CLINEA 0000H 0001H 03B0H 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03B1H 0002H 001EH
	b	_$L175
_$L164 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 03B2H 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03B3H 0002H 001EH
	b	_$L175
_$L167 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 03B4H 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03B5H 0002H 001EH
	b	_$L175
_$L170 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 03B6H 0003H 0065H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;	else
CLINEA 0000H 0001H 03B7H 0002H 0005H
	bal	_$L175
_$L173 :

;;		flSensorOut[0] = 0;
CLINEA 0000H 0001H 03B8H 0003H 0015H
	mov	er0,	#0 
	st	er0,	NEAR _flSensorOut
	st	er0,	NEAR _flSensorOut+02h
_$L175 :
...
;;{	
CLINEA 0000H 0001H 03C9H 0001H 0002H
	push	lr
CBLOCK 206 2 969
CRET 0000H
...
;;	flSensorOut[0] = (uniRawSensorOut._ucharArr[0]<<8|uniRawSensorOut._ucharArr[1])/1.2f;
CLINEA 0000H 0001H 03D2H 0002H 0056H
	l	r0,	NEAR _uniRawSensorOut
	mov	r1,	#00h
	mov	r3,	r0
	l	r0,	NEAR _uniRawSensorOut+01h
...
;;{
CLINEA 0000H 0001H 03E3H 0001H 0001H
	push	lr
CBLOCK 207 2 995
CRET 0000H

;;	I2C_Read(BH17xxFVC_ADDR_2, NULL, 0, uniRawSensorOut._ucharArr, 2);
CLINEA 0000H 0001H 03E9H 0002H 0043H
	mov	r0,	#02h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 03EDH 0002H 0028H
	l	er0,	NEAR _uniRawSensorOut
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 03F0H 0002H 0063H
	...
	bl	_printf_n
	add	sp,	#6 
CBLOCKEND 207 2 1009

;;}
CLINEA 0000H 0001H 03F1H 0001H 0001H
	pop	pc
CBLOCKEND 207 1 1009
CFUNCTIONEND 207
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 03FFH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0401H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 0403H 0002H 0036H
	push	xr0
	mov	r0,	#0cdh
	mov	r1,	#0cch
	mov	r2,	#0ch
...
;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>2)));
CLINEA 0000H 0000H 0405H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#02h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 0406H 0002H 007AH
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
	...
	bl	_printf_n
	add	sp,	#18
CBLOCKEND 208 2 1031

;;}
CLINEA 0000H 0001H 0407H 0001H 0001H
	pop	pc
CBLOCKEND 208 1 1031
CFUNCTIONEND 208
...
CLINEA 0000H 0001H 0419H 0002H 0049H
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 041EH 0002H 0042H
...
CLINEA 0000H 0001H 0421H 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 0424H 0002H 0048H
	mov	r0,	#02h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0426H 0002H 0025H
	l	r0,	NEAR _uniRawSensorOut
CBLOCK 209 3 1063
	cmp	r0,	#01h
	beq	_$L190
...
;;	switch(uniRawSensorOut._ucharArr[0])
CLINEA 0000H 0000H 0426H 0002H 0025H
	cmp	r0,	#02h
	beq	_$L191
...
CLINEA 0000H 0000H 042EH 0003H 0028H
	mov	r0,	#00h
CBLOCKEND 209 3 1071

;;	}
CLINEA 0000H 0000H 042FH 0002H 0002H
_$L188 :
	st	r0,	0f260h
CBLOCKEND 209 2 1072
...
;;{ 
CLINEA 0000H 0001H 043DH 0001H 0002H
	push	lr
CBLOCK 210 2 1085
CRET 0000H

;;	I2C_Read(KMX61_I2C_ADDR, &KMX61_ACCEL_XOUT_L, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 043FH 0002H 0050H
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 0440H 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut
...
CLINEA 0000H 0001H 0442H 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+04h
	srlc	r0,	#02h
	sra	r1,	#02h
...
CLINEA 0000H 0001H 0444H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 0445H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut+02h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 0446H 0002H 0041H
	l	er0,	NEAR _uniRawSensorOut+04h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;		uniRawSensorOut._intArr[0], flSensorOut[0], uniRawSensorOut._intArr[1], flSensorOut[1], uniRawSensorOut._intArr[2], flSensorOut[2]);
CLINEA 0000H 0001H 0448H 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 044AH 0002H 0047H
	mov	er0,	#0 
	mov	r2,	#00h
	mov	r3,	#0bfh
	push	xr0
...
CLINEA 0000H 0001H 044BH 0003H 0047H
	mov	r0,	#020h
	st	r0,	0f260h

;;	else if(0.5f<flSensorOut[0] && -0.5f<flSensorOut[1] && flSensorOut[1]<0.5f)
CLINEA 0000H 0001H 044CH 0002H 004CH
	b	_$L245
_$L198 :
	mov	er0,	#0 
	mov	r2,	#00h
...
CLINEA 0000H 0001H 044DH 0003H 0047H
	mov	r0,	#01h
	st	r0,	0f260h

;;	else if(-0.5f<flSensorOut[0] && flSensorOut[0]<0.5f && flSensorOut[1]<-0.5f)
CLINEA 0000H 0001H 044EH 0002H 004DH
	b	_$L245
_$L209 :
	mov	er0,	#0 
	mov	r2,	#00h
...
CLINEA 0000H 0001H 044FH 0003H 0048H
	mov	r0,	#04h
	st	r0,	0f260h

;;	else if(flSensorOut[0]<-0.5f && -0.5f<flSensorOut[1] && flSensorOut[1]<0.5f)
CLINEA 0000H 0001H 0450H 0002H 004DH
	b	_$L245
_$L220 :
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
...
CLINEA 0000H 0001H 0451H 0003H 0048H
	mov	r0,	#080h
	st	r0,	0f260h

;;	else if(flSensorOut[2]>0.5f)
CLINEA 0000H 0001H 0452H 0002H 001DH
	bal	_$L245
_$L231 :
...
CLINEA 0000H 0001H 0453H 0003H 0032H
	mov	r0,	#010h
	st	r0,	0f260h

;;	else if(flSensorOut[2]<-0.5f)
CLINEA 0000H 0001H 0454H 0002H 001EH
	bal	_$L245
_$L242 :
	l	er0,	NEAR _flSensorOut+08h
	l	er2,	NEAR _flSensorOut+0ah
...
CLINEA 0000H 0001H 0455H 0003H 0033H
	mov	r0,	#08h
	st	r0,	0f260h
_$L245 :

;;	I2C_Read(KMX61_I2C_ADDR, &KMX61_MAG_XOUT_L, 1, uniRawSensorOut._ucharArr, 6);
CLINEA 0000H 0001H 0458H 0002H 004EH
	mov	r0,	#06h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
;;	uniRawSensorOut._intArr[0] = uniRawSensorOut._intArr[0]>>2;
CLINEA 0000H 0001H 0459H 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut
...
;;	uniRawSensorOut._intArr[1] = uniRawSensorOut._intArr[1]>>2;
CLINEA 0000H 0001H 045AH 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+02h
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut+02h
...
;;	uniRawSensorOut._intArr[2] = uniRawSensorOut._intArr[2]>>2;
CLINEA 0000H 0001H 045BH 0002H 003CH
	l	er0,	NEAR _uniRawSensorOut+04h
	srlc	r0,	#02h
	sra	r1,	#02h
	st	er0,	NEAR _uniRawSensorOut+04h
...
CLINEA 0000H 0001H 045DH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 045EH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut+02h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
CLINEA 0000H 0001H 045FH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut+04h
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;		uniRawSensorOut._intArr[0], flSensorOut[0], uniRawSensorOut._intArr[1], flSensorOut[1], uniRawSensorOut._intArr[2], flSensorOut[2]);
CLINEA 0000H 0001H 0461H 0003H 0086H
	push	xr0
	add	sp,	#-4
	bl	__ftodu8sw
	l	er0,	NEAR _uniRawSensorOut+04h
	...
	bl	_printf_n
	add	sp,	#32
CBLOCKEND 210 2 1122

;;}
CLINEA 0000H 0001H 0462H 0001H 0001H
	pop	pc
CBLOCKEND 210 1 1122
CFUNCTIONEND 210
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 0470H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0472H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
CLINEA 0000H 0001H 0474H 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
CLINEA 0000H 0001H 0477H 0002H 0079H
	...
	bl	_printf_n
	add	sp,	#18
CBLOCKEND 211 2 1144

;;}
CLINEA 0000H 0001H 0478H 0001H 0001H
	pop	pc
CBLOCKEND 211 1 1144
CFUNCTIONEND 211
...
;;{
CLINEA 0000H 0001H 0485H 0001H 0001H
	push	lr
CBLOCK 212 2 1157
CRET 0000H

;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 0486H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 0488H 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
;;	flSensorOut[1] = Voltage2Temperature(flSensorOut[0], 1.3f, 30.0f, -0.0082f);
CLINEA 0000H 0001H 048AH 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
CLINEA 0000H 0000H 048CH 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#03h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 048DH 0002H 0072H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
...
CLINEA 0000H 0001H 048EH 0002H 001DH
	tb	0f258h.2
	beq	_$L252

;;		PRINTF(ESC_NEWLINE "BDJ0601HFV> Temperature Threshold Reached." ESC_PREVLINE);
CLINEA 0000H 0001H 048FH 0003H 0050H
	mov	er0,	#48
	push	er0
...
_$L255 :
	add	sp,	#2 
CBLOCKEND 212 2 1170

;;}
CLINEA 0000H 0001H 0492H 0001H 0001H
	pop	pc
CBLOCKEND 212 1 1170
CFUNCTIONEND 212
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 04A0H 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut
...
CLINEA 0000H 0001H 04A4H 0002H 0050H
	push	xr0
	mov	r0,	#04eh
	mov	r1,	#062h
	mov	r2,	#0e0h
...
;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>3)));
CLINEA 0000H 0000H 04A6H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#03h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 04A7H 0002H 0070H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
...
;;	if(SENINTF_HDR1_GPIO0(D)==0)
CLINEA 0000H 0001H 04A8H 0002H 001DH
	tb	0f258h.2
	bne	_$L259

;;		PRINTF(ESC_NEWLINE "BDE0600G> Temperature Threshold Reached." ESC_PREVLINE);
CLINEA 0000H 0001H 04A9H 0003H 004EH
	mov	er0,	#46
	push	er0
...
_$L262 :
	add	sp,	#2 
CBLOCKEND 213 2 1196

;;}
CLINEA 0000H 0001H 04ACH 0001H 0001H
	pop	pc
CBLOCKEND 213 1 1196
CFUNCTIONEND 213
...
;;	uniRawSensorOut._uint = ADC_Read(0);
CLINEA 0000H 0000H 04BAH 0002H 0025H
	mov	r0,	#00h
	bl	_ADC_Read
	st	er0,	NEAR _uniRawSensorOut

;;	flSensorOut[0] = uniRawSensorOut._uint*3.3f/1023;
CLINEA 0000H 0001H 04BCH 0002H 0032H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	mov	r0,	#033h
...
;;	flSensorOut[1] = Voltage2Temperature(flSensorOut[0], 1.3f, 30.0f, -0.0082f);
CLINEA 0000H 0001H 04BEH 0002H 004DH
	push	xr0
	mov	r0,	#066h
	mov	r1,	#066h
	mov	r2,	#0a6h
...
;;	LEDOUT(ReverseBits((unsigned char)(uniRawSensorOut._uint>>3)));
CLINEA 0000H 0000H 04C0H 0002H 0040H
	l	er0,	NEAR _uniRawSensorOut
	srlc	r0,	#03h
	bl	_ReverseBits
	st	r0,	0f260h
...
CLINEA 0000H 0001H 04C1H 0002H 0072H
	l	er0,	NEAR _flSensorOut
	l	er2,	NEAR _flSensorOut+02h
	push	xr0
	add	sp,	#-4
...
;;	if(SENINTF_HDR1_GPIO0(D)==0)
CLINEA 0000H 0001H 04C2H 0002H 001DH
	tb	0f258h.2
	bne	_$L266

;;		PRINTF(ESC_NEWLINE "BDJ0550HFV> Temperature Threshold Reached." ESC_PREVLINE);
CLINEA 0000H 0001H 04C3H 0003H 0050H
	mov	er0,	#48
	push	er0
...
_$L269 :
	add	sp,	#2 
CBLOCKEND 214 2 1222

;;}
CLINEA 0000H 0001H 04C6H 0001H 0001H
	pop	pc
CBLOCKEND 214 1 1222
CFUNCTIONEND 214
...
;;{
CLINEA 0000H 0001H 04D3H 0001H 0001H
CBLOCK 216 2 1235
...
CLINEA 0000H 0001H 04DBH 0002H 001CH
	sb	0f25bh.3

;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 04DDH 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 04DEH 0002H 001DH
	rb	0f25dh.2

;;	SENINTF_HDR1_GPIO1(MD0) = 0;
CLINEA 0000H 0001H 04DFH 0002H 001DH
	rb	0f25ch.3

;;	SENINTF_HDR1_GPIO1(MD1) = 0;
CLINEA 0000H 0001H 04E0H 0002H 001DH
	rb	0f25dh.3
CBLOCKEND 216 2 1249

;;}
CLINEA 0000H 0001H 04E1H 0001H 0001H
	rt
CBLOCKEND 216 1 1249
CFUNCTIONEND 216
...
;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 04F2H 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 04F3H 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 04F5H 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 04F6H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 215 2 1271

;;}
CLINEA 0000H 0001H 04F7H 0001H 0001H
	rt
CBLOCKEND 215 1 1271
CFUNCTIONEND 215
...
;;{
CLINEA 0000H 0001H 0504H 0001H 0001H
CBLOCK 217 2 1284

;;	SENINTF_HDR1_GPIO0(DIR) = 1;
CLINEA 0000H 0001H 0506H 0002H 001DH
	sb	0f259h.2
...
;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 050AH 0002H 001CH
	sb	0f25bh.2
...
;;	SENINTF_HDR1_GPIO1(C1) = 1;
CLINEA 0000H 0001H 050CH 0002H 001CH
	sb	0f25bh.3

;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 050EH 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 050FH 0002H 001DH
	rb	0f25dh.2

;;	SENINTF_HDR1_GPIO1(MD0) = 0;
CLINEA 0000H 0001H 0510H 0002H 001DH
	rb	0f25ch.3

;;	SENINTF_HDR1_GPIO1(MD1) = 0;
CLINEA 0000H 0001H 0511H 0002H 001DH
	rb	0f25dh.3
CBLOCKEND 217 2 1298

;;}
CLINEA 0000H 0001H 0512H 0001H 0001H
	rt
CBLOCKEND 217 1 1298
CFUNCTIONEND 217
...
CLINEA 0000H 0001H 0521H 0002H 003CH
	mov	r0,	#01h
	push	r0
...
;;	NOPms(24);
CLINEA 0000H 0001H 0528H 0002H 000BH
	mov	er0,	#24
	bl	_NOPms
CBLOCKEND 218 2 1321

;;}
CLINEA 0000H 0001H 0529H 0001H 0001H
	pop	pc
CBLOCKEND 218 1 1321
CFUNCTIONEND 218
...
CLINEA 0000H 0001H 0537H 0002H 001AH
	mov	r0,	#00h
	st	r0,	-1[fp]

;;	I2C_Write(BH17xxFVC_ADDR_2, &BH1730FVC_REG_INTERRUPT, 1, &cTmp, 1);
CLINEA 0000H 0001H 053AH 0002H 0044H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
CLINEA 0000H 0001H 053CH 0002H 003FH
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
CLINEA 0000H 0001H 053FH 0002H 0041H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
;;	cTmp = 0x3;
CLINEA 0000H 0001H 0541H 0002H 000CH
	mov	r0,	#03h
	st	r0,	-1[fp]

;;	I2C_Write(BH17xxFVC_ADDR_2, &BH1730FVC_REG_CONTROL, 1, &cTmp, 1);
CLINEA 0000H 0001H 0542H 0002H 0042H
	mov	r0,	#01h
	push	r0
	mov	er0,	fp
	add	er0,	#-1
...
CLINEA 0000H 0001H 0544H 0002H 0042H
	mov	r0,	#00h
	push	r0
	mov	er0,	#0 
	push	er0
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 219 2 1349

;;}
CLINEA 0000H 0001H 0545H 0001H 0001H
	mov	sp,	fp
	pop	fp
	pop	pc
CBLOCKEND 219 1 1349
CFUNCTIONEND 219
...
;;{	
CLINEA 0000H 0001H 0552H 0001H 0002H
	push	lr
CBLOCK 220 2 1362
CRET 0000H
...
CLINEA 0000H 0001H 0556H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 055AH 0002H 000DH
	...
	mov	r1,	#00h
	bl	_NOPms
CBLOCKEND 220 2 1371

;;}
CLINEA 0000H 0001H 055BH 0001H 0001H
	pop	pc
CBLOCKEND 220 1 1371
CFUNCTIONEND 220
...
CLINEA 0000H 0001H 0569H 0002H 001EH
	mov	r0,	#03h
...
CLINEA 0000H 0001H 056DH 0002H 0041H
	mov	r0,	#00h
	push	r0
	mov	er0,	#0 
	push	er0
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 221 2 1390

;;}
CLINEA 0000H 0001H 056EH 0001H 0001H
	pop	pc
CBLOCKEND 221 1 1390
CFUNCTIONEND 221
...
CBLOCK 222 2 1403
CBLOCKEND 222 2 1406

;;}
CLINEA 0000H 0001H 057EH 0001H 0001H
	rt
CBLOCKEND 222 1 1406
CFUNCTIONEND 222
...
;;{
CLINEA 0000H 0001H 058BH 0001H 0001H
	push	lr
CBLOCK 223 2 1419
CRET 0000H

;;	I2C_Write(KX022_I2C_ADDR, &KX022_CNTL1, 1, &KX022_CNTL1_CFGDAT, 1);
CLINEA 0000H 0001H 058CH 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 058DH 0002H 0046H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 058EH 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 058FH 0002H 004EH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 0591H 0002H 0043H
	mov	r0,	#0c1h
	st	r0,	NEAR _uniRawSensorOut

;;	I2C_Write(KX022_I2C_ADDR, &KX022_CNTL1, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 0592H 0002H 0048H
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 223 2 1427

;;}
CLINEA 0000H 0001H 0593H 0001H 0001H
	pop	pc
CBLOCKEND 223 1 1427
CFUNCTIONEND 223
...
;;{ 
CLINEA 0000H 0001H 05A0H 0001H 0002H
	push	lr
CBLOCK 224 2 1440
CRET 0000H

;;	uniRawSensorOut._uchar = 0x03u;
CLINEA 0000H 0001H 05A2H 0002H 0020H
	mov	r0,	#03h
	st	r0,	NEAR _uniRawSensorOut

;;	I2C_Write(KMX61_I2C_ADDR, &KMX61_STBY_REG, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 05A3H 0002H 004BH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
...
CLINEA 0000H 0001H 05A5H 0002H 004CH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A6H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A7H 0002H 0044H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A8H 0002H 0046H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05A9H 0002H 0052H
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05AAH 0002H 004CH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05ABH 0002H 004CH
	mov	r0,	#01h
	push	r0
...
CLINEA 0000H 0001H 05ADH 0002H 001FH
	mov	r0,	#00h
	st	r0,	NEAR _uniRawSensorOut

;;	I2C_Write(KMX61_I2C_ADDR, &KMX61_STBY_REG, 1, &uniRawSensorOut._uchar, 1);
CLINEA 0000H 0001H 05AEH 0002H 004BH
	mov	r0,	#01h
	push	r0
	mov	r0,	#BYTE1 OFFSET _uniRawSensorOut
	mov	r1,	#BYTE2 OFFSET _uniRawSensorOut
	...
	bl	_I2C_Write
	add	sp,	#6 
CBLOCKEND 224 2 1455

;;}
CLINEA 0000H 0001H 05AFH 0001H 0001H
	pop	pc
CBLOCKEND 224 1 1455
CFUNCTIONEND 224
...
CBLOCK 225 2 1468
CBLOCKEND 225 2 1471

;;}
CLINEA 0000H 0001H 05BFH 0001H 0001H
	rt
CBLOCKEND 225 1 1471
CFUNCTIONEND 225
...
;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 05CFH 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 05D0H 0002H 001CH
	sb	0f25bh.2
...
CLINEA 0000H 0001H 05D3H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 226 2 1492

;;}
CLINEA 0000H 0001H 05D4H 0001H 0001H
	rt
CBLOCKEND 226 1 1492
CFUNCTIONEND 226
...
;;{
CLINEA 0000H 0001H 05E1H 0001H 0001H
CBLOCK 227 2 1505
...
;;	SENINTF_HDR1_GPIO0(C0) = 0;
CLINEA 0000H 0001H 05E5H 0002H 001CH
	rb	0f25ah.2

;;	SENINTF_HDR1_GPIO0(C1) = 1;
CLINEA 0000H 0001H 05E6H 0002H 001CH
	sb	0f25bh.2

;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 05E8H 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05E9H 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 227 2 1514

;;}
CLINEA 0000H 0001H 05EAH 0001H 0001H
	rt
CBLOCKEND 227 1 1514
CFUNCTIONEND 227
...
;;{
CLINEA 0000H 0001H 05F7H 0001H 0001H
CBLOCK 228 2 1527
...
;;	SENINTF_HDR1_GPIO0(MD0) = 0;
CLINEA 0000H 0001H 05FEH 0002H 001DH
	rb	0f25ch.2

;;	SENINTF_HDR1_GPIO0(MD1) = 0;
CLINEA 0000H 0001H 05FFH 0002H 001DH
	rb	0f25dh.2
CBLOCKEND 228 2 1536

;;}
CLINEA 0000H 0001H 0600H 0001H 0001H
	rt
CBLOCKEND 228 1 1536
CFUNCTIONEND 228
...
;;	do {
CLINEA 0000H 0001H 060EH 0002H 0005H
_$L288 :
CBLOCK 179 3 1550

;;		WDTCON = 0x5Au;
CLINEA 0000H 0001H 060FH 0003H 0011H
	mov	r0,	#05ah
	st	r0,	0f00eh
CBLOCKEND 179 3 1552

;;	} while (WDP != 1);
CLINEA 0000H 0000H 0610H 0002H 0014H
	tb	0f00eh.0
	beq	_$L288

;;	WDTCON = 0xA5u;
CLINEA 0000H 0001H 0611H 0002H 0010H
	mov	r0,	#0a5h
	st	r0,	0f00eh
CBLOCKEND 179 2 1554

;;}
CLINEA 0000H 0001H 0612H 0001H 0001H
	rt
CBLOCKEND 179 1 1554
CFUNCTIONEND 179
...
;;{
CLINEA 0000H 0001H 061DH 0001H 0001H
	push	lr
CBLOCK 190 2 1565
CRET 0000H
...
CLINEA 0000H 0001H 061EH 0002H 0054H
	bl	_uart_continue

;;	_flgUartFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 061FH 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __flgUartFin

;;	main_reqNotHalt();				// uncommented 5/2/2013
CLINEA 0000H 0001H 0620H 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 190 2 1569

;;}
CLINEA 0000H 0001H 0621H 0001H 0001H
	pop	pc
CBLOCKEND 190 1 1569
CFUNCTIONEND 190
...
CLINEA 0000H 0001H 062DH 0002H 0053H
	bl	_i2c_continue

;;	_flgI2CFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 062EH 0002H 0025H
	mov	r0,	#01h
	st	r0,	NEAR __flgI2CFin

;;	main_reqNotHalt();				// uncommented 5/2/2013
CLINEA 0000H 0001H 062FH 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 191 2 1584

;;}
CLINEA 0000H 0001H 0630H 0001H 0001H
	pop	pc
CBLOCKEND 191 1 1584
CFUNCTIONEND 191
...
;;{
CLINEA 0000H 0001H 063AH 0001H 0001H
	push	lr
CBLOCK 194 2 1594
CRET 0000H

;;	i2c_continue();
CLINEA 0000H 0001H 063BH 0002H 0010H
	bl	_i2c_continue

;;	main_reqNotHalt();
CLINEA 0000H 0001H 063CH 0002H 0013H
	bl	_main_reqNotHalt
CBLOCKEND 194 2 1597

;;}
CLINEA 0000H 0001H 063DH 0001H 0001H
	pop	pc
CBLOCKEND 194 1 1597
CFUNCTIONEND 194
...
;;{
CLINEA 0000H 0001H 0647H 0001H 0001H
CBLOCK 195 2 1607

;;	_flgADCFin = 1;
CLINEA 0000H 0001H 0648H 0002H 0010H
	mov	r0,	#01h
	st	r0,	NEAR __flgADCFin
CBLOCKEND 195 2 1609

;;}
CLINEA 0000H 0001H 0649H 0001H 0001H
	rt
CBLOCKEND 195 1 1609
CFUNCTIONEND 195
...
CLINEA 0000H 0001H 0654H 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __reqNotHalt
CBLOCKEND 192 2 1621

;;}
CLINEA 0000H 0001H 0655H 0001H 0001H
	rt
CBLOCKEND 192 1 1621
CFUNCTIONEND 192
...
;;{
CLINEA 0000H 0001H 065FH 0001H 0001H
CBLOCK 193 2 1631

;;	uart_continue(); 	//in UART.c: process to continue send and receive...
CLINEA 0000H 0001H 0660H 0002H 0047H
	b	_uart_continue
CBLOCKEND 193 2 1633
CLINEA 0000H 0001H 0661H 0001H 0001H
CBLOCKEND 193 1 1633
CFUNCTIONEND 193
...
CLINEA 0000H 0001H 0666H 0001H 0019H
CBLOCK 181 2 1638

;;	SYSC0 = 0;			// Used to select the frequency of the HSCLK => 00=8.192MHz.
CLINEA 0000H 0001H 0669H 0002H 004AH
	rb	0f002h.0
...
CLINEA 0000H 0001H 066CH 0002H 0034H
	sb	0f002h.3

;;	OSCM0 = 0;
CLINEA 0000H 0001H 066DH 0002H 000BH
	rb	0f002h.2

;;	ENOSC = 1;			//1=Enable High Speed Oscillator...
CLINEA 0000H 0001H 066FH 0002H 0031H
	sb	0f003h.1

;;	SYSCLK = 1;			//1=HSCLK; 0=LSCLK 
CLINEA 0000H 0001H 0670H 0002H 0022H
	sb	0f003h.0

;;	LPLL = 1;			//1=Enables the use of PLL oscillation - ADDED 4/30/2013
CLINEA 0000H 0001H 0672H 0002H 0045H
	sb	0f003h.7

;;	__EI();			//INT enable
CLINEA 0000H 0001H 0674H 0002H 0017H
	ei
CBLOCKEND 181 2 1653

;;}
CLINEA 0000H 0001H 0675H 0001H 0001H
	rt
CBLOCKEND 181 1 1653
CFUNCTIONEND 181
...
;;void PortA_Low(void){
CLINEA 0000H 0001H 067BH 0001H 0015H
CBLOCK 182 2 1659

;;	PA0DIR = 0;		// PortA Bit0 set to Output Mode...
CLINEA 0000H 0001H 0685H 0002H 0031H
	rb	0f251h.0
...
CLINEA 0000H 0001H 068AH 0002H 0031H
	sb	0f253h.0

;;	PA0C0  = 1;		
CLINEA 0000H 0001H 068BH 0002H 000EH
	sb	0f252h.0

;;	PA1C1  = 1;		// PortA Bit1 set to CMOS Output...
CLINEA 0000H 0001H 068CH 0002H 0031H
	sb	0f253h.1

;;	PA1C0  = 1;	
CLINEA 0000H 0001H 068DH 0002H 000DH
	sb	0f252h.1

;;	PA2C1  = 1;		// PortA Bit2 set to CMOS Output...
CLINEA 0000H 0001H 068EH 0002H 0031H
	sb	0f253h.2

;;	PA2C0  = 1;	
CLINEA 0000H 0001H 068FH 0002H 000DH
	sb	0f252h.2

;;	PA0MD1  = 0;	// PortA Bit0 set to General Purpose Output...
CLINEA 0000H 0001H 0692H 0002H 003CH
	rb	0f255h.0

;;	PA0MD0  = 0;	
CLINEA 0000H 0001H 0693H 0002H 000EH
	rb	0f254h.0

;;	PA1MD1  = 0;	// PortA Bit1 set to General Purpose Output...
CLINEA 0000H 0001H 0694H 0002H 003CH
	rb	0f255h.1

;;	PA1MD0  = 0;	
CLINEA 0000H 0001H 0695H 0002H 000EH
	rb	0f254h.1

;;	PA2MD1  = 0;	// PortA Bit2 set to General Purpose Output...
CLINEA 0000H 0001H 0696H 0002H 003CH
	rb	0f255h.2

;;	PA2MD0  = 0;	
CLINEA 0000H 0001H 0697H 0002H 000EH
	rb	0f254h.2

;;	PA0D = 0;		// A.0 Output OFF....
CLINEA 0000H 0001H 069AH 0002H 0021H
	rb	0f250h.0

;;	PA1D = 0;		// A.1 Output OFF....
CLINEA 0000H 0001H 069BH 0002H 0021H
	rb	0f250h.1

;;	PA2D = 0;		// A.2 Output OFF....
CLINEA 0000H 0001H 069CH 0002H 0021H
	rb	0f250h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 069EH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 182 2 1695
CLINEA 0000H 0001H 069FH 0001H 0001H
CBLOCKEND 182 1 1695
CFUNCTIONEND 182
...
;;void PortB_Low(void){
CLINEA 0000H 0001H 06A5H 0001H 0015H
CBLOCK 183 2 1701
...
CLINEA 0000H 0001H 06B4H 0002H 0031H
	rb	0f259h.5
...
CLINEA 0000H 0001H 06B6H 0002H 0031H
	rb	0f259h.7
...
CLINEA 0000H 0001H 06C3H 0002H 0031H
	sb	0f25bh.5
...
CLINEA 0000H 0001H 06C5H 0002H 0031H
	sb	0f25bh.6
...
CLINEA 0000H 0001H 06D9H 0002H 003CH
	rb	0f25dh.7

;;	PB7MD0  = 0;
CLINEA 0000H 0001H 06DAH 0002H 000DH
	rb	0f25ch.7
...
CLINEA 0000H 0001H 06DFH 0002H 0021H
	rb	0f258h.2

;;	PB3D = 0;		// B.3 Output OFF....
CLINEA 0000H 0001H 06E0H 0002H 0021H
	rb	0f258h.3

;;	PB4D = 0;		// B.4 Output OFF....
CLINEA 0000H 0001H 06E1H 0002H 0021H
	rb	0f258h.4

;;	PB5D = 0;		// B.5 Output OFF....
CLINEA 0000H 0001H 06E2H 0002H 0021H
	rb	0f258h.5

;;	PB6D = 0;		// B.6 Output OFF....
CLINEA 0000H 0001H 06E3H 0002H 0021H
	rb	0f258h.6

;;	PB7D = 0;		// B.7 Output OFF....
CLINEA 0000H 0001H 06E4H 0002H 0021H
	rb	0f258h.7

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 06E6H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 183 2 1767
CLINEA 0000H 0001H 06E7H 0001H 0001H
CBLOCKEND 183 1 1767
CFUNCTIONEND 183
...
;;void PortC_Low(void){
CLINEA 0000H 0001H 06EDH 0001H 0015H
CBLOCK 184 2 1773
...
CLINEA 0000H 0001H 06F9H 0002H 0031H
	rb	0f261h.2
...
CLINEA 0000H 0001H 06FBH 0002H 0031H
	rb	0f261h.4
...
CLINEA 0000H 0001H 070BH 0002H 003BH
	sb	0f263h.5
...
CLINEA 0000H 0001H 070DH 0002H 003BH
	sb	0f263h.6

;;	PC6C0  = 1;	
CLINEA 0000H 0001H 070EH 0002H 000DH
	sb	0f262h.6

;;	PC7C1  = 1;		// PortC Bit7 set to High-Impedance Output...
CLINEA 0000H 0001H 070FH 0002H 003BH
	sb	0f263h.7
...
;;	PC2MD0  = 0;	
CLINEA 0000H 0001H 0718H 0002H 000EH
	rb	0f264h.2
...
;;	PC4MD0  = 0;	
CLINEA 0000H 0001H 071CH 0002H 000EH
	rb	0f264h.4

;;	PC5MD1  = 0;	// PortC Bit5 set to General Purpose Output...
CLINEA 0000H 0001H 071DH 0002H 003CH
	rb	0f265h.5

;;	PC5MD0  = 0;
CLINEA 0000H 0001H 071EH 0002H 000DH
	rb	0f264h.5

;;	PC6MD1  = 0;	// PortC Bit6 set to General Purpose Output...
CLINEA 0000H 0001H 071FH 0002H 003CH
	rb	0f265h.6

;;	PC6MD0  = 0;	
CLINEA 0000H 0001H 0720H 0002H 000EH
	rb	0f264h.6

;;	PC7MD1  = 0;	// PortC Bit7 set to General Purpose Output...
CLINEA 0000H 0001H 0721H 0002H 003CH
	rb	0f265h.7
...
CLINEA 0000H 0001H 0727H 0002H 0021H
	rb	0f260h.2

;;	PC3D = 0;		// C.3 Output OFF....
CLINEA 0000H 0001H 0728H 0002H 0021H
	rb	0f260h.3

;;	PC4D = 0;		// C.4 Output OFF....
CLINEA 0000H 0001H 0729H 0002H 0021H
	rb	0f260h.4

;;	PC5D = 0;		// C.5 Output OFF....
CLINEA 0000H 0001H 072AH 0002H 0021H
	rb	0f260h.5

;;	PC6D = 0;		// C.6 Output OFF....
CLINEA 0000H 0001H 072BH 0002H 0021H
	rb	0f260h.6

;;	PC7D = 0;		// C.7 Output OFF....
CLINEA 0000H 0001H 072CH 0002H 0021H
	rb	0f260h.7

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 072EH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 184 2 1840
CLINEA 0000H 0001H 0730H 0001H 0001H
CBLOCKEND 184 1 1840
CFUNCTIONEND 184
...
;;void PortD_Low(void){
CLINEA 0000H 0001H 0736H 0001H 0015H
CBLOCK 185 2 1846

;;	PD0DIR = 1;		// PortD Bit0 set to Input Mode...
CLINEA 0000H 0001H 073FH 0002H 0030H
	sb	0f269h.0

;;	PD1DIR = 1;		// PortD Bit1 set to Input Mode...
CLINEA 0000H 0001H 0740H 0002H 0030H
	sb	0f269h.1

;;	PD2DIR = 1;		// PortD Bit2 set to Input Mode...
CLINEA 0000H 0001H 0741H 0002H 0030H
	sb	0f269h.2

;;	PD3DIR = 1;		// PortD Bit3 set to Input Mode...
CLINEA 0000H 0001H 0742H 0002H 0030H
	sb	0f269h.3

;;	PD4DIR = 1;		// PortD Bit4 set to Input Mode...
CLINEA 0000H 0001H 0743H 0002H 0030H
	sb	0f269h.4

;;	PD5DIR = 1;		// PortD Bit5 set to Input Mode...
CLINEA 0000H 0001H 0744H 0002H 0030H
	sb	0f269h.5
...
CLINEA 0000H 0001H 074DH 0002H 0038H
	sb	0f26bh.3

;;	PD3C0= 1;		
CLINEA 0000H 0001H 074EH 0002H 000CH
	sb	0f26ah.3

;;	PD4C1= 1;		// PortD Bit4 set to High-impedance input...
CLINEA 0000H 0001H 074FH 0002H 0038H
	sb	0f26bh.4

;;	PD4C0= 1;	
CLINEA 0000H 0001H 0750H 0002H 000BH
	sb	0f26ah.4

;;	PD5C1= 1;		// PortD Bit5 set to High-impedance input...
CLINEA 0000H 0001H 0751H 0002H 0038H
	sb	0f26bh.5

;;	PD5C0= 1;	
CLINEA 0000H 0001H 0752H 0002H 000BH
	sb	0f26ah.5

;;	PD0D = 0;		// D.0 Input OFF....
CLINEA 0000H 0001H 0755H 0002H 0020H
	rb	0f268h.0

;;	PD1D = 0;		// D.1 Input OFF....
CLINEA 0000H 0001H 0756H 0002H 0020H
	rb	0f268h.1

;;	PD2D = 0;		// D.2 Input OFF....
CLINEA 0000H 0001H 0757H 0002H 0020H
	rb	0f268h.2

;;	PD3D = 0;		// D.3 Input OFF....
CLINEA 0000H 0001H 0758H 0002H 0020H
	rb	0f268h.3

;;	PD4D = 0;		// D.4 Input OFF....
CLINEA 0000H 0001H 0759H 0002H 0020H
	rb	0f268h.4

;;	PD5D = 0;		// D.5 Input OFF....
CLINEA 0000H 0001H 075AH 0002H 0020H
	rb	0f268h.5

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 075CH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 185 2 1885
CLINEA 0000H 0001H 075DH 0001H 0001H
CBLOCKEND 185 1 1885
CFUNCTIONEND 185
...
;;	TempSec = ms;
CLINEA 0000H 0001H 0772H 0002H 000EH
	mov	er4,	er0
...
;;	tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 0775H 0002H 0016H
	mov	r0,	#01h
	bl	_tm_init
...
;;	if(ms < 128){
CLINEA 0000H 0001H 0779H 0002H 000EH
	mov	er0,	er8
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bge	_$L302
...
;;		timerThres = 0x1FF * ms;
CLINEA 0000H 0001H 077AH 0003H 001AH
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
...
;;		TimeFlag = 0;
CLINEA 0000H 0001H 077BH 0003H 000FH
CBLOCKEND 196 3 1916

;;	}
CLINEA 0000H 0000H 077CH 0002H 0002H
_$L302 :

;;	if(ms == 128){
CLINEA 0000H 0001H 077DH 0002H 000FH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bne	_$L304
CBLOCK 196 4 1917
...
;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 077EH 0003H 0016H
	mov	bp,	#-1

;;		TimeFlag = 0;
CLINEA 0000H 0001H 077FH 0003H 000FH
	mov	r6,	#00h
CBLOCKEND 196 4 1920

;;	}
CLINEA 0000H 0000H 0780H 0002H 0002H
_$L304 :

;;	if(ms > 128){
CLINEA 0000H 0001H 0781H 0002H 000EH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	ble	_$L314
CBLOCK 196 5 1921
...
;;		while(TempSec > 128){
CLINEA 0000H 0000H 0782H 0001H 0001H
	bal	_$L324

;;		while(TempSec > 128){
CLINEA 0000H 0000H 0782H 0003H 0017H
_$L310 :
CBLOCK 196 6 1922

;;			TempSec -= 128;
CLINEA 0000H 0001H 0783H 0004H 0012H
	add	r0,	#080h
	addc	r1,	#0ffh
	mov	er4,	er0

;;			TimeFlag++;
CLINEA 0000H 0000H 0784H 0004H 000EH
	add	r6,	#01h
CBLOCKEND 196 6 1925
...
;;		if(TempSec != 0){
CLINEA 0000H 0001H 0786H 0003H 0013H
	mov	er4,	er4
	beq	_$L312
CBLOCK 196 7 1926

;;			timerThres = 0x1FF * TempSec;
CLINEA 0000H 0001H 0787H 0004H 0020H
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
	...
	subc	r1,	r5
	mov	bp,	er0
CBLOCKEND 196 7 1928

;;		else{
CLINEA 0000H 0001H 0789H 0003H 0007H
	bal	_$L314
_$L312 :
CBLOCK 196 8 1929

;;			timerThres = 0xFFFF;
CLINEA 0000H 0001H 078AH 0004H 0017H
	mov	bp,	#-1

;;			TimeFlag--;
CLINEA 0000H 0000H 078BH 0004H 000EH
	add	r6,	#0ffh
CBLOCKEND 196 8 1932

;;		}
CLINEA 0000H 0000H 078CH 0003H 0003H
_$L314 :
CBLOCKEND 196 5 1933

;;	main_clrWDT();	
CLINEA 0000H 0001H 0790H 0002H 0010H
	bl	_main_clrWDT
...
CLINEA 0000H 0001H 0794H 0002H 001BH
	bal	_$L317
_$L319 :
CBLOCK 196 9 1940
...
;;		timer = tm_getABCounter();
CLINEA 0000H 0000H 0795H 0003H 001CH
CBLOCKEND 196 9 1943
...
;;	while(timer < timerThres){
CLINEA 0000H 0000H 0794H 0000H 0000H
	cmp	er0,	bp
	blt	_$L319

;;	if(TimeFlag !=0){
CLINEA 0000H 0001H 0798H 0002H 0012H
	cmp	r6,	#00h
	beq	_$L322
...
;;		TimeFlag--;
CLINEA 0000H 0000H 079AH 0003H 000DH
	add	r6,	#0ffh

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 079BH 0003H 0016H
	mov	bp,	#-1

;;		goto TimerRestart;
CLINEA 0000H 0001H 079CH 0003H 0014H
	bal	_$L314

;;	}
CLINEA 0000H 0000H 079DH 0002H 0002H
_$L322 :
CBLOCKEND 196 2 1950
...
;;");
CLINEA 0000H 0001H 07B6H 0001H 0003H
...
CBLOCKEND 197 2 1975

;;}
CLINEA 0000H 0001H 07B7H 0001H 0001H
	rt
CBLOCKEND 197 1 1975
CFUNCTIONEND 197
...
;;{
CLINEA 0000H 0001H 07C1H 0001H 0001H
CBLOCK 198 2 1985

;;	if(LEDFlashFlag == 0){
CLINEA 0000H 0001H 07C2H 0002H 0017H
	l	r0,	NEAR _LEDFlashFlag
	bne	_$L327
CBLOCK 198 3 1986

;;		if(LEDChangeFlag == 0){
CLINEA 0000H 0001H 07C3H 0003H 0019H
	l	r0,	NEAR _LEDChangeFlag
	bne	_$L329
CBLOCK 198 4 1987

;;			LEDOUT(0xAA);
CLINEA 0000H 0001H 07C4H 0004H 0010H
	mov	r0,	#0aah
	st	r0,	0f260h

;;			LEDChangeFlag = 1;
CLINEA 0000H 0001H 07C5H 0004H 0015H
	mov	r0,	#01h
CBLOCKEND 198 4 1990

;;		else{
CLINEA 0000H 0001H 07C7H 0003H 0007H
	bal	_$L331
_$L329 :
CBLOCK 198 5 1991

;;			LEDOUT(0x55);
CLINEA 0000H 0001H 07C8H 0004H 0010H
	mov	r0,	#055h
	st	r0,	0f260h

;;			LEDChangeFlag = 0;
CLINEA 0000H 0001H 07C9H 0004H 0015H
	mov	r0,	#00h
CBLOCKEND 198 5 1994

;;		}
CLINEA 0000H 0000H 07CAH 0003H 0003H
_$L331 :
	st	r0,	NEAR _LEDChangeFlag
CBLOCKEND 198 3 1995

;;	else{
CLINEA 0000H 0001H 07CCH 0002H 0006H
	bal	_$L332
_$L327 :
CBLOCK 198 6 1996

;;		LEDOUT(0x00);
CLINEA 0000H 0001H 07CDH 0003H 000FH
	mov	r0,	#00h
	st	r0,	0f260h
CBLOCKEND 198 6 1998

;;	}
CLINEA 0000H 0000H 07CEH 0002H 0002H
_$L332 :

;;	LEDFlashFlag++;
CLINEA 0000H 0000H 07CFH 0002H 0010H
	lea	OFFSET _LEDFlashFlag
	inc	[ea]
	l	r0,	NEAR _LEDFlashFlag

;;	if(LEDFlashFlag >= 4){
CLINEA 0000H 0001H 07D0H 0002H 0017H
	cmp	r0,	#04h
	blt	_$L333
CBLOCK 198 7 2000

;;		LEDFlashFlag = 0;
CLINEA 0000H 0001H 07D1H 0003H 0013H
	mov	r0,	#00h
	st	r0,	NEAR _LEDFlashFlag
CBLOCKEND 198 7 2002

;;	}
CLINEA 0000H 0000H 07D2H 0002H 0002H
_$L333 :
CBLOCKEND 198 2 2003

;;}
CLINEA 0000H 0001H 07D3H 0001H 0001H
	rt
CBLOCKEND 198 1 2003
CFUNCTIONEND 198
...
_KMX61_BUF_CTRL2_CFGDAT :
	...
	rseg $$TAB$$S30$main
$$S30 :
	DB	"\x1b[2J\x1b[1;1H*********************************************\x0a\x0d** Q112 Firmware - Sensor Platform EVK\x0a\x0d** Revision    : REV00\x0a\x0d** Release date: Feb 24 2015 16:13:42\x0a\x0d** By          : ROHM Semiconductor USA, LLC\x0a\x0d********************************************"
	DB	"*\x0a\x0d", 00H
